const {} = require('./indentGuides.css.js');
const {
  DynamicViewOverlay
} = require('../../view/dynamicViewOverlay.js');
const {
...
} = require('../../../common/model/guidesTextModelPart.js');
const {
  HorizontalGuidesState,
  IndentGuide
} = require('../../../common/textModelGuides.js');
  ...
  prepareRender(ctx) {
    ...
    for (let lineNumber = visibleStartLineNumber; lineNumber <= visibleEndLineNumber; lineNumber++) {
      ...
      for (const guide of indent) {
        ...
        const width = guide.horizontalLine ? (ctx.visibleRangeForPosition(new Position(lineNumber, guide.horizontalLine.endColumn))?.left ?? left + this._spaceWidth) - left : this._spaceWidth;
