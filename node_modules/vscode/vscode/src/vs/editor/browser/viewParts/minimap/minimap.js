...
} = require('../../../../base/browser/globalPointerMoveMonitor.js');
const {
  Disposable
...
const {
  RGBA8
} = require('../../../common/core/rgba.js');
const {
  MinimapTokensColorTracker
} = require('../../../common/viewModel/minimapTokensColorTracker.js');
const {
  ViewModelDecoration
...
} = require('./minimapCharRendererFactory.js');
const {
...
class MinimapOptions {
  constructor(configuration, theme, tokensColorTracker) {
    ...
    const pixelRatio = options.get(143);
    ...
    this.sectionHeaderFontColor = MinimapOptions._getSectionHeaderColor(theme, tokensColorTracker.getColor(1));
