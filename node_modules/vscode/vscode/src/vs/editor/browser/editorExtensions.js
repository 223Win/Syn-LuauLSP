...
const _moduleId = "vs/editor/browser/editorExtensions";
class Command {
  constructor(opts) {
    this.id = opts.id;
...
const UndoCommand = registerCommand(new MultiCommand({
  ...
  menuOpts: [{
    ...
    group: '1_do',
    title: localizeWithPath(_moduleId, 0, "&&Undo"),
    order: 1
  }, {
    menuId: MenuId.CommandPalette,
    group: '',
    title: localizeWithPath(_moduleId, 1, "Undo"),
    order: 1
  }]
}));
...
const RedoCommand = registerCommand(new MultiCommand({
  ...
  menuOpts: [{
    menuId: MenuId.MenubarEditMenu,
    group: '1_do',
    title: localizeWithPath(_moduleId, 2, "&&Redo"),
    order: 2
  }, {
    menuId: MenuId.CommandPalette,
    group: '',
    title: localizeWithPath(_moduleId, 3, "Redo"),
    order: 1
  }]
}));
...
const SelectAllCommand = registerCommand(new MultiCommand({
  ...
  menuOpts: [{
    ...
    group: '1_basic',
    title: localizeWithPath(_moduleId, 4, "&&Select All"),
    order: 1
  }, {
    menuId: MenuId.CommandPalette,
    group: '',
...
exports.EditorExtensionsRegistry = EditorExtensionsRegistry;
