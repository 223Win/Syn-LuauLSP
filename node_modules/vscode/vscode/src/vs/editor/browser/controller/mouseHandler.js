...
class MouseHandler extends ViewEventHandler {
  ...
  _setupMouseWheelZoomListener() {
    ...
    this._register(addDisposableListener(this.viewHelper.viewDomNode, EventType.MOUSE_WHEEL, onMouseWheel, {
      capture: true,
      passive: false
    }));
...
class MouseDownOperation extends Disposable {
  ...
  start(targetType, e, pointerId) {
    ...
    if (!options.get(91) && options.get(35) && !options.get(22) && !this._mouseState.altKey && e.detail < 2 && !this._isActive && !this._currentSelection.isEmpty() && position.type === 6 && position.position && this._currentSelection.containsPosition(position.position)) {
