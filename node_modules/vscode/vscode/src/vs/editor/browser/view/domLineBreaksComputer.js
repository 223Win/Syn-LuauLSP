...
} = require('../../common/modelLineProjectionData.js');
const {
  LineInjectedText
} = require('../../common/textModelEvents.js');
    ...
    if (wrappingIndent !== 0) {
      ...
      if (firstNonWhitespaceIndex$1 === -1) {
        ...
        for (let i = 0; i < firstNonWhitespaceIndex$1; i++) {
          const charWidth = lineContent.charCodeAt(i) === 9 ? tabSize - wrappedTextIndentLength % tabSize : 1;
