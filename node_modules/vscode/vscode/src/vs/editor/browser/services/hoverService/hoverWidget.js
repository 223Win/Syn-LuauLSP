...
const {
  ...
  MarkdownRenderer
} = require('../../widget/markdownRenderer/browser/markdownRenderer.js');
const {
  isMarkdownString
...
const _moduleId = "vs/editor/browser/services/hoverService/hoverWidget";
const $ = $$1;
let HoverWidget = class HoverWidget extends Widget {
  ...
  constructor(options, _keybindingService, _configurationService, _openerService, _instantiationService, _accessibilityService) {
    ...
    if (hideOnHover && options.appearance?.showHoverHint) {
      ...
      infoElement.textContent = localizeWithPath(_moduleId, 0, 'Hold {0} key to mouse over', isMacintosh ? 'Option' : 'Alt');
