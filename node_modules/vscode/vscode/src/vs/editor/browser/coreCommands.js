...
const {
  ColumnSelection
} = require('../common/cursor/cursorColumnSelection.js');
const {
  CursorState
} = require('../common/cursorCommon.js');
const {
  DeleteOperations
} = require('../common/cursor/cursorDeleteOperations.js');
const {
  CursorMoveCommands,
  CursorMove
...
const _moduleId = "vs/editor/browser/coreCommands";
const CORE_WEIGHT = 0;
...
(function (CoreNavigationCommands) {
  class BaseMoveToCommand extends CoreEditorCommand {
    ...
    runCoreEditorCommand(viewModel, args) {
      ...
      const cursorStateChanged = viewModel.setCursorStates(args.source, 3, [CursorMoveCommands.moveTo(viewModel, viewModel.getPrimaryCursorState(), this._inSelectionMode, args.position, args.viewPosition)]);
    ...
    metadata: {
      ...
      args: [{
        ...
        schema: {
          ...
          properties: {
            'sticky': {
              description: localizeWithPath(_moduleId, 0, "Stick to the end even when going to longer lines"),
              type: 'boolean',
              default: false
            }
          }
  ...
  class EditorScrollImpl extends CoreEditorCommand {
    ...
    determineScrollMethod(args) {
      ...
      const verticalUnits = [1, 2, 3, 4, 5, 6];
    ...
    _runVerticalEditorScroll(viewModel, source, args) {
      ...
      if (args.revealCursor) {
        ...
        viewModel.setCursorStates(source, 3, [CursorMoveCommands.findPositionInViewportIfOutside(viewModel, viewModel.getPrimaryCursorState(), desiredVisibleViewRange, args.select)]);
      }
  ...
  class WordCommand extends CoreEditorCommand {
    ...
    runCoreEditorCommand(viewModel, args) {
      ...
      viewModel.model.pushStackElement();
      viewModel.setCursorStates(args.source, 3, [CursorMoveCommands.word(viewModel, viewModel.getPrimaryCursorState(), this._inSelectionMode, args.position)]);
  ...
  class LineCommand extends CoreEditorCommand {
    ...
    runCoreEditorCommand(viewModel, args) {
      ...
      viewModel.model.pushStackElement();
      viewModel.setCursorStates(args.source, 3, [CursorMoveCommands.line(viewModel, viewModel.getPrimaryCursorState(), this._inSelectionMode, args.position, args.viewPosition)]);
      if (args.revealType !== 2) {
  ...
  CoreNavigationCommands.CancelSelection = registerEditorCommand(new class extends CoreEditorCommand {
    ...
    runCoreEditorCommand(viewModel, args) {
      viewModel.model.pushStackElement();
      viewModel.setCursorStates(args.source, 3, [CursorMoveCommands.cancelSelection(viewModel, viewModel.getPrimaryCursorState())]);
      viewModel.revealAllCursors(args.source, true);
    }
  }());
  CoreNavigationCommands.RemoveSecondaryCursors = registerEditorCommand(new class extends CoreEditorCommand {
    ...
    runCoreEditorCommand(viewModel, args) {
      viewModel.model.pushStackElement();
      viewModel.setCursorStates(args.source, 3, [viewModel.getPrimaryCursorState()]);
      viewModel.revealAllCursors(args.source, true);
      status(localizeWithPath(_moduleId, 1, "Removed secondary cursors"));
    }
  }());
  ...
  CoreNavigationCommands.SelectAll = new class extends EditorOrNativeTextInputCommand {
    ...
    runCoreEditorCommand(viewModel, args) {
      viewModel.model.pushStackElement();
      viewModel.setCursorStates('keyboard', 3, [CursorMoveCommands.selectAll(viewModel, viewModel.getPrimaryCursorState())]);
    }
  }();
  CoreNavigationCommands.SetSelection = registerEditorCommand(new class extends CoreEditorCommand {
    ...
    runCoreEditorCommand(viewModel, args) {
      ...
      viewModel.model.pushStackElement();
      viewModel.setCursorStates(args.source, 3, [CursorState.fromModelSelection(args.selection)]);
    }
  }());
...
exports.CoreEditingCommands = CoreEditingCommands;
exports.CoreEditorCommand = CoreEditorCommand;
exports.CoreNavigationCommands = CoreNavigationCommands;
exports.EditorScroll_ = EditorScroll_;
exports.RevealLine_ = RevealLine_;