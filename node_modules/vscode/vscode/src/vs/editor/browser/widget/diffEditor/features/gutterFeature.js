...
const {
  EditorGutter
} = require('../utils/editorGutter.js');
const {
  ActionRunnerWithContext
} = require('../../multiDiffEditor/utils.js');
const {
  LineRangeSet,
  LineRange
...
const {
  TextModelText
} = require('../../../../common/model/textModelText.js');
const {
...
DiffToolBar = __decorate([__param(3, IInstantiationService)], DiffToolBar);
