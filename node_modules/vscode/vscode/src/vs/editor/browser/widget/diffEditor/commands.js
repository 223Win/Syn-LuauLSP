...
const {} = require('./registrations.contribution.js');
const _moduleId = "vs/editor/browser/widget/diffEditor/commands";
class ToggleCollapseUnchangedRegions extends Action2 {
  constructor() {
    super({
      id: 'diffEditor.toggleCollapseUnchangedRegions',
      title: localize2WithPath(_moduleId, 0, 'Toggle Collapse Unchanged Regions'),
      icon: Codicon.map,
...
class ToggleShowMovedCodeBlocks extends Action2 {
  constructor() {
    super({
      ...
      title: localize2WithPath(_moduleId, 1, 'Toggle Show Moved Code Blocks'),
      precondition: ContextKeyExpr.has('isInDiffEditor')
    });
  }
  run(accessor, ...args) {
...
class ToggleUseInlineViewWhenSpaceIsLimited extends Action2 {
  constructor() {
    super({
      ...
      title: localize2WithPath(_moduleId, 2, 'Toggle Use Inline View When Space Is Limited'),
      precondition: ContextKeyExpr.has('isInDiffEditor')
    });
  }
  run(accessor, ...args) {
...
const diffEditorCategory = localize2WithPath(_moduleId, 3, "Diff Editor");
class SwitchSide extends EditorAction2 {
  constructor() {
    super({
      id: 'diffEditor.switchSide',
      title: localize2WithPath(_moduleId, 4, 'Switch Side'),
...
class ExitCompareMove extends EditorAction2 {
  constructor() {
    super({
      ...
      title: localize2WithPath(_moduleId, 5, 'Exit Compare Move'),
      icon: Codicon.close,
...
class CollapseAllUnchangedRegions extends EditorAction2 {
  constructor() {
    super({
      ...
      title: localize2WithPath(_moduleId, 6, 'Collapse All Unchanged Regions'),
      icon: Codicon.fold,
      precondition: ContextKeyExpr.has('isInDiffEditor'),
      f1: true,
      category: diffEditorCategory
...
class ShowAllUnchangedRegions extends EditorAction2 {
  constructor() {
    super({
      ...
      title: localize2WithPath(_moduleId, 7, 'Show All Unchanged Regions'),
      icon: Codicon.unfold,
      precondition: ContextKeyExpr.has('isInDiffEditor'),
      f1: true,
      category: diffEditorCategory
...
class RevertHunkOrSelection extends Action2 {
  constructor() {
    super({
      ...
      title: localize2WithPath(_moduleId, 8, 'Revert'),
      f1: false,
      category: diffEditorCategory
    });
  }
...
const accessibleDiffViewerCategory = localize2WithPath(_moduleId, 9, "Accessible Diff Viewer");
class AccessibleDiffViewerNext extends Action2 {
  ...
  constructor() {
    super({
      ...
      title: localize2WithPath(_moduleId, 10, 'Go to Next Difference'),
...
class AccessibleDiffViewerPrev extends Action2 {
  ...
  constructor() {
    super({
      ...
      title: localize2WithPath(_moduleId, 11, 'Go to Previous Difference'),
      category: accessibleDiffViewerCategory,
      precondition: ContextKeyExpr.has('isInDiffEditor'),
      keybinding: {
        primary: 1024 | 65,
