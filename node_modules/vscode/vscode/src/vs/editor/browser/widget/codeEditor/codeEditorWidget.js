...
const {} = require('../../services/markerDecorations.js');
const {
  DragAndDropObserver,
  getWindow,
...
const {} = require('./editor.css.js');
const {
  applyFontInfo
} = require('../../config/domFontInfo.js');
const {
  EditorConfiguration
} = require('../../config/editorConfiguration.js');
const {
  TabFocus
} = require('../../config/tabFocus.js');
const {
...
} = require('../../../common/editorAction.js');
const {
  EditorType
...
} = require('../../../common/viewModel/monospaceLineBreaksComputer.js');
const {
  ViewModel
} = require('../../../common/viewModel/viewModelImpl.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const {
...
const _moduleId = "vs/editor/browser/widget/codeEditor/codeEditorWidget";
let CodeEditorWidget = class CodeEditorWidget extends Disposable {
  ...
  constructor(domElement, _options, codeEditorWidgetOptions, instantiationService, codeEditorService, commandService, contextKeyService, themeService, notificationService, accessibilityService, languageConfigurationService, languageFeaturesService) {
    ...
    const isDropIntoEnabled = () => {
      return !this._configuration.options.get(91) && this._configuration.options.get(36).enabled;
    };
  ...
  getConfiguredWordAtPosition(position) {
    ...
    return WordOperations.getWordAtPosition(this._modelData.model, this._configuration.options.get(131), this._configuration.options.get(130), position);
  }
        ...
        case 6:
          {
            if (e.reachedMaxCursorCount) {
              ...
              const message = localizeWithPath(_moduleId, 0, "The number of cursors has been limited to {0}. Consider using [find and replace](https://code.visualstudio.com/docs/editor/codebasics#_find-and-replace) for larger changes or increase the editor multi cursor limit setting.", multiCursorLimit);
              this._notificationService.prompt(Severity$1.Warning, message, [{
                ...
                label: localizeWithPath(_moduleId, 1, 'Increase Multi Cursor Limit'),
                run: () => {
