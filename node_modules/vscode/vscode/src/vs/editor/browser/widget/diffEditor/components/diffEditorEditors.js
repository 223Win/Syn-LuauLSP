...
const {
  obsCodeEditor
} = require('../../../observableUtilities.js');
const {
...
const _moduleId = "vs/editor/browser/widget/diffEditor/components/diffEditorEditors";
let DiffEditorEditors = class DiffEditorEditors extends Disposable {
  ...
  constructor(originalEditorElement, modifiedEditorElement, _options, _argCodeEditorWidgetOptions, _createInnerEditor, _instantiationService, _keybindingService) {
    ...
    this.isOriginalFocused = obsCodeEditor(this.original).isFocused;
    this.isModifiedFocused = obsCodeEditor(this.modified).isFocused;
  ...
  _updateAriaLabel(ariaLabel) {
    ...
    const ariaNavigationTip = localizeWithPath(_moduleId, 0, ' use {0} to open the accessibility help.', this._keybindingService.lookupKeybinding('editor.action.accessibilityHelp')?.getAriaLabel());
