...
const _moduleId = "vs/editor/browser/widget/diffEditor/components/diffEditorViewZones/inlineDiffDeletedCodeMargin";
    ...
    const showContextMenu = (x, y) => {
      this._contextMenuService.showContextMenu({
        ...
        getActions: () => {
          ...
          actions.push(new Action('diff.clipboard.copyDeletedContent', isDeletion ? _diff.original.length > 1 ? localizeWithPath(_moduleId, 0, "Copy deleted lines") : localizeWithPath(_moduleId, 1, "Copy deleted line") : _diff.original.length > 1 ? localizeWithPath(_moduleId, 2, "Copy changed lines") : localizeWithPath(_moduleId, 3, "Copy changed line"), undefined, true, async () => {
          ...
          if (_diff.original.length > 1) {
            actions.push(new Action('diff.clipboard.copyDeletedLineContent', isDeletion ? localizeWithPath(_moduleId, 4, "Copy deleted line ({0})", _diff.original.startLineNumber + currentLineNumberOffset) : localizeWithPath(_moduleId, 5, "Copy changed line ({0})", _diff.original.startLineNumber + currentLineNumberOffset), undefined, true, async () => {
          ...
          if (!readOnly) {
            actions.push(new Action('diff.inline.revertChange', localizeWithPath(_moduleId, 6, "Revert this change"), undefined, true, async () => {
