...
const {
  MoveOperations
} = require('../../../common/cursor/cursorMoveOperations.js');
const {
  Range
...
const _moduleId = "vs/editor/contrib/caretOperations/browser/transpose";
class TransposeLettersAction extends EditorAction {
  constructor() {
    super({
      id: 'editor.action.transposeLetters',
      label: localizeWithPath(_moduleId, 0, "Transpose Letters"),
