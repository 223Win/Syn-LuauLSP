...
const {
  quickFixCommandId,
  getCodeActions
} = require('../../codeAction/browser/codeAction.js');
const {
  CodeActionController
} = require('../../codeAction/browser/codeActionController.js');
const {
  CodeActionKind,
  CodeActionTriggerSource
} = require('../../codeAction/common/types.js');
const {
  MarkerController,
  NextMarkerAction
} = require('../../gotoError/browser/gotoError.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const {
...
const _moduleId = "vs/editor/contrib/hover/browser/markerHoverParticipant";
const $ = $$1;
class MarkerHover {
  ...
  renderMarkerStatusbar(context, markerHover, disposables) {
    if (markerHover.marker.severity === MarkerSeverity.Error || markerHover.marker.severity === MarkerSeverity.Warning || markerHover.marker.severity === MarkerSeverity.Info) {
      ...
      if (markerController) {
        context.statusBar.addAction({
          label: localizeWithPath(_moduleId, 0, "View Problem"),
    ...
    if (!this._editor.getOption(91)) {
      ...
      if (this.recentMarkerCodeActionsInfo) {
        if (IMarkerData.makeKey(this.recentMarkerCodeActionsInfo.marker) === IMarkerData.makeKey(markerHover.marker)) {
          if (!this.recentMarkerCodeActionsInfo.hasCodeActions) {
            quickfixPlaceholderElement.textContent = localizeWithPath(_moduleId, 1, "No quick fixes available");
          }
        } else {
          this.recentMarkerCodeActionsInfo = undefined;
        }
      }
      const updatePlaceholderDisposable = this.recentMarkerCodeActionsInfo && !this.recentMarkerCodeActionsInfo.hasCodeActions ? Disposable.None : disposableTimeout(() => quickfixPlaceholderElement.textContent = localizeWithPath(_moduleId, 2, "Checking for quick fixes..."), 200, disposables);
      ...
      codeActionsPromise.then(actions => {
        ...
        context.statusBar.addAction({
          label: localizeWithPath(_moduleId, 3, "Quick Fix..."),
