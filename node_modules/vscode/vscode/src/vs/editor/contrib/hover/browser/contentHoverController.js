...
const {
  HoverOperation
} = require('./hoverOperation.js');
const {
  HoverParticipantRegistry,
  HoverRangeAnchor
} = require('./hoverTypes.js');
const {
...
} = require('./markdownHoverParticipant.js');
const {
  InlayHintsHover
} = require('../../inlayHints/browser/inlayHintsHover.js');
const {
  ContentHoverWidget
} = require('./contentHoverWidget.js');
const {
  ContentHoverComputer
} = require('./contentHoverComputer.js');
const {
  HoverResult,
  ContentHoverVisibleData
} = require('./contentHoverTypes.js');
const {
  EditorHoverStatusBar
} = require('./contentHoverStatusBar.js');
...
let ContentHoverController = class ContentHoverController extends Disposable {
  ...
  _renderMessages(anchor, messages) {
    ...
    if (fragment.hasChildNodes()) {
      ...
      this._widget.showAt(fragment, new ContentHoverVisibleData(anchor.initialMousePosX, anchor.initialMousePosY, colorPicker, showAtPosition, showAtSecondaryPosition, this._editor.getOption(60).above, this._computer.shouldFocus, this._computer.source, isBeforeContent, disposables));
    } else {
      disposables.dispose();
    }
  }
