...
} = require('../../gotoSymbol/browser/link/goToDefinitionAtPosition.js');
const {
  HoverController
} = require('./hoverController.js');
const {
...
class ShowOrFocusHoverAction extends EditorAction {
  constructor() {
    super({
      ...
      metadata: {
        description: localize2WithPath(_moduleId, 1, 'Show or focus the editor hover which shows documentation, references, and other content for a symbol at the current cursor position.'),
        args: [{
          name: 'args',
          schema: {
            type: 'object',
            properties: {
              'focus': {
                ...
                enumDescriptions: [localizeWithPath(_moduleId, 2, 'The hover will not automatically take focus.'), localizeWithPath(_moduleId, 3, 'The hover will take focus only if it is already visible.'), localizeWithPath(_moduleId, 4, 'The hover will automatically take focus when it appears.')],
