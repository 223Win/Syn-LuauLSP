...
const {} = require('../../../../base/browser/ui/codicons/codicon/codicon.css.js');
const {} = require('../../../../base/browser/ui/codicons/codicon/codicon-modifiers.css.js');
const {
  List
...
const {} = require('./media/suggest.css.js');
const {
  EmbeddedCodeEditorWidget
} = require('../../../browser/widget/codeEditor/embeddedCodeEditorWidget.js');
const {
  SuggestWidgetStatus
} = require('./suggestWidgetStatus.js');
const {} = require('../../symbolIcons/browser/symbolIcons.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const {
...
} = require('../../../../platform/theme/common/colors/quickpickColors.js');
...
} = require('../../../../base/browser/ui/resizable/resizable.js');
const {
...
} = require('./suggestWidgetDetails.js');
const {
  ItemRenderer,
  getAriaId
} = require('./suggestWidgetRenderer.js');
const {
  getListStyles
...
var SuggestWidget_1;
const _moduleId = "vs/editor/contrib/suggest/browser/suggestWidget";
registerColor('editorSuggestWidget.background', {
  dark: editorWidgetBackground,
  light: editorWidgetBackground,
  hcDark: editorWidgetBackground,
  hcLight: editorWidgetBackground
}, localizeWithPath(_moduleId, 0, 'Background color of the suggest widget.'));
...
}, localizeWithPath(_moduleId, 1, 'Border color of the suggest widget.'));
...
}, localizeWithPath(_moduleId, 2, 'Foreground color of the suggest widget.'));
...
}, localizeWithPath(_moduleId, 3, 'Foreground color of the selected entry in the suggest widget.'));
...
}, localizeWithPath(_moduleId, 4, 'Icon foreground color of the selected entry in the suggest widget.'));
...
}, localizeWithPath(_moduleId, 5, 'Background color of the selected entry in the suggest widget.'));
...
}, localizeWithPath(_moduleId, 6, 'Color of the match highlights in the suggest widget.'));
...
}, localizeWithPath(_moduleId, 7, 'Color of the match highlights in the suggest widget when an item is focused.'));
...
}, localizeWithPath(_moduleId, 8, 'Foreground color of the suggest widget status.'));
...
let SuggestWidget = class SuggestWidget {
  ...
  static {
    this.LOADING_MESSAGE = localizeWithPath(_moduleId, 9, "Loading...");
  }
  static {
    this.NO_SUGGESTIONS_MESSAGE = localizeWithPath(_moduleId, 10, "No suggestions.");
  }
  constructor(editor, _storageService, _contextKeyService, _themeService, instantiationService) {
    ...
    this._list = new List('SuggestWidget', this._listElement, {
      ...
      accessibilityProvider: {
        getRole: () => 'option',
        getWidgetAriaLabel: () => localizeWithPath(_moduleId, 11, "Suggest"),
        ...
        getAriaLabel: item => {
          ...
          if (typeof item.completion.label !== 'string') {
            ...
            if (detail && description) {
              label = localizeWithPath(_moduleId, 12, '{0} {1}, {2}', label, detail, description);
            } else if (detail) {
              label = localizeWithPath(_moduleId, 13, '{0} {1}', label, detail);
            } else if (description) {
              label = localizeWithPath(_moduleId, 14, '{0}, {1}', label, description);
            }
          }
          ...
          return localizeWithPath(_moduleId, 15, "{0}, docs: {1}", label, docs);
        }
      }
    });
