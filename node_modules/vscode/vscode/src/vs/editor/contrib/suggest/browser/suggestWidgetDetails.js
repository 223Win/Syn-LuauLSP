...
const _moduleId = "vs/editor/contrib/suggest/browser/suggestWidgetDetails";
...
let SuggestDetailsWidget = class SuggestDetailsWidget {
  constructor(_editor, instaService) {
    ...
    this._close.title = localizeWithPath(_moduleId, 0, "Close");
  ...
  renderLoading() {
    this._type.textContent = localizeWithPath(_moduleId, 1, "Loading...");
