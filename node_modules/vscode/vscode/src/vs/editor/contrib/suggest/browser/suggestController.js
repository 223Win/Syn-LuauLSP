...
const {
  SnippetController2
} = require('../../snippet/browser/snippetController2.js');
const {
  SnippetParser
} = require('../../snippet/browser/snippetParser.js');
const {
  ISuggestMemoryService
} = require('./suggestMemory.js');
const {
  WordContextKey
} = require('./wordContextKey.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const {
...
const {
  SuggestAlternatives
} = require('./suggestAlternatives.js');
const {
  CommitCharacterController
} = require('./suggestCommitCharacters.js');
const {
  SuggestModel
} = require('./suggestModel.js');
const {
  OvertypingCapturer
} = require('./suggestOvertypingCapturer.js');
const {
  SuggestWidget
} = require('./suggestWidget.js');
const {
  ITelemetryService
...
const _moduleId = "vs/editor/contrib/suggest/browser/suggestController";
class LineSuffix {
...
let SuggestController = class SuggestController {
  ...
  constructor(editor, _memoryService, _commandService, _contextKeyService, _instantiationService, _logService, _telemetryService) {
    ...
    this.widget = this._toDispose.add(new WindowIdleValue(getWindow(editor.getDomNode()), () => {
      ...
      this._toDispose.add(widget.onDetailsKeyDown(e => {
        if (e.toKeyCodeChord().equals(new KeyCodeChord(true, false, false, false, 33)) || isMacintosh && e.toKeyCodeChord().equals(new KeyCodeChord(false, false, false, true, 33))) {
          e.stopPropagation();
          return;
        }
  ...
  _alertCompletionItem(item) {
    if (isNonEmptyArray(item.completion.additionalTextEdits)) {
      const msg = localizeWithPath(_moduleId, 0, "Accepting '{0}' made {1} additional edits", item.textLabel, item.completion.additionalTextEdits.length);
      alert(msg);
    }
  }
...
class TriggerSuggestAction extends EditorAction {
  ...
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 1, "Trigger Suggest"),
...
registerEditorCommand(new SuggestCommand({
  ...
  menuOpts: [{
    ...
    title: localizeWithPath(_moduleId, 2, "Insert"),
    group: 'left',
    order: 1,
    ...
    menuId: suggestWidgetStatusbarMenu,
    title: localizeWithPath(_moduleId, 3, "Replace"),
    group: 'left',
    order: 1,
...
registerEditorCommand(new SuggestCommand({
  ...
  menuOpts: [{
    ...
    title: localizeWithPath(_moduleId, 4, "show less")
  }, {
    menuId: suggestWidgetStatusbarMenu,
    group: 'right',
    order: 1,
    when: ContextKeyExpr.and(Context.DetailsVisible.toNegated(), Context.CanResolve),
    title: localizeWithPath(_moduleId, 5, "show more")
  }]
}));
registerEditorCommand(new SuggestCommand({
...
registerEditorAction(class extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 6, "Reset Suggest Widget Size"),
