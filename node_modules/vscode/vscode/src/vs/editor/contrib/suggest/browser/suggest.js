...
const _moduleId = "vs/editor/contrib/suggest/browser/suggest";
const Context = {
  Visible: historyNavigationVisible,
  HasFocusedSuggestion: new RawContextKey('suggestWidgetHasFocusedSuggestion', false, localizeWithPath(_moduleId, 0, "Whether any suggestion is focused")),
  DetailsVisible: new RawContextKey('suggestWidgetDetailsVisible', false, localizeWithPath(_moduleId, 1, "Whether suggestion details are visible")),
  MultipleSuggestions: new RawContextKey('suggestWidgetMultipleSuggestions', false, localizeWithPath(_moduleId, 2, "Whether there are multiple suggestions to pick from")),
  MakesTextEdit: new RawContextKey('suggestionMakesTextEdit', true, localizeWithPath(_moduleId, 3, "Whether inserting the current suggestion yields in a change or has everything already been typed")),
  AcceptSuggestionsOnEnter: new RawContextKey('acceptSuggestionOnEnter', true, localizeWithPath(_moduleId, 4, "Whether suggestions are inserted when pressing Enter")),
  HasInsertAndReplaceRange: new RawContextKey('suggestionHasInsertAndReplaceRange', false, localizeWithPath(_moduleId, 5, "Whether the current suggestion has insert and replace behaviour")),
  InsertMode: new RawContextKey('suggestionInsertMode', undefined, {
    type: 'string',
    description: localizeWithPath(_moduleId, 6, "Whether the default behaviour is to insert or replace")
  }),
  CanResolve: new RawContextKey('suggestionCanResolve', false, localizeWithPath(_moduleId, 7, "Whether the current suggestion supports to resolve further details"))
};
...
exports.suggestWidgetStatusbarMenu = suggestWidgetStatusbarMenu;