...
const {
  ICodeLensCache
} = require('./codeLensCache.js');
const {
  CodeLensWidget,
  CodeLensHelper
} = require('./codelensWidget.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const {
...
const _moduleId = "vs/editor/contrib/codelens/browser/codelensController";
...
registerEditorAction(class ShowLensesInCurrentLine extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 0, "Show CodeLens Commands For Current Line"),
  ...
  async run(accessor, editor) {
    ...
    const item = await quickInputService.pick(items, {
      canPickMany: false,
      placeHolder: localizeWithPath(_moduleId, 1, "Select a command")
    });
    if (!item) {
      return;
    }
