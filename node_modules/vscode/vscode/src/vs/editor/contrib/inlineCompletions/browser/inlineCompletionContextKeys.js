...
const _moduleId = "vs/editor/contrib/inlineCompletions/browser/inlineCompletionContextKeys";
class InlineCompletionContextKeys extends Disposable {
  static {
    this.inlineSuggestionVisible = new RawContextKey('inlineSuggestionVisible', false, localizeWithPath(_moduleId, 0, "Whether an inline suggestion is visible"));
  }
  static {
    this.inlineSuggestionHasIndentation = new RawContextKey('inlineSuggestionHasIndentation', false, localizeWithPath(_moduleId, 1, "Whether the inline suggestion starts with whitespace"));
  }
  static {
    this.inlineSuggestionHasIndentationLessThanTabSize = new RawContextKey('inlineSuggestionHasIndentationLessThanTabSize', true, localizeWithPath(_moduleId, 2, "Whether the inline suggestion starts with whitespace that is less than what would be inserted by tab"));
  }
  static {
    this.suppressSuggestions = new RawContextKey('inlineSuggestionSuppressSuggestions', undefined, localizeWithPath(_moduleId, 3, "Whether suggestions should be suppressed for the current suggestion"));
  }
