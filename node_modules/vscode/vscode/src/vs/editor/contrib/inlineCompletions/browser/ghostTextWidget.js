...
const {} = require('./ghostText.css.js');
const {
  applyFontInfo
...
const {
  StringBuilder
} = require('../../../common/core/stringBuilder.js');
const {
  ILanguageService
...
class AdditionalLinesWidget extends Disposable {
  ...
  constructor(editor, languageIdCodec, lines) {
    ...
    this.editorOptionsChanged = observableSignalFromEvent('editorOptionChanged', Event.filter(this.editor.onDidChangeConfiguration, e => e.hasChanged(33) || e.hasChanged(117) || e.hasChanged(99) || e.hasChanged(94) || e.hasChanged(51) || e.hasChanged(50) || e.hasChanged(67)));
...
exports.GHOST_TEXT_DESCRIPTION = GHOST_TEXT_DESCRIPTION;
exports.GhostTextWidget = GhostTextWidget;
exports.ttPolicy = ttPolicy;