...
const {
  Context
} = require('../../suggest/browser/suggest.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const {
...
const _moduleId = "vs/editor/contrib/inlineCompletions/browser/commands";
class ShowNextInlineSuggestionAction extends EditorAction {
  ...
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 0, "Show Next Inline Suggestion"),
...
class ShowPreviousInlineSuggestionAction extends EditorAction {
  ...
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 1, "Show Previous Inline Suggestion"),
...
class TriggerInlineSuggestionAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 2, "Trigger Inline Suggestion"),
...
class AcceptNextWordOfInlineCompletion extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 3, "Accept Next Word Of Inline Suggestion"),
      ...
      menuOpts: [{
        ...
        title: localizeWithPath(_moduleId, 4, 'Accept Word'),
        group: 'primary',
        order: 2
      }]
    });
...
class AcceptNextLineOfInlineCompletion extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 5, "Accept Next Line Of Inline Suggestion"),
      ...
      menuOpts: [{
        menuId: MenuId.InlineSuggestionToolbar,
        title: localizeWithPath(_moduleId, 6, 'Accept Line'),
        group: 'secondary',
        order: 2
      }]
    });
...
class AcceptInlineCompletion extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 7, "Accept Inline Suggestion"),
      alias: 'Accept Inline Suggestion',
      precondition: InlineCompletionContextKeys.inlineSuggestionVisible,
      menuOpts: [{
        menuId: MenuId.InlineSuggestionToolbar,
        title: localizeWithPath(_moduleId, 8, "Accept"),
        group: 'primary',
        order: 1
      }],
      kbOpts: {
...
class HideInlineCompletion extends EditorAction {
  ...
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 9, "Hide Inline Suggestion"),
...
class ToggleAlwaysShowInlineSuggestionToolbar extends Action2 {
  ...
  constructor() {
    super({
      ...
      title: localizeWithPath(_moduleId, 10, "Always Show Toolbar"),
      f1: false,
