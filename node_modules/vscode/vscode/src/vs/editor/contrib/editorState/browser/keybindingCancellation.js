...
const _moduleId = "vs/editor/contrib/editorState/browser/keybindingCancellation";
const IEditorCancellationTokens = createDecorator('IEditorCancelService');
const ctxCancellableOperation = new RawContextKey('cancellableOperation', false, localizeWithPath(_moduleId, 0, 'Whether the editor runs a cancellable operation, e.g. like \'Peek References\''));
