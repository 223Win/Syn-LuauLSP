...
const foldBackground = registerColor('editor.foldBackground', {
  ...
  hcDark: null,
  hcLight: null
}, localizeWithPath(_moduleId, 0, "Background color behind folded ranges. The color must not be opaque so as not to hide underlying decorations."), true);
registerColor('editorGutter.foldingControlForeground', {
  dark: iconForeground,
  light: iconForeground,
  hcDark: iconForeground,
  hcLight: iconForeground
}, localizeWithPath(_moduleId, 1, 'Color of the folding control in the editor gutter.'));
...
const foldingManualCollapsedIcon = registerIcon('folding-manual-collapsed', foldingCollapsedIcon, localizeWithPath(_moduleId, 4, 'Icon for manually collapsed ranges in the editor glyph margin.'));
const foldingManualExpandedIcon = registerIcon('folding-manual-expanded', foldingExpandedIcon, localizeWithPath(_moduleId, 5, 'Icon for manually expanded ranges in the editor glyph margin.'));
...
exports.foldingCollapsedIcon = foldingCollapsedIcon;
exports.foldingExpandedIcon = foldingExpandedIcon;
exports.foldingManualCollapsedIcon = foldingManualCollapsedIcon;
exports.foldingManualExpandedIcon = foldingManualExpandedIcon;