...
const {} = require('./folding.css.js');
const {
  StableEditorScrollState
} = require('../../../browser/stableEditorScroll.js');
const {
...
const {
  ...
  getPreviousFoldLine,
  getNextFoldLine
} = require('./foldingModel.js');
const {
  HiddenRangeModel
} = require('./hiddenRangeModel.js');
const {
  IndentRangeProvider
} = require('./indentRangeProvider.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const {
...
} = require('./foldingDecorations.js');
const {
  FoldingRegions
} = require('./foldingRanges.js');
const {
  SyntaxRangeProvider
} = require('./syntaxRangeProvider.js');
const {
...
const _moduleId = "vs/editor/contrib/folding/browser/folding";
...
class UnfoldAction extends FoldingAction {
  constructor() {
    super({
      id: 'editor.unfold',
      label: localizeWithPath(_moduleId, 0, "Unfold"),
      alias: 'Unfold',
...
class UnFoldRecursivelyAction extends FoldingAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 1, "Unfold Recursively"),
...
class FoldAction extends FoldingAction {
  constructor() {
    super({
      id: 'editor.fold',
      label: localizeWithPath(_moduleId, 2, "Fold"),
      alias: 'Fold',
      precondition: CONTEXT_FOLDING_ENABLED,
      kbOpts: {
        kbExpr: EditorContextKeys.editorTextFocus,
...
class ToggleFoldAction extends FoldingAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 3, "Toggle Fold"),
      alias: 'Toggle Fold',
      precondition: CONTEXT_FOLDING_ENABLED,
      kbOpts: {
        kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldRecursivelyAction extends FoldingAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 4, "Fold Recursively"),
...
class FoldAllBlockCommentsAction extends FoldingAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 5, "Fold All Block Comments"),
...
class FoldAllRegionsAction extends FoldingAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 6, "Fold All Regions"),
...
class UnfoldAllRegionsAction extends FoldingAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 7, "Unfold All Regions"),
...
class FoldAllExceptAction extends FoldingAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 8, "Fold All Except Selected"),
...
class UnfoldAllExceptAction extends FoldingAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 9, "Unfold All Except Selected"),
...
class FoldAllAction extends FoldingAction {
  constructor() {
    super({
      id: 'editor.foldAll',
      label: localizeWithPath(_moduleId, 10, "Fold All"),
      alias: 'Fold All',
      precondition: CONTEXT_FOLDING_ENABLED,
      kbOpts: {
        kbExpr: EditorContextKeys.editorTextFocus,
...
class UnfoldAllAction extends FoldingAction {
  constructor() {
    super({
      id: 'editor.unfoldAll',
      label: localizeWithPath(_moduleId, 11, "Unfold All"),
      alias: 'Unfold All',
      precondition: CONTEXT_FOLDING_ENABLED,
      kbOpts: {
        kbExpr: EditorContextKeys.editorTextFocus,
...
class GotoParentFoldAction extends FoldingAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 12, "Go to Parent Fold"),
...
class GotoPreviousFoldAction extends FoldingAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 13, "Go to Previous Folding Range"),
...
class GotoNextFoldAction extends FoldingAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 14, "Go to Next Folding Range"),
...
class FoldRangeFromSelectionAction extends FoldingAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 15, "Create Folding Range from Selection"),
...
class RemoveFoldRangeFromSelectionAction extends FoldingAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 16, "Remove Manual Folding Ranges"),
...
for (let i = 1; i <= 7; i++) {
  registerInstantiatedEditorAction(new FoldLevelAction({
    ...
    label: localizeWithPath(_moduleId, 17, "Fold Level {0}", i),
    alias: `Fold Level ${i}`,
    precondition: CONTEXT_FOLDING_ENABLED,
    kbOpts: {
      kbExpr: EditorContextKeys.editorTextFocus,
