...
} = require('../../../common/core/editorColorRegistry.js');
const {
  EditorContextKeys
...
const {
  FindOptionsWidget
} = require('./findOptionsWidget.js');
const {
  FindReplaceState
} = require('./findState.js');
const {
  FindWidget
} = require('./findWidget.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const {
...
const _moduleId = "vs/editor/contrib/find/browser/findController";
...
let CommonFindController = class CommonFindController extends Disposable {
  ...
  replaceAll() {
    if (this._model) {
      if (this._editor.getModel()?.isTooLargeForHeapOperation()) {
        this._notificationService.warn(localizeWithPath(_moduleId, 0, "The file is too large to perform a replace all operation."));
        return false;
      }
  ...
  async getGlobalBufferTerm() {
    if (this._editor.getOption(41).globalFindClipboard && this._editor.hasModel() && !this._editor.getModel().isTooLargeForSyncing()) {
...
const StartFindAction = registerMultiEditorAction(new MultiEditorAction({
  ...
  label: localizeWithPath(_moduleId, 1, "Find"),
  alias: 'Find',
  ...
  menuOpts: {
    ...
    group: '3_find',
    title: localizeWithPath(_moduleId, 2, "&&Find"),
    order: 1
  }
}));
...
class StartFindWithArgsAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 3, "Find With Arguments"),
...
class StartFindWithSelectionAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 4, "Find With Selection"),
...
class NextMatchFindAction extends MatchFindAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 5, "Find Next"),
      alias: 'Find Next',
      precondition: undefined,
      kbOpts: [{
...
class PreviousMatchFindAction extends MatchFindAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 6, "Find Previous"),
      alias: 'Find Previous',
      precondition: undefined,
      kbOpts: [{
        kbExpr: EditorContextKeys.focus,
...
class MoveToMatchFindAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 7, "Go to Match..."),
      alias: 'Go to Match...',
  ...
  run(accessor, editor, args) {
    ...
    if (matchesCount < 1) {
      ...
      notificationService.notify({
        ...
        message: localizeWithPath(_moduleId, 8, "No matches. Try searching for something else.")
      });
      return;
    }
    const quickInputService = accessor.get(IQuickInputService);
    const inputBox = quickInputService.createInputBox();
    inputBox.placeholder = localizeWithPath(_moduleId, 9, "Type a number to go to a specific match (between 1 and {0})", matchesCount);
    ...
    const updatePickerAndEditor = value => {
      ...
      if (typeof index === 'number') {
        ...
        inputBox.validationMessage = localizeWithPath(_moduleId, 10, "Please type a number between 1 and {0}", controller.getState().matchesCount);
...
class NextSelectionMatchFindAction extends SelectionMatchFindAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 11, "Find Next Selection"),
...
class PreviousSelectionMatchFindAction extends SelectionMatchFindAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 12, "Find Previous Selection"),
...
const StartFindReplaceAction = registerMultiEditorAction(new MultiEditorAction({
  ...
  label: localizeWithPath(_moduleId, 13, "Replace"),
  alias: 'Replace',
  precondition: ContextKeyExpr.or(EditorContextKeys.focus, ContextKeyExpr.has('editorIsOpen')),
  kbOpts: {
    kbExpr: null,
  ...
  menuOpts: {
    menuId: MenuId.MenubarEditMenu,
    group: '3_find',
    title: localizeWithPath(_moduleId, 14, "&&Replace"),
    order: 2
  }
}));
StartFindReplaceAction.addImplementation(0, (accessor, editor, args) => {
  ...
  const seedSearchStringFromSelection = !currentSelection.isEmpty() && currentSelection.startLineNumber === currentSelection.endLineNumber && editor.getOption(41).seedSearchStringFromSelection !== 'never' && !findInputFocused;
