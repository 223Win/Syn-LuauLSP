...
const uncategorizedCodeActionGroup = Object.freeze({
  ...
  title: localizeWithPath(_moduleId, 0, 'More Actions...')
});
const codeActionGroups = Object.freeze([{
  kind: CodeActionKind.QuickFix,
  title: localizeWithPath(_moduleId, 1, 'Quick Fix')
}, {
  kind: CodeActionKind.RefactorExtract,
  title: localizeWithPath(_moduleId, 2, 'Extract'),
  icon: Codicon.wrench
}, {
  kind: CodeActionKind.RefactorInline,
  title: localizeWithPath(_moduleId, 3, 'Inline'),
  icon: Codicon.wrench
}, {
  kind: CodeActionKind.RefactorRewrite,
  title: localizeWithPath(_moduleId, 4, 'Rewrite'),
  icon: Codicon.wrench
}, {
  kind: CodeActionKind.RefactorMove,
  title: localizeWithPath(_moduleId, 5, 'Move'),
  icon: Codicon.wrench
}, {
  kind: CodeActionKind.SurroundWith,
  title: localizeWithPath(_moduleId, 6, 'Surround With'),
  icon: Codicon.surroundWith
}, {
  kind: CodeActionKind.Source,
  title: localizeWithPath(_moduleId, 7, 'Source Action'),
