...
const {} = require('./lightBulbWidget.css.js');
const {
  computeIndentLevel
} = require('../../../common/model/utils.js');
const {
  autoFixCommandId,
  quickFixCommandId
...
let LightBulbWidget = class LightBulbWidget extends Disposable {
  ...
  _updateLightbulbTitle(autoFix, autoRun) {
    ...
    if (autoRun) {
      ...
      this.title = localizeWithPath(_moduleId, 1, "Show Code Actions. Preferred Quick Fix Available ({0})", this._preferredKbLabel);
