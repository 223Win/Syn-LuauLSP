...
const _moduleId = "vs/editor/contrib/codeAction/browser/codeAction";
...
async function applyCodeAction(accessor, item, codeActionReason, options, token = CancellationToken.None) {
  ...
  if (item.action.command) {
    try {
      ...
      notificationService.error(typeof message === 'string' ? message : localizeWithPath(_moduleId, 0, "An unknown error occurred while applying the code action"));
    }
  }
}
...
exports.ApplyCodeActionReason = ApplyCodeActionReason;
exports.applyCodeAction = applyCodeAction;
exports.autoFixCommandId = autoFixCommandId;
...
exports.quickFixCommandId = quickFixCommandId;
