...
const {
  CopyPasteController
} = require('../../dropOrPasteInto/browser/copyPasteController.js');
const {
  localize2WithPath,
  localizeWithPath
} = require('../../../../nls.js');
...
const _moduleId = "vs/editor/contrib/clipboard/browser/clipboard";
...
const CutAction = supportsCut ? registerCommand(new MultiCommand({
  ...
  menuOpts: [{
    ...
    group: '2_ccp',
    title: localizeWithPath(_moduleId, 0, "Cu&&t"),
    order: 1
  }, {
    menuId: MenuId.EditorContext,
    group: CLIPBOARD_CONTEXT_MENU_GROUP,
    title: localizeWithPath(_moduleId, 1, "Cut"),
...
const CopyAction = supportsCopy ? registerCommand(new MultiCommand({
  ...
  menuOpts: [{
    menuId: MenuId.MenubarEditMenu,
    group: '2_ccp',
    title: localizeWithPath(_moduleId, 2, "&&Copy"),
    order: 2
  }, {
    menuId: MenuId.EditorContext,
    group: CLIPBOARD_CONTEXT_MENU_GROUP,
    title: localizeWithPath(_moduleId, 3, "Copy"),
    order: 2
  }, {
    menuId: MenuId.CommandPalette,
    group: '',
...
MenuRegistry.appendMenuItem(MenuId.MenubarEditMenu, {
  ...
  title: localize2WithPath(_moduleId, 4, "Copy As"),
  group: '2_ccp',
  order: 3
});
...
MenuRegistry.appendMenuItem(MenuId.EditorContext, {
  ...
  title: localize2WithPath(_moduleId, 5, "Share"),
  group: '11_share',
  order: -1,
...
const PasteAction = supportsPaste ? registerCommand(new MultiCommand({
  ...
  menuOpts: [{
    menuId: MenuId.MenubarEditMenu,
    group: '2_ccp',
    title: localizeWithPath(_moduleId, 6, "&&Paste"),
    order: 4
  }, {
    menuId: MenuId.EditorContext,
    group: CLIPBOARD_CONTEXT_MENU_GROUP,
    title: localizeWithPath(_moduleId, 7, "Paste"),
    when: EditorContextKeys.writable,
    order: 4
  }, {
    menuId: MenuId.CommandPalette,
...
class ExecCommandCopyWithSyntaxHighlightingAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 8, "Copy With Syntax Highlighting"),
