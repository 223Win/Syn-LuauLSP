...
const {} = require('./messageController.css.js');
const {
...
let MessageController = class MessageController {
  ...
  static {
    this.MESSAGE_VISIBLE = new RawContextKey('messageVisible', false, localizeWithPath(_moduleId, 0, 'Whether the editor is currently showing an inline message'));
  }
  static get(editor) {
