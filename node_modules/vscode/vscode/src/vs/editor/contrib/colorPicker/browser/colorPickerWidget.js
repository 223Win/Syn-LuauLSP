...
const {} = require('./colorPicker.css.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
...
const _moduleId = "vs/editor/contrib/colorPicker/browser/colorPickerWidget";
const $ = $$1;
class ColorPickerHeader extends Disposable {
  constructor(container, model, themeService, showingStandaloneColorPicker = false) {
    ...
    const tooltip = localizeWithPath(_moduleId, 0, "Click to toggle color options (rgb/hsl/hex)");
...
class CloseButton extends Disposable {
  constructor(container) {
    ...
    const closeButton = append(innerDiv, $('.button' + ThemeIcon.asCSSSelector(registerIcon('color-picker-close', Codicon.close, localizeWithPath(_moduleId, 1, 'Icon to close the color picker')))));
