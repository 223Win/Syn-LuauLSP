...
} = require('./standaloneColorPickerWidget.js');
const {
  EditorContextKeys
...
class ShowOrFocusStandaloneColorPicker extends EditorAction2 {
  constructor() {
    super({
      ...
      metadata: {
        description: localize2WithPath(_moduleId, 2, "Show or focus a standalone color picker which uses the default color provider. It displays hex/rgb/hsl colors.")
      }
    });
  }
...
class InsertColorWithStandaloneColorPicker extends EditorAction {
  constructor() {
    super({
      ...
      metadata: {
        description: localize2WithPath(_moduleId, 6, "Insert hex/rgb/hsl colors with the focused standalone color picker.")
      }
    });
  }
  run(_accessor, editor) {
