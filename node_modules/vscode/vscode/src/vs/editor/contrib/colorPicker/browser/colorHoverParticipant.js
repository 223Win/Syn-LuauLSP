...
const {
  ColorPickerModel
} = require('./colorPickerModel.js');
const {
  ColorPickerWidget
} = require('./colorPickerWidget.js');
const {
  IThemeService
...
function renderHoverParts(participant, editor, themeService, hoverParts, context) {
  ...
  const widget = disposables.add(new ColorPickerWidget(context.fragment, model, editor.getOption(143), themeService, participant instanceof StandaloneColorPickerParticipant));
