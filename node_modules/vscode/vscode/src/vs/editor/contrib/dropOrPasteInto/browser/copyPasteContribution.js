...
const {
  ...
  CopyPasteController
} = require('./copyPasteController.js');
const {
  ...
  static {
    this.argsSchema = {
      ...
      properties: {
        kind: {
          type: 'string',
          description: localizeWithPath(_moduleId, 0, "The kind of the paste edit to try applying. If not provided or there are multiple edits for this kind, the editor will show a picker.")
        }
      }
    };
  }
