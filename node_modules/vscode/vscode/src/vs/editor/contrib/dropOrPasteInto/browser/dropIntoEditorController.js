...
} = require('../../../common/services/treeViewsDnd.js');
const {
  ITreeViewsDnDService
} = require('../../../common/services/treeViewsDndService.js');
const {
...
const _moduleId = "vs/editor/contrib/dropOrPasteInto/browser/dropIntoEditorController";
...
const dropWidgetVisibleCtx = new RawContextKey('dropWidgetVisible', false, localizeWithPath(_moduleId, 0, "Whether the drop widget is showing"));
let DropIntoEditorController = class DropIntoEditorController extends Disposable {
  ...
  constructor(editor, instantiationService, _configService, _languageFeaturesService, _treeViewsDragAndDropService) {
    ...
    this._postDropWidgetManager = this._register(instantiationService.createInstance(PostEditWidgetManager, 'dropIntoEditor', editor, dropWidgetVisibleCtx, {
      ...
      label: localizeWithPath(_moduleId, 1, "Show drop options...")
    }));
  ...
  async onDropIntoEditor(editor, position, dragEvent) {
    ...
    this._dropProgressManager.showWhile(position, localizeWithPath(_moduleId, 2, "Running drop handlers. Click to cancel"), p);
...
exports.changeDropTypeCommandId = changeDropTypeCommandId;
exports.defaultProviderConfig = defaultProviderConfig;
exports.dropWidgetVisibleCtx = dropWidgetVisibleCtx;