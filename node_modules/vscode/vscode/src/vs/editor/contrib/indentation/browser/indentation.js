...
const {
  ShiftCommand
} = require('../../../common/commands/shiftCommand.js');
const {
  Range
...
const {
  ...
  getIndentMetadata
} = require('../../../common/languages/autoIndent.js');
const {
  getReindentEditOperations
} = require('../common/indentation.js');
const _moduleId = "vs/editor/contrib/indentation/browser/indentation";
class IndentationToSpacesAction extends EditorAction {
  ...
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 0, "Convert Indentation to Spaces"),
      alias: 'Convert Indentation to Spaces',
      precondition: EditorContextKeys.writable,
      metadata: {
        description: localize2WithPath(_moduleId, 1, "Convert the tab indentation to spaces.")
      }
    });
  }
  run(accessor, editor) {
...
class IndentationToTabsAction extends EditorAction {
  ...
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 2, "Convert Indentation to Tabs"),
      alias: 'Convert Indentation to Tabs',
      precondition: EditorContextKeys.writable,
      metadata: {
        description: localize2WithPath(_moduleId, 3, "Convert the spaces indentation to tabs.")
      }
    });
  }
  run(accessor, editor) {
...
class ChangeIndentationSizeAction extends EditorAction {
  ...
  run(accessor, editor) {
    ...
    const picks = [1, 2, 3, 4, 5, 6, 7, 8].map(n => ({
      id: n.toString(),
      label: n.toString(),
      description: n === creationOpts.tabSize && n === modelOpts.tabSize ? localizeWithPath(_moduleId, 4, "Configured Tab Size") : n === creationOpts.tabSize ? localizeWithPath(_moduleId, 5, "Default Tab Size") : n === modelOpts.tabSize ? localizeWithPath(_moduleId, 6, "Current Tab Size") : undefined
    }));
    const autoFocusIndex = Math.min(model.getOptions().tabSize - 1, 7);
    setTimeout(() => {
      quickInputService.pick(picks, {
        placeHolder: localizeWithPath(_moduleId, 7, "Select Tab Size for Current File"),
...
class IndentUsingTabs extends ChangeIndentationSizeAction {
  ...
  constructor() {
    super(false, false, {
      ...
      label: localizeWithPath(_moduleId, 8, "Indent Using Tabs"),
      alias: 'Indent Using Tabs',
      precondition: undefined,
      metadata: {
        description: localize2WithPath(_moduleId, 9, "Use indentation with tabs.")
      }
    });
  }
}
class IndentUsingSpaces extends ChangeIndentationSizeAction {
  ...
  constructor() {
    super(true, false, {
      ...
      label: localizeWithPath(_moduleId, 10, "Indent Using Spaces"),
      alias: 'Indent Using Spaces',
      precondition: undefined,
      metadata: {
        description: localize2WithPath(_moduleId, 11, "Use indentation with spaces.")
      }
    });
  }
}
class ChangeTabDisplaySize extends ChangeIndentationSizeAction {
  ...
  constructor() {
    super(true, true, {
      ...
      label: localizeWithPath(_moduleId, 12, "Change Tab Display Size"),
      alias: 'Change Tab Display Size',
      precondition: undefined,
      metadata: {
        description: localize2WithPath(_moduleId, 13, "Change the space size equivalent of the tab.")
      }
    });
  }
}
class DetectIndentation extends EditorAction {
  ...
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 14, "Detect Indentation from Content"),
      alias: 'Detect Indentation from Content',
      precondition: undefined,
      metadata: {
        description: localize2WithPath(_moduleId, 15, "Detect the indentation from content.")
      }
    });
  }
  run(accessor, editor) {
...
class ReindentLinesAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 16, "Reindent Lines"),
      alias: 'Reindent Lines',
      precondition: EditorContextKeys.writable,
      metadata: {
        description: localize2WithPath(_moduleId, 17, "Reindent the lines of the editor.")
      }
    });
  }
  run(accessor, editor) {
...
class ReindentSelectedLinesAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 18, "Reindent Selected Lines"),
      alias: 'Reindent Selected Lines',
      precondition: EditorContextKeys.writable,
      metadata: {
        description: localize2WithPath(_moduleId, 19, "Reindent the selected lines of the editor.")
      }
    });
  }
  run(accessor, editor) {
