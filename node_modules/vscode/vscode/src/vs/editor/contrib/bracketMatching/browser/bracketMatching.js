...
const {} = require('./bracketMatching.css.js');
const {
...
const overviewRulerBracketMatchForeground = registerColor('editorOverviewRuler.bracketMatchForeground', {
  ...
  hcDark: '#A0A0A0',
  hcLight: '#A0A0A0'
}, localizeWithPath(_moduleId, 0, 'Overview ruler marker color for matching brackets.'));
...
class SelectToBracketAction extends EditorAction {
  constructor() {
    super({
      ...
      precondition: undefined,
      metadata: {
        description: localize2WithPath(_moduleId, 3, "Select the text inside and including the brackets or curly braces"),
        args: [{
          name: 'args',
          schema: {
            type: 'object',
