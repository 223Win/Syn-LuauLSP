...
const _moduleId = "vs/editor/contrib/cursorUndo/browser/cursorUndo";
class CursorState {
...
class CursorUndo extends EditorAction {
  constructor() {
    super({
      id: 'cursorUndo',
      label: localizeWithPath(_moduleId, 0, "Cursor Undo"),
      alias: 'Cursor Undo',
...
class CursorRedo extends EditorAction {
  constructor() {
    super({
      id: 'cursorRedo',
      label: localizeWithPath(_moduleId, 1, "Cursor Redo"),
      alias: 'Cursor Redo',
      precondition: undefined
    });
  }
