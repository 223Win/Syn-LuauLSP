...
const {} = require('./anchorSelect.css.js');
const {
...
const _moduleId = "vs/editor/contrib/anchorSelect/browser/anchorSelect";
    ...
    if (this.editor.hasModel()) {
      ...
      this.editor.changeDecorations(accessor => {
        ...
        this.decorationId = accessor.addDecoration(Selection.fromPositions(position, position), {
          ...
          stickiness: 1,
          hoverMessage: new MarkdownString().appendText(localizeWithPath(_moduleId, 0, "Selection Anchor")),
          className: 'selection-anchor'
        });
      });
      this.selectionAnchorSetContextKey.set(!!this.decorationId);
      alert(localizeWithPath(_moduleId, 1, "Anchor set at {0}:{1}", position.lineNumber, position.column));
    }
  }
  goToSelectionAnchor() {
...
class SetSelectionAnchor extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 2, "Set Selection Anchor"),
...
class GoToSelectionAnchor extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 3, "Go to Selection Anchor"),
...
class SelectFromAnchorToCursor extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 4, "Select from Anchor to Cursor"),
...
class CancelSelectionAnchor extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 5, "Cancel Selection Anchor"),
...
exports.SelectionAnchorSet = SelectionAnchorSet;