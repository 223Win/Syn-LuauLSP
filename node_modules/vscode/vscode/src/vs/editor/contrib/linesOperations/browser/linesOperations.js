...
} = require('../../../common/commands/trimTrailingWhitespaceCommand.js');
const {
  TypeOperations
} = require('../../../common/cursor/cursorTypeOperations.js');
const {
  EditOperation
} = require('../../../common/core/editOperation.js');
const {
  Position
...
const {
  CopyLinesCommand
} = require('./copyLinesCommand.js');
const {
  MoveLinesCommand
} = require('./moveLinesCommand.js');
const {
  SortLinesCommand
} = require('./sortLinesCommand.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const {
...
const _moduleId = "vs/editor/contrib/linesOperations/browser/linesOperations";
...
class CopyLinesUpAction extends AbstractCopyLinesAction {
  constructor() {
    super(false, {
      ...
      label: localizeWithPath(_moduleId, 0, "Copy Line Up"),
      alias: 'Copy Line Up',
      ...
      menuOpts: {
        ...
        group: '2_line',
        title: localizeWithPath(_moduleId, 1, "&&Copy Line Up"),
        order: 1
      }
    });
  }
...
class CopyLinesDownAction extends AbstractCopyLinesAction {
  constructor() {
    super(true, {
      ...
      label: localizeWithPath(_moduleId, 2, "Copy Line Down"),
      ...
      menuOpts: {
        menuId: MenuId.MenubarSelectionMenu,
        group: '2_line',
        title: localizeWithPath(_moduleId, 3, "Co&&py Line Down"),
        order: 2
      }
    });
  }
...
class DuplicateSelectionAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 4, "Duplicate Selection"),
      alias: 'Duplicate Selection',
      precondition: EditorContextKeys.writable,
      menuOpts: {
        menuId: MenuId.MenubarSelectionMenu,
        group: '2_line',
        title: localizeWithPath(_moduleId, 5, "&&Duplicate Selection"),
        order: 5
      }
    });
  }
...
class MoveLinesUpAction extends AbstractMoveLinesAction {
  constructor() {
    super(false, {
      ...
      label: localizeWithPath(_moduleId, 6, "Move Line Up"),
      alias: 'Move Line Up',
      precondition: EditorContextKeys.writable,
      kbOpts: {
        kbExpr: EditorContextKeys.editorTextFocus,
      ...
      menuOpts: {
        menuId: MenuId.MenubarSelectionMenu,
        group: '2_line',
        title: localizeWithPath(_moduleId, 7, "Mo&&ve Line Up"),
        order: 3
      }
    });
  }
...
class MoveLinesDownAction extends AbstractMoveLinesAction {
  constructor() {
    super(true, {
      ...
      label: localizeWithPath(_moduleId, 8, "Move Line Down"),
      ...
      menuOpts: {
        menuId: MenuId.MenubarSelectionMenu,
        group: '2_line',
        title: localizeWithPath(_moduleId, 9, "Move &&Line Down"),
        order: 4
      }
    });
  }
...
class SortLinesAscendingAction extends AbstractSortLinesAction {
  constructor() {
    super(false, {
      ...
      label: localizeWithPath(_moduleId, 10, "Sort Lines Ascending"),
...
class SortLinesDescendingAction extends AbstractSortLinesAction {
  constructor() {
    super(true, {
      ...
      label: localizeWithPath(_moduleId, 11, "Sort Lines Descending"),
...
class DeleteDuplicateLinesAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 12, "Delete Duplicate Lines"),
...
class TrimTrailingWhitespaceAction extends EditorAction {
  ...
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 13, "Trim Trailing Whitespace"),
...
class DeleteLinesAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 14, "Delete Line"),
      alias: 'Delete Line',
      precondition: EditorContextKeys.writable,
      kbOpts: {
...
class IndentLinesAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 15, "Indent Line"),
      alias: 'Indent Line',
      precondition: EditorContextKeys.writable,
      kbOpts: {
        kbExpr: EditorContextKeys.editorTextFocus,
...
class OutdentLinesAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 16, "Outdent Line"),
      alias: 'Outdent Line',
      precondition: EditorContextKeys.writable,
      kbOpts: {
        kbExpr: EditorContextKeys.editorTextFocus,
...
class InsertLineBeforeAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 17, "Insert Line Above"),
...
class InsertLineAfterAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 18, "Insert Line Below"),
...
class DeleteAllLeftAction extends AbstractDeleteAllToBoundaryAction {
  constructor() {
    super({
      id: 'deleteAllLeft',
      label: localizeWithPath(_moduleId, 19, "Delete All Left"),
...
class DeleteAllRightAction extends AbstractDeleteAllToBoundaryAction {
  constructor() {
    super({
      id: 'deleteAllRight',
      label: localizeWithPath(_moduleId, 20, "Delete All Right"),
...
class JoinLinesAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 21, "Join Lines"),
      alias: 'Join Lines',
      precondition: EditorContextKeys.writable,
      kbOpts: {
        kbExpr: EditorContextKeys.editorTextFocus,
...
class TransposeAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 22, "Transpose Characters around the Cursor"),
...
class AbstractCaseAction extends EditorAction {
  run(_accessor, editor) {
    ...
    const wordSeparators = editor.getOption(131);
    const textEdits = [];
    for (const selection of selections) {
      if (selection.isEmpty()) {
        const cursor = selection.getStartPosition();
...
class UpperCaseAction extends AbstractCaseAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 23, "Transform to Uppercase"),
...
class LowerCaseAction extends AbstractCaseAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 24, "Transform to Lowercase"),
...
class TitleCaseAction extends AbstractCaseAction {
  ...
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 25, "Transform to Title Case"),
...
class SnakeCaseAction extends AbstractCaseAction {
  ...
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 26, "Transform to Snake Case"),
...
class CamelCaseAction extends AbstractCaseAction {
  ...
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 27, "Transform to Camel Case"),
...
class PascalCaseAction extends AbstractCaseAction {
  ...
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 28, "Transform to Pascal Case"),
...
class KebabCaseAction extends AbstractCaseAction {
  ...
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 29, 'Transform to Kebab Case'),
