...
} = require('./markerNavigationService.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const {
...
} = require('./gotoErrorWidget.js');
var MarkerController_1;
const _moduleId = "vs/editor/contrib/gotoError/browser/gotoError";
...
class NextMarkerAction extends MarkerNavigationAction {
  ...
  static {
    this.LABEL = localizeWithPath(_moduleId, 0, "Go to Next Problem (Error, Warning, Info)");
  }
  constructor() {
    super(true, false, {
      ...
      menuOpts: {
        ...
        icon: registerIcon('marker-navigation-next', Codicon.arrowDown, localizeWithPath(_moduleId, 1, 'Icon for goto next marker.')),
        group: 'navigation',
        order: 1
      }
    });
...
class PrevMarkerAction extends MarkerNavigationAction {
  ...
  static {
    this.LABEL = localizeWithPath(_moduleId, 2, "Go to Previous Problem (Error, Warning, Info)");
  }
  constructor() {
    super(false, false, {
      ...
      menuOpts: {
        ...
        icon: registerIcon('marker-navigation-previous', Codicon.arrowUp, localizeWithPath(_moduleId, 3, 'Icon for goto previous marker.')),
        group: 'navigation',
        order: 2
      }
    });
...
class NextMarkerInFilesAction extends MarkerNavigationAction {
  constructor() {
    super(true, true, {
      ...
      label: localizeWithPath(_moduleId, 4, "Go to Next Problem in Files (Error, Warning, Info)"),
      ...
      menuOpts: {
        ...
        title: localizeWithPath(_moduleId, 5, "Next &&Problem"),
        group: '6_problem_nav',
        order: 1
      }
    });
...
class PrevMarkerInFilesAction extends MarkerNavigationAction {
  constructor() {
    super(false, true, {
      ...
      label: localizeWithPath(_moduleId, 6, "Go to Previous Problem in Files (Error, Warning, Info)"),
      ...
      menuOpts: {
        menuId: MenuId.MenubarGoMenu,
        title: localizeWithPath(_moduleId, 7, "Previous &&Problem"),
        group: '6_problem_nav',
        order: 2
      }
    });
