...
const {} = require('./media/gotoErrorWidget.css.js');
const {
  Range
...
const {
  SeverityIcon
} = require('../../../../platform/severityIcon/browser/severityIcon.js');
const {
  registerColor,
  transparent,
  oneOf
...
const _moduleId = "vs/editor/contrib/gotoError/browser/gotoErrorWidget";
class MessageWidget {
  ...
  getAriaLabel(marker) {
    ...
    switch (marker.severity) {
      case MarkerSeverity.Error:
        severityLabel = localizeWithPath(_moduleId, 0, "Error");
        break;
      case MarkerSeverity.Warning:
        severityLabel = localizeWithPath(_moduleId, 1, "Warning");
        break;
      case MarkerSeverity.Info:
        severityLabel = localizeWithPath(_moduleId, 2, "Info");
        break;
      case MarkerSeverity.Hint:
        severityLabel = localizeWithPath(_moduleId, 3, "Hint");
        break;
    }
    let ariaLabel = localizeWithPath(_moduleId, 4, "{0} at {1}. ", severityLabel, marker.startLineNumber + ':' + marker.startColumn);
...
let MarkerNavigationWidget = class MarkerNavigationWidget extends PeekViewWidget {
  ...
  showAtMarker(marker, markerIdx, markerCount) {
    ...
    if (model) {
      const detail = markerCount > 1 ? localizeWithPath(_moduleId, 5, "{0} of {1} problems", markerIdx, markerCount) : localizeWithPath(_moduleId, 6, "{0} of {1} problem", markerIdx, markerCount);
...
}, localizeWithPath(_moduleId, 7, 'Editor marker navigation widget error color.'));
const editorMarkerNavigationErrorHeader = registerColor('editorMarkerNavigationError.headerBackground', {
  ...
  hcDark: null,
  hcLight: null
}, localizeWithPath(_moduleId, 8, 'Editor marker navigation widget error heading background.'));
const editorMarkerNavigationWarning = registerColor('editorMarkerNavigationWarning.background', {
  dark: warningDefault,
  light: warningDefault,
  hcDark: contrastBorder,
  hcLight: contrastBorder
}, localizeWithPath(_moduleId, 9, 'Editor marker navigation widget warning color.'));
...
}, localizeWithPath(_moduleId, 10, 'Editor marker navigation widget warning heading background.'));
const editorMarkerNavigationInfo = registerColor('editorMarkerNavigationInfo.background', {
  dark: infoDefault,
  light: infoDefault,
  hcDark: contrastBorder,
  hcLight: contrastBorder
}, localizeWithPath(_moduleId, 11, 'Editor marker navigation widget info color.'));
const editorMarkerNavigationInfoHeader = registerColor('editorMarkerNavigationInfo.headerBackground', {
  ...
  hcDark: null,
  hcLight: null
}, localizeWithPath(_moduleId, 12, 'Editor marker navigation widget info heading background.'));
const editorMarkerNavigationBackground = registerColor('editorMarkerNavigation.background', {
  dark: editorBackground,
  light: editorBackground,
  hcDark: editorBackground,
  hcLight: editorBackground
}, localizeWithPath(_moduleId, 13, 'Editor marker navigation widget background.'));
