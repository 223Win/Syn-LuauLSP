...
let SnippetController2 = class SnippetController2 {
  ...
  static {
    this.InSnippetMode = new RawContextKey('inSnippetMode', false, localizeWithPath(_moduleId, 0, "Whether the editor in current in snippet mode"));
  }
  static {
    this.HasNextTabstop = new RawContextKey('hasNextTabstop', false, localizeWithPath(_moduleId, 1, "Whether there is a next tab stop when in snippet mode"));
  }
  static {
    this.HasPrevTabstop = new RawContextKey('hasPrevTabstop', false, localizeWithPath(_moduleId, 2, "Whether there is a previous tab stop when in snippet mode"));
  }
          ...
          for (let i = 0; i < activeChoice.choice.options.length; i++) {
            ...
            suggestions.push({
              ...
              command: {
                ...
                title: localizeWithPath(_moduleId, 3, 'Go to next placeholder...')
              }
            });
          }
          return {
