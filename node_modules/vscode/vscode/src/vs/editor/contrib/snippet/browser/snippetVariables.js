...
const _moduleId = "vs/editor/contrib/snippet/browser/snippetVariables";
...
class TimeBasedVariableResolver {
  ...
  static {
    this.dayNames = [localizeWithPath(_moduleId, 0, "Sunday"), localizeWithPath(_moduleId, 1, "Monday"), localizeWithPath(_moduleId, 2, "Tuesday"), localizeWithPath(_moduleId, 3, "Wednesday"), localizeWithPath(_moduleId, 4, "Thursday"), localizeWithPath(_moduleId, 5, "Friday"), localizeWithPath(_moduleId, 6, "Saturday")];
  }
  static {
    this.dayNamesShort = [localizeWithPath(_moduleId, 7, "Sun"), localizeWithPath(_moduleId, 8, "Mon"), localizeWithPath(_moduleId, 9, "Tue"), localizeWithPath(_moduleId, 10, "Wed"), localizeWithPath(_moduleId, 11, "Thu"), localizeWithPath(_moduleId, 12, "Fri"), localizeWithPath(_moduleId, 13, "Sat")];
  }
  static {
    this.monthNames = [localizeWithPath(_moduleId, 14, "January"), localizeWithPath(_moduleId, 15, "February"), localizeWithPath(_moduleId, 16, "March"), localizeWithPath(_moduleId, 17, "April"), localizeWithPath(_moduleId, 18, "May"), localizeWithPath(_moduleId, 19, "June"), localizeWithPath(_moduleId, 20, "July"), localizeWithPath(_moduleId, 21, "August"), localizeWithPath(_moduleId, 22, "September"), localizeWithPath(_moduleId, 23, "October"), localizeWithPath(_moduleId, 24, "November"), localizeWithPath(_moduleId, 25, "December")];
  }
  static {
    this.monthNamesShort = [localizeWithPath(_moduleId, 26, "Jan"), localizeWithPath(_moduleId, 27, "Feb"), localizeWithPath(_moduleId, 28, "Mar"), localizeWithPath(_moduleId, 29, "Apr"), localizeWithPath(_moduleId, 30, "May"), localizeWithPath(_moduleId, 31, "Jun"), localizeWithPath(_moduleId, 32, "Jul"), localizeWithPath(_moduleId, 33, "Aug"), localizeWithPath(_moduleId, 34, "Sep"), localizeWithPath(_moduleId, 35, "Oct"), localizeWithPath(_moduleId, 36, "Nov"), localizeWithPath(_moduleId, 37, "Dec")];
  }
  resolve(variable) {
    const {
      name
...
exports.KnownSnippetVariableNames = KnownSnippetVariableNames;
