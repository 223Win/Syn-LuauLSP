...
const _moduleId = "vs/editor/contrib/gotoSymbol/browser/symbolNavigation";
const ctxHasSymbols = new RawContextKey('hasSymbols', false, localizeWithPath(_moduleId, 0, "Whether there are symbol locations that can be navigated via keyboard-only."));
...
let SymbolNavigationService = class SymbolNavigationService {
  ...
  _showMessage() {
    ...
    const message = kb ? localizeWithPath(_moduleId, 1, "Symbol {0} of {1}, {2} for next", this._currentIdx + 1, this._currentModel.references.length, kb.getLabel()) : localizeWithPath(_moduleId, 2, "Symbol {0} of {1}", this._currentIdx + 1, this._currentModel.references.length);
