...
const ctxReferenceSearchVisible = new RawContextKey('referenceSearchVisible', false, localizeWithPath(_moduleId, 0, "Whether reference peek is visible, like 'Peek References' or 'Peek Definition'"));
      ...
      return this._widget.setModel(this._model).then(() => {
        if (this._widget && this._model && this._editor.hasModel()) {
          if (!this._model.isEmpty) {
            this._widget.setMetaTitle(localizeWithPath(_moduleId, 2, "{0} ({1})", this._model.title, this._model.references.length));
          } else {
