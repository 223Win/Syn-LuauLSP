...
} = require('../../editorState/browser/editorState.js');
const {
  isCodeEditor
} = require('../../../browser/editorBrowser.js');
const {
  EditorAction2
...
} = require('../../../browser/widget/codeEditor/embeddedCodeEditorWidget.js');
const {
  Position
...
} = require('./peek/referencesController.js');
const {
  ReferencesModel
} = require('./referencesModel.js');
const {
  ISymbolNavigationService
} = require('./symbolNavigation.js');
const {
  MessageController
...
class SymbolNavigationAction extends EditorAction2 {
  ...
  runEditorCommand(accessor, editor, arg, range) {
    ...
    const cts = new EditorStateCancellationTokenSource(editor, 1 | 4);
...
class DefinitionAction extends SymbolNavigationAction {
  async _getLocationModel(languageFeaturesService, model, position, token) {
    return new ReferencesModel(await getDefinitionsAtPosition(languageFeaturesService.definitionProvider, model, position, token), localizeWithPath(_moduleId, 1, 'Definitions'));
  }
  _getNoResultFoundMessage(info) {
    return info && info.word ? localizeWithPath(_moduleId, 2, "No definition found for '{0}'", info.word) : localizeWithPath(_moduleId, 3, "No definition found");
  }
...
class DeclarationAction extends SymbolNavigationAction {
  async _getLocationModel(languageFeaturesService, model, position, token) {
    return new ReferencesModel(await getDeclarationsAtPosition(languageFeaturesService.declarationProvider, model, position, token), localizeWithPath(_moduleId, 8, 'Declarations'));
  }
  _getNoResultFoundMessage(info) {
    return info && info.word ? localizeWithPath(_moduleId, 9, "No declaration found for '{0}'", info.word) : localizeWithPath(_moduleId, 10, "No declaration found");
  }
  _getAlternativeCommand(editor) {
...
class TypeDefinitionAction extends SymbolNavigationAction {
  async _getLocationModel(languageFeaturesService, model, position, token) {
    return new ReferencesModel(await getTypeDefinitionsAtPosition(languageFeaturesService.typeDefinitionProvider, model, position, token), localizeWithPath(_moduleId, 14, 'Type Definitions'));
  }
  _getNoResultFoundMessage(info) {
    return info && info.word ? localizeWithPath(_moduleId, 15, "No type definition found for '{0}'", info.word) : localizeWithPath(_moduleId, 16, "No type definition found");
  }
  _getAlternativeCommand(editor) {
...
class ImplementationAction extends SymbolNavigationAction {
  async _getLocationModel(languageFeaturesService, model, position, token) {
    return new ReferencesModel(await getImplementationsAtPosition(languageFeaturesService.implementationProvider, model, position, token), localizeWithPath(_moduleId, 20, 'Implementations'));
  }
  _getNoResultFoundMessage(info) {
    return info && info.word ? localizeWithPath(_moduleId, 21, "No implementation found for '{0}'", info.word) : localizeWithPath(_moduleId, 22, "No implementation found");
  }
  _getAlternativeCommand(editor) {
...
class ReferencesAction extends SymbolNavigationAction {
  _getNoResultFoundMessage(info) {
    return info ? localizeWithPath(_moduleId, 26, "No references found for '{0}'", info.word) : localizeWithPath(_moduleId, 27, "No references found");
  }
  _getAlternativeCommand(editor) {
...
registerAction2(class GoToReferencesAction extends ReferencesAction {
  ...
  async _getLocationModel(languageFeaturesService, model, position, token) {
    return new ReferencesModel(await getReferencesAtPosition(languageFeaturesService.referenceProvider, model, position, true, token), localizeWithPath(_moduleId, 30, 'References'));
  }
});
registerAction2(class PeekReferencesAction extends ReferencesAction {
  ...
  async _getLocationModel(languageFeaturesService, model, position, token) {
    return new ReferencesModel(await getReferencesAtPosition(languageFeaturesService.referenceProvider, model, position, false, token), localizeWithPath(_moduleId, 30, 'References'));
  }
});
class GenericGoToLocationAction extends SymbolNavigationAction {
  ...
  async _getLocationModel(languageFeaturesService, _model, _position, _token) {
    return new ReferencesModel(this._references, localizeWithPath(_moduleId, 33, 'Locations'));
  }
  _getNoResultFoundMessage(info) {
