...
const {
  GhostText,
  GhostTextPart
} = require('../../inlineCompletions/browser/ghostText.js');
const {
  ICommandService
...
let InlineEditController = class InlineEditController extends Disposable {
  ...
  static {
    this.inlineEditVisibleContext = new RawContextKey(InlineEditController_1.inlineEditVisibleKey, false);
  }
  static {
    this.cursorAtInlineEditKey = 'cursorAtInlineEdit';
  }
  static {
    this.cursorAtInlineEditContext = new RawContextKey(InlineEditController_1.cursorAtInlineEditKey, false);
  }
  static get(editor) {
