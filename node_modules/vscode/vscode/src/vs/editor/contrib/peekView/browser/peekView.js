...
const {} = require('./media/peekViewWidget.css.js');
const {
...
const {
  ZoneWidget
} = require('../../zoneWidget/browser/zoneWidget.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const {
...
const peekViewTitleBackground = registerColor('peekViewTitle.background', {
  ...
  hcDark: Color.black,
  hcLight: Color.white
}, localizeWithPath(_moduleId, 2, 'Background color of the peek view title area.'));
const peekViewTitleForeground = registerColor('peekViewTitleLabel.foreground', {
  dark: Color.white,
  light: Color.black,
  hcDark: Color.white,
  hcLight: editorForeground
}, localizeWithPath(_moduleId, 3, 'Color of the peek view title.'));
const peekViewTitleInfoForeground = registerColor('peekViewTitleDescription.foreground', {
  dark: '#ccccccb3',
  light: '#616161',
  hcDark: '#FFFFFF99',
  hcLight: '#292929'
}, localizeWithPath(_moduleId, 4, 'Color of the peek view title info.'));
const peekViewBorder = registerColor('peekView.border', {
  dark: editorInfoForeground,
  light: editorInfoForeground,
  hcDark: contrastBorder,
  hcLight: contrastBorder
}, localizeWithPath(_moduleId, 5, 'Color of the peek view borders and arrow.'));
const peekViewResultsBackground = registerColor('peekViewResult.background', {
  dark: '#252526',
  light: '#F3F3F3',
  hcDark: Color.black,
  hcLight: Color.white
}, localizeWithPath(_moduleId, 6, 'Background color of the peek view result list.'));
registerColor('peekViewResult.lineForeground', {
  dark: '#bbbbbb',
  light: '#646465',
  hcDark: Color.white,
  hcLight: editorForeground
}, localizeWithPath(_moduleId, 7, 'Foreground color for line nodes in the peek view result list.'));
registerColor('peekViewResult.fileForeground', {
  dark: Color.white,
  light: '#1E1E1E',
  hcDark: Color.white,
  hcLight: editorForeground
}, localizeWithPath(_moduleId, 8, 'Foreground color for file nodes in the peek view result list.'));
registerColor('peekViewResult.selectionBackground', {
  dark: '#3399ff33',
  light: '#3399ff33',
  hcDark: null,
  hcLight: null
}, localizeWithPath(_moduleId, 9, 'Background color of the selected entry in the peek view result list.'));
registerColor('peekViewResult.selectionForeground', {
  dark: Color.white,
  light: '#6C6C6C',
  hcDark: Color.white,
  hcLight: editorForeground
}, localizeWithPath(_moduleId, 10, 'Foreground color of the selected entry in the peek view result list.'));
const peekViewEditorBackground = registerColor('peekViewEditor.background', {
  dark: '#001F33',
  light: '#F2F8FC',
  hcDark: Color.black,
  hcLight: Color.white
}, localizeWithPath(_moduleId, 11, 'Background color of the peek view editor.'));
registerColor('peekViewEditorGutter.background', {
...
}, localizeWithPath(_moduleId, 12, 'Background color of the gutter in the peek view editor.'));
registerColor('peekViewEditorStickyScroll.background', {
  dark: peekViewEditorBackground,
  light: peekViewEditorBackground,
  hcDark: peekViewEditorBackground,
  hcLight: peekViewEditorBackground
}, localizeWithPath(_moduleId, 13, 'Background color of sticky scroll in the peek view editor.'));
registerColor('peekViewResult.matchHighlightBackground', {
  dark: '#ea5c004d',
  light: '#ea5c004d',
  hcDark: null,
  hcLight: null
}, localizeWithPath(_moduleId, 14, 'Match highlight color in the peek view result list.'));
const peekViewEditorMatchHighlight = registerColor('peekViewEditor.matchHighlightBackground', {
  dark: '#ff8f0099',
  light: '#f5d802de',
  hcDark: null,
  hcLight: null
}, localizeWithPath(_moduleId, 15, 'Match highlight color in the peek view editor.'));
registerColor('peekViewEditor.matchHighlightBorder', {
  dark: null,
  light: null,
  hcDark: activeContrastBorder,
  hcLight: activeContrastBorder
}, localizeWithPath(_moduleId, 16, 'Match highlight border in the peek view editor.'));
