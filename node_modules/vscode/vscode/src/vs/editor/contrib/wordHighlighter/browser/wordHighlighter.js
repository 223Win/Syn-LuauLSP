...
} = require('./highlightDecorations.js');
const {
  RawContextKey
...
const {
  score
} = require('../../../common/languageSelector.js');
var WordHighlighter_1, WordHighlighterContribution_1;
const _moduleId = "vs/editor/contrib/wordHighlighter/browser/wordHighlighter";
...
let WordHighlighter = class WordHighlighter {
  ...
  static {
    this.storedDecorations = new ResourceMap();
  }
  static {
    this.query = null;
  }
  ...
  computeWithModel(model, selection, word, otherModels) {
    if (!otherModels.length) {
      return computeOccurencesAtPosition(this.providers, model, selection, word, this.editor.getOption(131));
    } else {
      return computeOccurencesMultiModel(this.multiDocumentProviders, model, selection, word, this.editor.getOption(131), otherModels);
    }
  }
...
class NextWordHighlightAction extends WordHighlightNavigationAction {
  constructor() {
    super(true, {
      ...
      label: localizeWithPath(_moduleId, 0, "Go to Next Symbol Highlight"),
...
class PrevWordHighlightAction extends WordHighlightNavigationAction {
  constructor() {
    super(false, {
      ...
      label: localizeWithPath(_moduleId, 1, "Go to Previous Symbol Highlight"),
...
class TriggerWordHighlightAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 2, "Trigger Symbol Highlight"),
