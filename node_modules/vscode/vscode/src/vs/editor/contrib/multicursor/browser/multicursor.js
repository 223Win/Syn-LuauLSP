...
} = require('../../find/browser/findController.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const {
...
} = require('../../wordHighlighter/browser/highlightDecorations.js');
const {
...
let SelectionHighlighter = class SelectionHighlighter extends Disposable {
  ...
  static _createState(oldState, isEnabled, editor) {
    ...
    return new SelectionHighlighterState(editor.getModel(), r.searchText, r.matchCase, r.wholeWord ? editor.getOption(131) : null, oldState);
  }
  _setState(newState) {
    this.state = newState;
    if (!this.state) {
