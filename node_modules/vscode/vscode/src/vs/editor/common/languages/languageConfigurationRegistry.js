...
const {
  AutoClosingPairs
} = require('./languageConfiguration.js');
const {
  createScopedLineTokens
} = require('./supports.js');
const {
  CharacterPairSupport
} = require('./supports/characterPair.js');
const {
  BracketElectricCharacterSupport
} = require('./supports/electricCharacter.js');
const {
  IndentRulesSupport
} = require('./supports/indentRules.js');
const {
  OnEnterSupport
} = require('./supports/onEnter.js');
const {
  RichEditBrackets
} = require('./supports/richEditBrackets.js');
const {
  createDecorator
...
} = require('./modesRegistry.js');
const {
  LanguageBracketsConfiguration
} = require('./supports/languageBracketsConfiguration.js');
