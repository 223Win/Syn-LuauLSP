...
const {
  ...
  DateTimeout,
  SequenceDiff
} = require('./algorithms/diffAlgorithm.js');
const {
  DynamicProgrammingDiffing
} = require('./algorithms/dynamicProgrammingDiffing.js');
const {
  MyersDiffAlgorithm
} = require('./algorithms/myersDiffAlgorithm.js');
const {
  computeMovedLines
} = require('./computeMovedLines.js');
const {
...
} = require('./heuristicSequenceOptimizations.js');
const {
  LineSequence
} = require('./lineSequence.js');
const {
  LinesSliceCharSequence
} = require('./linesSliceCharSequence.js');
const {
  LinesDiff,
  MovedText
} = require('../linesDiffComputer.js');
const {
  DetailedLineRangeMapping,
  RangeMapping
} = require('../rangeMapping.js');
