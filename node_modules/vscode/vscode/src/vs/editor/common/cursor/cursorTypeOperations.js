...
} = require('../commands/replaceCommand.js');
const {
  ShiftCommand
} = require('../commands/shiftCommand.js');
const {
  SurroundSelectionCommand,
  CompositionSurroundSelectionCommand
} = require('../commands/surroundSelectionCommand.js');
const {
  EditOperationResult,
  isQuote
...
const {
  IndentAction
} = require('../languages/languageConfiguration.js');
const {
...
} = require('../languages/autoIndent.js');
const {
  getEnterAction
} = require('../languages/enterAction.js');
