...
const {
  StringBuilder
} = require('../core/stringBuilder.js');
const {
  LineDecoration,
  LineDecorationsNormalizer
} = require('./lineDecorations.js');
const {
  LinePart
} = require('./linePart.js');
const _moduleId = "vs/editor/common/viewLayout/viewLineRenderer";
class LineRange {
...
function _renderLine(input, sb) {
  ...
  if (isOverflowing) {
    ...
    sb.appendString(localizeWithPath(_moduleId, 0, "Show more ({0})", renderOverflowingCharCount(overflowingCharCount)));
    sb.appendString('</span>');
  }
  sb.appendString('</span>');
...
function renderOverflowingCharCount(n) {
  if (n < 1024) {
    return localizeWithPath(_moduleId, 1, "{0} chars", n);
  }
  if (n < 1024 * 1024) {
