...
const _moduleId = "vs/editor/common/model/editStack";
...
class EditStack {
  ...
  _getOrCreateEditStackElement(beforeCursorState, group) {
    ...
    const newElement = new SingleModelEditStackElement(localizeWithPath(_moduleId, 0, "Typing"), 'undoredo.textBufferEdit', this._model, beforeCursorState);
