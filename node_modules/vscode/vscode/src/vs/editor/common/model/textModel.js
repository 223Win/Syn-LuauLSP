...
const {
  countEOL
} = require('../core/eolCounter.js');
const {
  normalizeIndentation
} = require('../core/indentation.js');
const {
  LineRange
} = require('../core/lineRange.js');
const {
  Position
...
} = require('../languages/languageConfigurationRegistry.js');
const {
...
} = require('./bracketPairsTextModelPart/bracketPairsImpl.js');
const {
  ColorizedBracketPairsDecorationProvider
} = require('./bracketPairsTextModelPart/colorizedBracketPairsDecorationProvider.js');
const {
  EditStack
} = require('./editStack.js');
const {
  GuidesTextModelPart
} = require('./guidesTextModelPart.js');
const {
  guessIndentation
} = require('./indentationGuesser.js');
const {
  recomputeMaxEnd,
  IntervalNode,
  IntervalTree
} = require('./intervalTree.js');
const {
  PieceTreeTextBuffer
} = require('./pieceTreeTextBuffer/pieceTreeTextBuffer.js');
const {
  PieceTreeTextBufferBuilder
} = require('./pieceTreeTextBuffer/pieceTreeTextBufferBuilder.js');
const {
  TextModelSearch,
  SearchParams
} = require('./textModelSearch.js');
const {
  TokenizationTextModelPart
} = require('./tokenizationTextModelPart.js');
const {
