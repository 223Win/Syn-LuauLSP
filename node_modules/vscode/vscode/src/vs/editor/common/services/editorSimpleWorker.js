const {
  stringDiff
} = require('../../../base/common/diff/diff.js');
const {
  URI
...
const {
  MirrorTextModel
} = require('../model/mirrorTextModel.js');
const {
  getWordAtText,
...
const {
  computeLinks
} = require('../languages/linkComputer.js');
const {
  BasicInplaceReplace
} = require('../languages/supports/inplaceReplaceSupport.js');
const {
  createMonacoBaseAPI
} = require('./editorBaseApi.js');
const {
  StopWatch
} = require('../../../base/common/stopwatch.js');
const {
  UnicodeTextModelHighlighter
} = require('./unicodeTextModelHighlighter.js');
const {
  DiffComputer
} = require('../diff/legacyLinesDiffComputer.js');
const {
  linesDiffComputers
} = require('../diff/linesDiffComputers.js');
const {
  createProxyObject,
  getAllMethodNames
...
} = require('../languages/defaultDocumentColorsComputer.js');
const {
  findSectionHeaders
} = require('./findSectionHeaders.js');
