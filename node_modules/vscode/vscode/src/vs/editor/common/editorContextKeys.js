...
(function (EditorContextKeys) {
  ...
  EditorContextKeys.focus = new RawContextKey('editorFocus', false, localizeWithPath(_moduleId, 1, "Whether the editor or an editor widget has focus (e.g. focus is in the find widget)"));
  EditorContextKeys.textInputFocus = new RawContextKey('textInputFocus', false, localizeWithPath(_moduleId, 2, "Whether an editor or a rich text input has focus (cursor is blinking)"));
  ...
  EditorContextKeys.diffEditorRenderSideBySideInlineBreakpointReached = new RawContextKey('diffEditorRenderSideBySideInlineBreakpointReached', false, localizeWithPath(_moduleId, 11, "Whether the diff editor render side by side inline breakpoint is reached"));
  ...
  EditorContextKeys.inCompositeEditor = new RawContextKey('inCompositeEditor', undefined, localizeWithPath(_moduleId, 27, "Whether the editor is part of a larger editor (e.g. notebooks)"));
  ...
  EditorContextKeys.hasDocumentSelectionFormattingProvider = new RawContextKey('editorHasDocumentSelectionFormattingProvider', false, localizeWithPath(_moduleId, 44, "Whether the editor has a document selection formatting provider"));
  EditorContextKeys.hasMultipleDocumentFormattingProvider = new RawContextKey('editorHasMultipleDocumentFormattingProvider', false, localizeWithPath(_moduleId, 45, "Whether the editor has multiple document formatting providers"));
  EditorContextKeys.hasMultipleDocumentSelectionFormattingProvider = new RawContextKey('editorHasMultipleDocumentSelectionFormattingProvider', false, localizeWithPath(_moduleId, 46, "Whether the editor has multiple document selection formatting providers"));
})(EditorContextKeys || (EditorContextKeys = {}));
exports.EditorContextKeys = EditorContextKeys;