...
} = require('./languages/supports.js');
const {
  CursorColumns
} = require('./core/cursorColumns.js');
const {
...
class CursorConfiguration {
  static shouldRecreate(e) {
    return e.hasChanged(145) || e.hasChanged(131) || e.hasChanged(37) || e.hasChanged(77) || e.hasChanged(79) || e.hasChanged(80) || e.hasChanged(6) || e.hasChanged(7) || e.hasChanged(11) || e.hasChanged(9) || e.hasChanged(10) || e.hasChanged(14) || e.hasChanged(128) || e.hasChanged(50) || e.hasChanged(91) || e.hasChanged(130);
  }
  constructor(languageId, modelOptions, configuration, languageConfigurationService) {
    ...
    this.wordSeparators = options.get(131);
    ...
    this.wordSegmenterLocales = options.get(130);
