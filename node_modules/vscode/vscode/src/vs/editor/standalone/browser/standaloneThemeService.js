...
const {
  TokenMetadata
} = require('../../common/encodedTokenAttributes.js');
const {
  generateTokensCSSForColorMap,
  TokenTheme
} = require('../../common/languages/supports/tokenization.js');
const {
  hc_light,
  hc_black,
  vs_dark,
...
const {
  ...
  getIconsStyleSheet
} = require('../../../platform/theme/browser/iconsStyleSheet.js');
const {
  mainWindow
...
exports.HC_BLACK_THEME_NAME = HC_BLACK_THEME_NAME;
exports.HC_LIGHT_THEME_NAME = HC_LIGHT_THEME_NAME;
