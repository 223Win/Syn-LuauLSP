...
const {} = require('../../common/languages/languageConfigurationRegistry.js');
const {} = require('./standaloneCodeEditorService.js');
const {} = require('./standaloneLayoutService.js');
const {} = require('../../../platform/undoRedo/common/undoRedoService.js');
const {} = require('../../common/services/languageFeatureDebounce.js');
const {} = require('../../common/services/semanticTokensStylingService.js');
const {} = require('../../common/services/languageFeaturesService.js');
const {} = require('../../browser/services/hoverService/hoverService.js');
const {
  format
...
const {
  decodeKeybinding,
  KeyCodeChord
} = require('../../../base/common/keybindings.js');
const {
  Disposable,
  ImmortalReference,
  combinedDisposable,
...
} = require('../../common/services/textResourceConfiguration.js');
const {
  CommandsRegistry
...
} = require('../../../platform/configuration/common/configurationModels.js');
const {
  IContextKeyService
...
} = require('../../../platform/keybinding/common/abstractKeybindingService.js');
const {
  IKeybindingService
} = require('../../../platform/keybinding/common/keybinding.service.js');
const {
  KeybindingResolver
} = require('../../../platform/keybinding/common/keybindingResolver.js');
const {
  KeybindingsRegistry
} = require('../../../platform/keybinding/common/keybindingsRegistry.js');
const {
  ResolvedKeybindingItem
} = require('../../../platform/keybinding/common/resolvedKeybindingItem.js');
const {
  USLayoutResolvedKeybinding
} = require('../../../platform/keybinding/common/usLayoutResolvedKeybinding.js');
const {
  ILabelService
...
const {
  ContextViewService
} = require('../../../platform/contextview/browser/contextViewService.js');
const {
  LanguageService
} = require('../../common/services/languageService.js');
const {
  ContextMenuService
} = require('../../../platform/contextview/browser/contextMenuService.js');
const {
...
const {
  OpenerService
} = require('../../browser/services/openerService.js');
const {
...
} = require('../../common/services/markerDecorationsService.js');
const {
  IMarkerDecorationsService
} = require('../../common/services/markerDecorations.js');
const {
  ModelService
} = require('../../common/services/modelService.js');
const {
  StandaloneQuickInputService
} = require('./quickInput/standaloneQuickInputService.js');
const {
  StandaloneThemeService
} = require('./standaloneThemeService.js');
const {
  IStandaloneThemeService
} = require('../common/standaloneTheme.js');
const {
  AccessibilityService
} = require('../../../platform/accessibility/browser/accessibilityService.js');
const {
...
const {
  MenuService
} = require('../../../platform/actions/common/menuService.js');
const {
  BrowserClipboardService
} = require('../../../platform/clipboard/browser/clipboardService.js');
const {
  IClipboardService
} = require('../../../platform/clipboard/common/clipboardService.service.js');
const {
  ContextKeyService
} = require('../../../platform/contextkey/browser/contextKeyService.js');
const {
  SyncDescriptor
} = require('../../../platform/instantiation/common/descriptors.js');
const {
  InstantiationService
} = require('../../../platform/instantiation/common/instantiationService.js');
const {
  ServiceCollection
...
const {
  MarkerService
} = require('../../../platform/markers/common/markerService.js');
const {
  IOpenerService
...
} = require('../../../platform/configuration/common/configurations.js');
const {
  IAccessibilitySignalService
} = require('../../../platform/accessibilitySignal/browser/accessibilitySignalService.service.js');
const {
  LogService
} = require('../../../platform/log/common/logService.js');
const {
  IEnvironmentService
