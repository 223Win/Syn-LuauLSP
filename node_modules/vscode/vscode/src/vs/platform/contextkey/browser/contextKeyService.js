...
const {
  RawContextKey
} = require('../common/contextkey.js');
const {
  IContextKeyService
} = require('../common/contextkey.service.js');
const _moduleId = "vs/platform/contextkey/browser/contextKeyService";
...
CommandsRegistry.registerCommand({
  ...
  metadata: {
    description: localizeWithPath(_moduleId, 0, "A command that returns information about context keys"),
    args: []
  }
});
