...
const {
  NoMatchingKb
} = require('./keybindingResolver.js');
const _moduleId = "vs/platform/keybinding/common/abstractKeybindingService";
...
class AbstractKeybindingService extends Disposable {
  ...
  _expectAnotherChord(firstChord, keypressLabel) {
    ...
    switch (this._currentChords.length) {
      ...
      case 1:
        this._currentChordStatusMessage = this._notificationService.status(localizeWithPath(_moduleId, 0, "({0}) was pressed. Waiting for second key of chord...", keypressLabel));
        break;
      default:
        {
          ...
          this._currentChordStatusMessage = this._notificationService.status(localizeWithPath(_moduleId, 1, "({0}) was pressed. Waiting for next key of chord...", fullKeypressLabel));
        }
    }
      ...
      case 0:
        {
          ...
          if (this.inChordMode) {
            ...
            this._notificationService.status(localizeWithPath(_moduleId, 2, "The key combination ({0}, {1}) is not a command.", currentChordsLabel, keypressLabel), {
              hideAfter: 10 * 1000
            });
            this._leaveChordMode();
