...
const _moduleId = "vs/platform/userDataSync/common/userDataSyncMachines";
...
let UserDataSyncMachinesService = class UserDataSyncMachinesService extends Disposable {
  ...
  async readMachinesData(manifest) {
    ...
    if (machinesData.version !== UserDataSyncMachinesService_1.VERSION) {
      throw new Error(localizeWithPath(_moduleId, 0, "Cannot read machines data as the current version is incompatible. Please update {0} and try again.", this.productService.nameLong));
    }
    return machinesData;
  }
