...
const {
  ...
  hasNoContent,
  asText
} = require('../../request/common/request.js');
const {
  IRequestService
} = require('../../request/common/request.service.js');
const {
  getServiceMachineId
} = require('../../externalServices/common/serviceMachineId.js');
const {
  IStorageService
} = require('../../storage/common/storage.service.js');
const {
  UserDataSyncStoreError,
  HEADER_OPERATION_ID,
  HEADER_EXECUTION_ID,
  SYNC_SERVICE_URL_TYPE
} = require('./userDataSync.js');
const {
  IUserDataSyncLogService,
  IUserDataSyncStoreManagementService
} = require('./userDataSync.service.js');
...
let AbstractUserDataSyncStoreManagementService = class AbstractUserDataSyncStoreManagementService extends Disposable {
  ...
  toUserDataSyncStore(configurationSyncStore) {
    ...
    configurationSyncStore = isWeb && configurationSyncStore.web ? {
      ...configurationSyncStore,
      ...configurationSyncStore.web
    } : configurationSyncStore;
...
AbstractUserDataSyncStoreManagementService = __decorate([__param(0, IProductService), __param(1, IConfigurationService), __param(2, IStorageService)], AbstractUserDataSyncStoreManagementService);
...
UserDataSyncStoreManagementService = __decorate([__param(0, IProductService), __param(1, IConfigurationService), __param(2, IStorageService)], UserDataSyncStoreManagementService);
let UserDataSyncStoreClient = class UserDataSyncStoreClient extends Disposable {
  ...
  async getAllCollections(headers = {}) {
    ...
    const context = await this.request(url, {
      type: 'GET',
      headers
    }, [], CancellationToken.None);
    return (await asJson(context))?.map(({
      id
    }) => id) || [];
  }
  ...
  async getAllResourceRefs(resource, collection) {
    ...
    const headers = {};
    const context = await this.request(uri.toString(), {
      type: 'GET',
      headers
    }, [], CancellationToken.None);
...
UserDataSyncStoreClient = __decorate([__param(1, IProductService), __param(2, IRequestService), __param(3, IUserDataSyncLogService), __param(4, IEnvironmentService), __param(5, IFileService), __param(6, IStorageService)], UserDataSyncStoreClient);
...
UserDataSyncStoreService = __decorate([__param(0, IUserDataSyncStoreManagementService), __param(1, IProductService), __param(2, IRequestService), __param(3, IUserDataSyncLogService), __param(4, IEnvironmentService), __param(5, IFileService), __param(6, IStorageService)], UserDataSyncStoreService);
