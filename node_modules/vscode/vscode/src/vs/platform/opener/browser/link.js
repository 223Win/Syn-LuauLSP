...
const {
  IOpenerService
} = require('../common/opener.service.js');
const {} = require('./link.css.js');
const {
...
let Link = class Link extends Disposable {
  ...
  constructor(container, _link, options = {}, _hoverService, openerService) {
    ...
    const onEnterPress = Event.chain(onKeyPress.event, $ => $.map(e => new StandardKeyboardEvent(e)).filter(e => e.keyCode === 3));
