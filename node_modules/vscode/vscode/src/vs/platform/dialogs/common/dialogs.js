...
const {} = require('../../../base/common/labels.js');
...
function getFileNamesMessage(fileNamesOrResources) {
  ...
  if (fileNamesOrResources.length > MAX_CONFIRM_FILES) {
    if (fileNamesOrResources.length - MAX_CONFIRM_FILES === 1) {
      ...
      message.push(localizeWithPath(_moduleId, 4, "...{0} additional files not shown", fileNamesOrResources.length - MAX_CONFIRM_FILES));
    }
  }
  message.push('');
  return message.join('\n');
