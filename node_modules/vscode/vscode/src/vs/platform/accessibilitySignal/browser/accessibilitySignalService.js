...
let AccessibilitySignalService = class AccessibilitySignalService extends Disposable {
  constructor(configurationService, accessibilityService, telemetryService) {
    ...
    this._signalConfigValue = new CachedFunction(signal => observableConfigValue(signal.settingsKey, this.configurationService));
...
exports.AcknowledgeDocCommentsToken = AcknowledgeDocCommentsToken;
exports.Sound = Sound;
