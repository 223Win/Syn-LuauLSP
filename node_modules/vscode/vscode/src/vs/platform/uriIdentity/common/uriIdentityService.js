...
const {} = require('../../instantiation/common/instantiation.js');
const {
  IFileService
...
const {
  SkipList
} = require('../../../base/common/skipList.js');
const {
  Event
...
UriIdentityService = __decorate([__param(0, IFileService)], UriIdentityService);
