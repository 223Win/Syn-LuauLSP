...
let QuickInputController = class QuickInputController extends Disposable {
  ...
  getUI(showInActiveContainer) {
    ...
    const visibleCount = new CountBadge(visibleCountContainer, {
      countFormat: localizeWithPath(_moduleId, 1, "{0} Results")
    }, this.styles.countBadge);
    const countContainer = append(filterContainer, $('.quick-input-count'));
    countContainer.setAttribute('aria-live', 'polite');
    const count = new CountBadge(countContainer, {
      countFormat: localizeWithPath(_moduleId, 2, "{0} Selected")
    }, this.styles.countBadge);
...
QuickInputController = QuickInputController_1 = __decorate([__param(1, ILayoutService), __param(2, IInstantiationService)], QuickInputController);
