...
const {
  WorkbenchObjectTree
} = require('../../list/browser/listService.js');
const {
  IThemeService
...
const _moduleId = "vs/platform/quickinput/browser/quickInputTree";
const $ = $$1;
...
class QuickInputAccessibilityProvider {
  getWidgetAriaLabel() {
    return localizeWithPath(_moduleId, 0, "Quick Input");
  }
...
let QuickInputTree = class QuickInputTree extends Disposable {
  ...
  _registerHoverListeners() {
    ...
    this._register(this._tree.onMouseOver(async e => {
      ...
      if (!(e.browserEvent.relatedTarget instanceof HTMLAnchorElement) && isAncestor(e.browserEvent.relatedTarget, e.element?.element)) {
        return;
      }
      try {
  ...
  getFocusedElements() {
    return this._tree.getFocus().filter(e => !!e).map(e => e.item).filter(e => !!e);
  }
  ...
  getSelectedElements() {
    return this._tree.getSelection().filter(e => !!e && !!e.item).map(e => e.item);
  }
...
QuickInputTree.__decorator = __decorate([memoize], QuickInputTree.prototype, "onDidChangeFocus", null);
QuickInputTree.__decorator = __decorate([memoize], QuickInputTree.prototype, "onDidChangeSelection", null);
...
exports.QuickInputListFocus = QuickInputListFocus;
