      ...
      definitions: {
        style: {
          ...
          properties: {
            ...
            fontStyle: {
              type: 'string',
              description: localizeWithPath(_moduleId, 3, 'Sets the all font styles of the rule: \'italic\', \'bold\', \'underline\' or \'strikethrough\' or a combination. All styles that are not listed are unset. The empty string unsets all styles.'),
              pattern: fontStylePattern,
              patternErrorMessage: localizeWithPath(_moduleId, 4, 'Font style must be \'italic\', \'bold\', \'underline\' or \'strikethrough\' or a combination. The empty string unsets all styles.'),
              defaultSnippets: [{
                label: localizeWithPath(_moduleId, 5, 'None (clear inherited style)'),
                bodyText: '""'
              }, {
                body: 'italic'
              }, {
            ...
            bold: {
              type: 'boolean',
              description: localizeWithPath(_moduleId, 6, 'Sets or unsets the font style to bold. Note, the presence of \'fontStyle\' overrides this setting.')
            },
            italic: {
              type: 'boolean',
              description: localizeWithPath(_moduleId, 7, 'Sets or unsets the font style to italic. Note, the presence of \'fontStyle\' overrides this setting.')
            },
            underline: {
              type: 'boolean',
              description: localizeWithPath(_moduleId, 8, 'Sets or unsets the font style to underline. Note, the presence of \'fontStyle\' overrides this setting.')
            },
            strikethrough: {
              type: 'boolean',
              description: localizeWithPath(_moduleId, 9, 'Sets or unsets the font style to strikethrough. Note, the presence of \'fontStyle\' overrides this setting.')
            }
          },
          defaultSnippets: [{
            body: {
...
exports.SemanticTokenRule = SemanticTokenRule;
...
exports.tokenStylingSchemaId = tokenStylingSchemaId;
exports.typeAndModifierIdPattern = typeAndModifierIdPattern;