...
} = require('../../../base/common/codiconsUtil.js');
const {
  ThemeIcon
      ...
      definitions: {
        icons: {
          ...
          properties: {
            fontId: {
              type: 'string',
              description: localizeWithPath(_moduleId, 0, 'The id of the font to use. If not set, the font that is defined first is used.')
            },
            fontCharacter: {
              type: 'string',
              description: localizeWithPath(_moduleId, 1, 'The font character associated with the icon definition.')
            }
          },
...
const widgetClose = registerIcon('widget-close', Codicon.close, localizeWithPath(_moduleId, 2, 'Icon for the close action in widgets.'));
const gotoPreviousLocation = registerIcon('goto-previous-location', Codicon.arrowUp, localizeWithPath(_moduleId, 3, 'Icon for goto previous editor location.'));
const gotoNextLocation = registerIcon('goto-next-location', Codicon.arrowDown, localizeWithPath(_moduleId, 4, 'Icon for goto next editor location.'));
...
exports.IconFontDefinition = IconFontDefinition;
exports.getIconRegistry = getIconRegistry;
exports.gotoNextLocation = gotoNextLocation;
exports.gotoPreviousLocation = gotoPreviousLocation;
exports.iconsSchemaId = iconsSchemaId;
exports.registerIcon = registerIcon;
exports.spinningLoading = spinningLoading;
