...
const Extensions = require('../../jsonschemas/common/jsonContributionRegistry.js').Extensions;
      ...
      for (const key in overrides) {
        ...
        if (OVERRIDE_PROPERTY_REGEX.test(key)) {
          ...
          const property = {
            ...
            description: localizeWithPath(_moduleId, 1, "Configure settings to be overridden for the {0} language.", plainKey),
...
function validateProperty(property, schema) {
  ...
  if (OVERRIDE_PROPERTY_REGEX.test(property)) {
    return localizeWithPath(_moduleId, 5, "Cannot register '{0}'. This matches property pattern '\\\\[.*\\\\]$' for describing language specific editor settings. Use 'configurationDefaults' contribution.", property);
  }
  if (configurationRegistry.getConfigurationProperties()[property] !== undefined) {
    return localizeWithPath(_moduleId, 6, "Cannot register '{0}'. This property is already registered.", property);
  }
  if (schema.policy?.name && configurationRegistry.getPolicyConfigurations().get(schema.policy?.name) !== undefined) {
    return localizeWithPath(_moduleId, 7, "Cannot register '{0}'. The associated policy {1} is already registered with {2}.", property, schema.policy?.name, configurationRegistry.getPolicyConfigurations().get(schema.policy?.name));
  }
  return null;
}
function getScopes() {
...
exports.EditPresentationTypes = EditPresentationTypes;
exports.Extensions = Extensions$1;
exports.OVERRIDE_PROPERTY_PATTERN = OVERRIDE_PROPERTY_PATTERN;
exports.OVERRIDE_PROPERTY_REGEX = OVERRIDE_PROPERTY_REGEX;
exports.allSettings = allSettings;
exports.applicationSettings = applicationSettings;
exports.configurationDefaultsSchemaId = configurationDefaultsSchemaId;
exports.getDefaultValue = getDefaultValue;
exports.getScopes = getScopes;
exports.keyFromOverrideIdentifiers = keyFromOverrideIdentifiers;
exports.machineOverridableSettings = machineOverridableSettings;
exports.machineSettings = machineSettings;
exports.overrideIdentifiersFromKey = overrideIdentifiersFromKey;
exports.resourceLanguageSettingsSchemaId = resourceLanguageSettingsSchemaId;
