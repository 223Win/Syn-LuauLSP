...
const {} = require('./menuEntryActionViewItem.css.js');
const {
  localizeWithPath
} = require('../../../nls.js');
const {
...
} = require('../../action/common/action.js');
const {
  IContextKeyService
...
} = require('../../accessibility/common/accessibility.service.js');
const _moduleId = "vs/platform/actions/browser/menuEntryActionViewItem";
...
let MenuEntryActionViewItem = class MenuEntryActionViewItem extends ActionViewItem {
  ...
  getTooltip() {
    ...
    let title = keybindingLabel ? localizeWithPath(_moduleId, 0, "{0} ({1})", tooltip, keybindingLabel) : tooltip;
    if (!this._wantsAltCommand && this._menuItemAction.alt?.enabled) {
      const altTooltip = this._menuItemAction.alt.tooltip || this._menuItemAction.alt.label;
      const altKeybinding = this._keybindingService.lookupKeybinding(this._menuItemAction.alt.id, this._contextKeyService);
      const altKeybindingLabel = altKeybinding && altKeybinding.getLabel();
      const altTitleSection = altKeybindingLabel ? localizeWithPath(_moduleId, 0, "{0} ({1})", altTooltip, altKeybindingLabel) : altTooltip;
      title = localizeWithPath(_moduleId, 1, "{0}\n[{1}] {2}", title, UILabelProvider.modifierLabels[OS].altKey, altTitleSection);
    }
    return title;
  }
  updateClass() {
