...
const {} = require('../../../base/common/platform.js');
const {
...
let AbstractTunnelService = class AbstractTunnelService {
  ...
  addTunnelToMap(remoteHost, remotePort, tunnel) {
    ...
    this._tunnels.get(remoteHost).set(remotePort, {
      refcount: 1,
      value: tunnel
    });
  }
...
AbstractTunnelService = __decorate([__param(0, ILogService), __param(1, IConfigurationService)], AbstractTunnelService);
exports.ALL_INTERFACES_ADDRESSES = ALL_INTERFACES_ADDRESSES;
exports.AbstractTunnelService = AbstractTunnelService;
exports.DisposableTunnel = DisposableTunnel;
exports.LOCALHOST_ADDRESSES = LOCALHOST_ADDRESSES;
exports.ProvidedOnAutoForward = ProvidedOnAutoForward;
exports.TunnelPrivacyId = TunnelPrivacyId;
