...
} = require('../../../../platform/remote/common/remoteAuthorityResolver.service.js');
const {
  IStorageService
...
} = require('../../environment/common/environmentService.service.js');
const {
  IExtensionService
...
const _moduleId = "vs/workbench/services/remote/common/tunnelModel";
...
const forwardedPortsViewEnabled = new RawContextKey('forwardedPortsViewEnabled', false, localizeWithPath(_moduleId, 0, "Whether the Ports view is enabled."));
...
const UserTunnelSource = {
  ...
  description: localizeWithPath(_moduleId, 1, "User Forwarded")
};
const AutoTunnelSource = {
  source: TunnelSource.Auto,
  description: localizeWithPath(_moduleId, 2, "Auto Forwarded")
};
...
let TunnelModel = class TunnelModel extends Disposable {
  ...
  async showPortMismatchModalIfNeeded(tunnel, expectedLocal, attributes) {
    ...
    const mismatchString = localizeWithPath(_moduleId, 3, "Local port {0} could not be used for forwarding to remote port {1}.\n\nThis usually happens when there is already another process using local port {0}.\n\nPort number {2} has been used instead.", expectedLocal, tunnel.tunnelRemotePort, tunnel.tunnelLocalPort);
      ...
      for (const tunnel of tunnels) {
        ...
        this.detected.set(makeAddress(tunnel.remoteAddress.host, tunnel.remoteAddress.port), {
          ...
          source: {
            ...
            description: localizeWithPath(_moduleId, 4, "Statically Forwarded")
          }
        });
...
exports.ACTIVATION_EVENT = ACTIVATION_EVENT;
exports.AutoTunnelSource = AutoTunnelSource;
exports.OnPortForward = OnPortForward;
exports.PortsAttributes = PortsAttributes;
exports.TunnelCloseReason = TunnelCloseReason;
exports.TunnelModel = TunnelModel;
exports.TunnelSource = TunnelSource;
exports.UserTunnelSource = UserTunnelSource;
exports.forwardedPortsViewEnabled = forwardedPortsViewEnabled;
