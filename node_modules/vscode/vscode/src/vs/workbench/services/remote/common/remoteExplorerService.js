...
const remoteHelpExtPoint = ExtensionsRegistry.registerExtensionPoint({
  ...
  jsonSchema: {
    ...
    properties: {
      'getStarted': {
        description: localizeWithPath(_moduleId, 2, "The url, or a command that returns the url, to your project's Getting Started page, or a walkthrough ID contributed by your project's extension"),
        oneOf: [{
          type: 'string'
        }, getStartedWalkthrough]
      },
      'documentation': {
        description: localizeWithPath(_moduleId, 3, "The url, or a command that returns the url, to your project's documentation page"),
        type: 'string'
      },
      'feedback': {
        description: localizeWithPath(_moduleId, 4, "The url, or a command that returns the url, to your project's feedback reporter"),
        type: 'string',
        markdownDeprecationMessage: localizeWithPath(_moduleId, 5, "Use {0} instead", '`reportIssue`')
      },
      'reportIssue': {
        description: localizeWithPath(_moduleId, 6, "The url, or a command that returns the url, to your project's issue reporter"),
        type: 'string'
      },
      'issues': {
        description: localizeWithPath(_moduleId, 7, "The url, or a command that returns the url, to your project's issues list"),
        type: 'string'
      }
    }
  }
...
exports.PORT_AUTO_FALLBACK_SETTING = PORT_AUTO_FALLBACK_SETTING;
exports.PORT_AUTO_FORWARD_SETTING = PORT_AUTO_FORWARD_SETTING;
exports.PORT_AUTO_SOURCE_SETTING = PORT_AUTO_SOURCE_SETTING;
exports.PORT_AUTO_SOURCE_SETTING_HYBRID = PORT_AUTO_SOURCE_SETTING_HYBRID;
exports.PORT_AUTO_SOURCE_SETTING_OUTPUT = PORT_AUTO_SOURCE_SETTING_OUTPUT;
exports.PORT_AUTO_SOURCE_SETTING_PROCESS = PORT_AUTO_SOURCE_SETTING_PROCESS;
exports.REMOTE_EXPLORER_TYPE_KEY = REMOTE_EXPLORER_TYPE_KEY;
exports.RemoteExplorerService = RemoteExplorerService;
exports.TUNNEL_VIEW_CONTAINER_ID = TUNNEL_VIEW_CONTAINER_ID;
exports.TUNNEL_VIEW_ID = TUNNEL_VIEW_ID;
exports.TunnelEditId = TunnelEditId;
exports.TunnelType = TunnelType;