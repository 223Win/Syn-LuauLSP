...
} = require('../../workingCopy/common/workingCopyBackup.service.js');
const {
  ETAG_DISABLED,
...
const {
  IWorkingCopyService
} = require('../../workingCopy/common/workingCopyService.service.js');
const {
  NO_TYPE_ID
} = require('../../workingCopy/common/workingCopy.js');
const {
...
} = require('../../languageDetection/common/languageDetectionWorkerService.service.js');
const {
  IPathService
} = require('../../path/common/pathService.service.js');
const {
  extUri
...
const _moduleId = "vs/workbench/services/textfile/common/textFileEditorModel";
let TextFileEditorModel = class TextFileEditorModel extends BaseTextEditorModel {
  static {
    TextFileEditorModel_1 = this;
  }
  static {
    this.TEXTFILE_SAVE_ENCODING_SOURCE = SaveSourceRegistry.registerSource('textFileEncoding.source', localizeWithPath(_moduleId, 0, "File Encoding Changed"));
  }
  static {
...
TextFileEditorModel = TextFileEditorModel_1 = __decorate([__param(3, ILanguageService), __param(4, IModelService), __param(5, IFileService), __param(6, ITextFileService), __param(7, IWorkingCopyBackupService), __param(8, ILogService), __param(9, IWorkingCopyService), __param(10, IFilesConfigurationService), __param(11, ILabelService), __param(12, ILanguageDetectionService), __param(13, IAccessibilityService), __param(14, IPathService), __param(15, IExtensionService)], TextFileEditorModel);
