...
const {
  ...
  Extensions,
  PaneComposite
} = require('../../../browser/panecomposite.js');
const {
...
} = require('../../editor/common/editorGroupsService.service.js');
const {
  FilterViewPaneContainer
} = require('../../../browser/parts/views/viewsViewlet.js');
const {
  IPaneCompositePartService
} = require('../../panecomposite/browser/panecomposite.service.js');
const {
  IEditorService
} = require('../../editor/common/editorService.service.js');
const {
  IViewsService
} = require('../common/viewsService.service.js');
const _moduleId = "vs/workbench/services/views/browser/viewsService";
let ViewsService = class ViewsService extends Disposable {
  ...
  onDidRegisterViewContainer(viewContainer, viewContainerLocation) {
    ...
    this._register(viewContainerModel.onDidChangeAllViewDescriptors(({
      added,
      removed
    }) => {
  ...
  getFocusedViewName() {
    ...
    const textEditorFocused = this.editorService.activeTextEditorControl?.hasTextFocus() ? localizeWithPath(_moduleId, 0, "Text Editor") : undefined;
          ...
          super({
            ...
            get title() {
              ...
              if (viewContainerLocation === 0) {
                return {
                  value: localizeWithPath(_moduleId, 1, "Show {0}", localizedTitle),
                  original: `Show ${originalTitle}`
                };
              } else {
                return {
                  value: localizeWithPath(_moduleId, 2, "Toggle {0}", localizedTitle),
  ...
  registerFocusViewAction(viewDescriptor, category) {
    return registerAction2(class FocusViewAction extends Action2 {
      constructor() {
        const title = localize2WithPath(_moduleId, 3, "Focus on {0} View", viewDescriptor.name.value);
        super({
    ...
    return registerAction2(class ResetViewLocationAction extends Action2 {
      constructor() {
        super({
          ...
          title: localize2WithPath(_moduleId, 4, "Reset Location"),
          menu: [{
