...
const {
  ExtensionsRegistry
} = require('../../extensions/common/extensionsRegistry.js');
const {
  Extensions$1
...
const {
  Extensions
} = require('../../extensionManagement/common/extensionFeatures.js');
const {
  SyncDescriptor
    ...
    items: {
      ...
      properties: {
        id: {
          ...
          patternErrorMessage: localizeWithPath(_moduleId, 2, 'Identifiers must only contain letters, digits and dots and can not start with a dot')
        },
        description: {
          type: 'string',
        ...
        defaults: {
          ...
          properties: {
            light: {
              description: localizeWithPath(_moduleId, 4, 'The default color for light themes. Either a color value in hex (#RRGGBB[AA]) or the identifier of a themable color which provides the default.'),
              type: 'string',
            ...
            dark: {
              description: localizeWithPath(_moduleId, 5, 'The default color for dark themes. Either a color value in hex (#RRGGBB[AA]) or the identifier of a themable color which provides the default.'),
              type: 'string',
              anyOf: [colorReferenceSchema, {
                type: 'string',
                format: 'color-hex'
            ...
            highContrast: {
              description: localizeWithPath(_moduleId, 6, 'The default color for high contrast dark themes. Either a color value in hex (#RRGGBB[AA]) or the identifier of a themable color which provides the default. If not provided, the `dark` color is used as default for high contrast dark themes.'),
              type: 'string',
              anyOf: [colorReferenceSchema, {
                type: 'string',
                format: 'color-hex'
            ...
            highContrastLight: {
              description: localizeWithPath(_moduleId, 7, 'The default color for high contrast light themes. Either a color value in hex (#RRGGBB[AA]) or the identifier of a themable color which provides the default. If not provided, the `light` color is used as default for high contrast light themes.'),
              type: 'string',
              anyOf: [colorReferenceSchema, {
                type: 'string',
                format: 'color-hex'
    ...
    configurationExtPoint.setHandler((extensions, delta) => {
      for (const extension of delta.added) {
        ...
        const parseColorValue = (s, name) => {
          ...
          collector.error(localizeWithPath(_moduleId, 9, "{0} must be either a color value in hex (#RRGGBB[AA] or #RGB[A]) or the identifier of a themable color which provides the default.", name));
          return Color.red;
        };
        for (const colorContribution of extensionValue) {
          if (typeof colorContribution.id !== 'string' || colorContribution.id.length === 0) {
            collector.error(localizeWithPath(_moduleId, 10, "'configuration.colors.id' must be defined and can not be empty"));
            return;
          }
          if (!colorContribution.id.match(colorIdPattern)) {
            collector.error(localizeWithPath(_moduleId, 11, "'configuration.colors.id' must only contain letters, digits and dots and can not start with a dot"));
            return;
          }
          if (typeof colorContribution.description !== 'string' || colorContribution.id.length === 0) {
            collector.error(localizeWithPath(_moduleId, 12, "'configuration.colors.description' must be defined and can not be empty"));
            return;
          }
          ...
          if (!defaults || typeof defaults !== 'object' || typeof defaults.light !== 'string' || typeof defaults.dark !== 'string') {
            collector.error(localizeWithPath(_moduleId, 13, "'configuration.colors.defaults' must be defined and must contain 'light' and 'dark'"));
            return;
          }
          if (defaults.highContrast && typeof defaults.highContrast !== 'string') {
            collector.error(localizeWithPath(_moduleId, 14, "If defined, 'configuration.colors.defaults.highContrast' must be a string."));
            return;
          }
          if (defaults.highContrastLight && typeof defaults.highContrastLight !== 'string') {
            collector.error(localizeWithPath(_moduleId, 15, "If defined, 'configuration.colors.defaults.highContrastLight' must be a string."));
            return;
          }
...
class ColorDataRenderer extends Disposable {
  ...
  render(manifest) {
    ...
    const headers = [localizeWithPath(_moduleId, 16, "ID"), localizeWithPath(_moduleId, 17, "Description"), localizeWithPath(_moduleId, 18, "Dark Default"), localizeWithPath(_moduleId, 19, "Light Default"), localizeWithPath(_moduleId, 20, "High Contrast Default")];
