...
} = require('../../../../base/common/keybindingLabels.js');
const {
  MenuRegistry
...
} = require('../../keybinding/browser/unboundCommands.js');
const {
  isString,
  isEmptyObject
...
const _moduleId = "vs/workbench/services/preferences/browser/keybindingsEditorModel";
const KEYBINDING_ENTRY_TEMPLATE_ID = 'keybinding.entry.template';
const SOURCE_SYSTEM = localizeWithPath(_moduleId, 0, "System");
const SOURCE_EXTENSION = localizeWithPath(_moduleId, 1, "Extension");
const SOURCE_USER = localizeWithPath(_moduleId, 2, "User");
  ...
  static getCommandDefaultLabel(menuCommand) {
    if (!Language.isDefaultVariant()) {
      if (menuCommand && menuCommand.title && menuCommand.title.original) {
        ...
        return category ? localizeWithPath(_moduleId, 3, "{0}: {1}", category, title) : title;
      }
    }
    return null;
  }
...
class KeybindingItemMatches {
  ...
  wordMatchesAltModifier(word) {
    ...
    if (equalsIgnoreCase(localizeWithPath(_moduleId, 4, "option"), word)) {
      return true;
    }
    return false;
  }
  ...
  wordMatchesMetaModifier(word) {
    ...
    if (equalsIgnoreCase(localizeWithPath(_moduleId, 5, "meta"), word)) {
      return true;
    }
    return false;
  }
...
exports.KEYBINDING_ENTRY_TEMPLATE_ID = KEYBINDING_ENTRY_TEMPLATE_ID;
