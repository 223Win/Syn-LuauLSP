...
class ReplacePattern {
  constructor(replaceString, arg2, arg3) {
    ...
    if (typeof arg2 === 'boolean') {
      ...
      this._regExp = createRegExp(searchPatternInfo.pattern, !!searchPatternInfo.isRegExp, {
    ...
    if (this._regExp.global) {
      this._regExp = createRegExp(this._regExp.source, true, {
