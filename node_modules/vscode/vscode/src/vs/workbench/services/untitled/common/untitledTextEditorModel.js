...
const {
  ITextFileService
} = require('../../textfile/common/textfiles.service.js');
const {
  assertIsDefined
...
} = require('../../../../editor/common/core/wordHelper.js');
const {
  IEditorService
...
const {
  UTF8
} = require('../../textfile/common/encoding.js');
const {
  bufferToReadable,
  VSBuffer,
  bufferToStream
...
let UntitledTextEditorModel = class UntitledTextEditorModel extends BaseTextEditorModel {
  ...
  static {
    this.FIRST_LINE_NAME_CANDIDATE_MAX_LENGTH = UntitledTextEditorModel_1.FIRST_LINE_NAME_MAX_LENGTH * 10;
  }
  static {
...
UntitledTextEditorModel = UntitledTextEditorModel_1 = __decorate([__param(5, ILanguageService), __param(6, IModelService), __param(7, IWorkingCopyBackupService), __param(8, ITextResourceConfigurationService), __param(9, IWorkingCopyService), __param(10, ITextFileService), __param(11, ILabelService), __param(12, IEditorService), __param(13, ILanguageDetectionService), __param(14, IAccessibilityService)], UntitledTextEditorModel);
