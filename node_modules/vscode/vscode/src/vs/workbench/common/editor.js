...
const DEFAULT_EDITOR_ASSOCIATION = {
  id: 'default',
  displayName: localizeWithPath(_moduleId, 0, "Text Editor"),
  providerDisplayName: localizeWithPath(_moduleId, 1, "Built-in")
};
...
function createTooLargeFileError(group, input, options, message, preferencesService) {
  return createEditorOpenError(message, [toAction({
    ...
    label: localizeWithPath(_moduleId, 3, "Configure Limit"),
    run: () => {
...
exports.BINARY_DIFF_EDITOR_ID = BINARY_DIFF_EDITOR_ID;
exports.CloseDirection = CloseDirection;
exports.DEFAULT_EDITOR_ASSOCIATION = DEFAULT_EDITOR_ASSOCIATION;
exports.EditorCloseContext = EditorCloseContext;
exports.EditorCloseMethod = EditorCloseMethod;
exports.EditorExtensions = EditorExtensions;
exports.EditorInputCapabilities = EditorInputCapabilities;
exports.EditorResourceAccessor = EditorResourceAccessor;
exports.EditorsOrder = EditorsOrder;
exports.SIDE_BY_SIDE_EDITOR_ID = SIDE_BY_SIDE_EDITOR_ID;
exports.SaveSourceRegistry = SaveSourceRegistry;
exports.SideBySideEditor = SideBySideEditor;
exports.TEXT_DIFF_EDITOR_ID = TEXT_DIFF_EDITOR_ID;
