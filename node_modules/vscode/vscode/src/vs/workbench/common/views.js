...
const VIEWS_LOG_NAME = localizeWithPath(_moduleId, 0, "Views");
const defaultViewIcon = registerIcon('default-view-icon', Codicon.window, localizeWithPath(_moduleId, 1, 'Default view icon.'));
var Extensions;
(function (Extensions) {
  ...
  addViews(viewDescriptors, viewContainer) {
    ...
    for (const viewDescriptor of viewDescriptors) {
      if (this.getView(viewDescriptor.id) !== null) {
        throw new Error(localizeWithPath(_moduleId, 2, "A view with id '{0}' is already registered", viewDescriptor.id));
      }
...
class NoTreeViewError extends Error {
  constructor(treeViewId) {
    super(localizeWithPath(_moduleId, 3, 'No tree view with id \'{0}\' registered.', treeViewId));
...
exports.VIEWS_LOG_ID = VIEWS_LOG_ID;
exports.VIEWS_LOG_NAME = VIEWS_LOG_NAME;
exports.ViewContainerLocation = ViewContainerLocation;
exports.ViewContainerLocationToString = ViewContainerLocationToString;
exports.ViewContainerLocations = ViewContainerLocations;
exports.ViewContentGroups = ViewContentGroups;
exports.ViewVisibilityState = ViewVisibilityState;
exports.defaultViewIcon = defaultViewIcon;