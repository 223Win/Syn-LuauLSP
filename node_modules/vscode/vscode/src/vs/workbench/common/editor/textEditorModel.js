...
const _moduleId = "vs/workbench/common/editor/textEditorModel";
let BaseTextEditorModel = class BaseTextEditorModel extends EditorModel {
  ...
  async doAutoDetectLanguage() {
    ...
    if (lang && lang !== prevLang && !this.isDisposed()) {
      ...
      this.accessibilityService.alert(localizeWithPath(_moduleId, 0, "Language {0} was automatically detected and set as the language mode.", languageName ?? lang));
    }
  }
