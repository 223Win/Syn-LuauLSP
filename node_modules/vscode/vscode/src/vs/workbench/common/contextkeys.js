...
const WorkbenchStateContext = new RawContextKey('workbenchState', undefined, {
  type: 'string',
  description: localizeWithPath(_moduleId, 0, "The kind of workspace opened in the window, either 'empty' (no workspace), 'folder' (single folder) or 'workspace' (multi-root workspace)")
});
...
const RemoteNameContext = new RawContextKey('remoteName', '', localizeWithPath(_moduleId, 3, "The name of the remote the window is connected to or an empty string if not connected to any remote"));
const VirtualWorkspaceContext = new RawContextKey('virtualWorkspace', '', localizeWithPath(_moduleId, 4, "The scheme of the current workspace is from a virtual file system or an empty string."));
const TemporaryWorkspaceContext = new RawContextKey('temporaryWorkspace', false, localizeWithPath(_moduleId, 5, "The scheme of the current workspace is from a temporary file system."));
...
const EmbedderIdentifierContext = new RawContextKey('embedderIdentifier', undefined, localizeWithPath(_moduleId, 8, 'The identifier of the embedder according to the product service, if one is defined'));
...
const ActiveEditorCanToggleReadonlyContext = new RawContextKey('activeEditorCanToggleReadonly', true, localizeWithPath(_moduleId, 16, "Whether the active editor can toggle between being read-only or writeable"));
...
const ActiveEditorContext = new RawContextKey('activeEditor', null, {
  type: 'string',
  description: localizeWithPath(_moduleId, 18, "The identifier of the active editor")
});
const ActiveEditorAvailableEditorIdsContext = new RawContextKey('activeEditorAvailableEditorIds', '', localizeWithPath(_moduleId, 19, "The available editor identifiers that are usable for the active editor"));
...
const EditorPartMultipleEditorGroupsContext = new RawContextKey('editorPartMultipleEditorGroups', false, localizeWithPath(_moduleId, 29, "Whether there are multiple editor groups opened in an editor part"));
...
const PanelAlignmentContext = new RawContextKey('panelAlignment', 'center', localizeWithPath(_moduleId, 54, "The alignment of the panel, either 'center', 'left', 'right' or 'justify'"));
...
let ResourceContextKey = class ResourceContextKey {
  ...
  static {
    this.Scheme = new RawContextKey('resourceScheme', undefined, {
      type: 'string',
      description: localizeWithPath(_moduleId, 58, "The scheme of the resource")
    });
  }
  static {
    this.Filename = new RawContextKey('resourceFilename', undefined, {
      type: 'string',
      description: localizeWithPath(_moduleId, 59, "The file name of the resource")
    });
  }
  static {
    this.Dirname = new RawContextKey('resourceDirname', undefined, {
      type: 'string',
      description: localizeWithPath(_moduleId, 60, "The folder name the resource is contained in")
    });
  }
  static {
    this.Path = new RawContextKey('resourcePath', undefined, {
      type: 'string',
      description: localizeWithPath(_moduleId, 61, "The full path of the resource")
    });
  }
  static {
    this.LangId = new RawContextKey('resourceLangId', undefined, {
      type: 'string',
      description: localizeWithPath(_moduleId, 62, "The language identifier of the resource")
    });
  }
  static {
    this.Resource = new RawContextKey('resource', undefined, {
      type: 'URI',
      description: localizeWithPath(_moduleId, 63, "The full value of the resource including scheme and path")
    });
  }
  static {
    this.Extension = new RawContextKey('resourceExtname', undefined, {
      type: 'string',
      description: localizeWithPath(_moduleId, 64, "The extension name of the resource")
    });
  }
  static {
    this.HasResource = new RawContextKey('resourceSet', undefined, {
      type: 'boolean',
      description: localizeWithPath(_moduleId, 65, "Whether a resource is present or not")
    });
  }
  static {
    this.IsFileSystemResource = new RawContextKey('isFileSystemResource', undefined, {
      type: 'boolean',
      description: localizeWithPath(_moduleId, 66, "Whether the resource is backed by a file system provider")
    });
  }
...
ResourceContextKey = ResourceContextKey_1 = __decorate([__param(0, IContextKeyService), __param(1, IFileService), __param(2, ILanguageService), __param(3, IModelService)], ResourceContextKey);
...
exports.ActiveAuxiliaryContext = ActiveAuxiliaryContext;
exports.ActiveCompareEditorCanSwapContext = ActiveCompareEditorCanSwapContext;
exports.ActiveEditorAvailableEditorIdsContext = ActiveEditorAvailableEditorIdsContext;
exports.ActiveEditorCanRevertContext = ActiveEditorCanRevertContext;
exports.ActiveEditorCanSplitInGroupContext = ActiveEditorCanSplitInGroupContext;
exports.ActiveEditorCanToggleReadonlyContext = ActiveEditorCanToggleReadonlyContext;
exports.ActiveEditorContext = ActiveEditorContext;
exports.ActiveEditorDirtyContext = ActiveEditorDirtyContext;
exports.ActiveEditorFirstInGroupContext = ActiveEditorFirstInGroupContext;
exports.ActiveEditorGroupEmptyContext = ActiveEditorGroupEmptyContext;
exports.ActiveEditorGroupIndexContext = ActiveEditorGroupIndexContext;
exports.ActiveEditorGroupLastContext = ActiveEditorGroupLastContext;
exports.ActiveEditorGroupLockedContext = ActiveEditorGroupLockedContext;
exports.ActiveEditorLastInGroupContext = ActiveEditorLastInGroupContext;
exports.ActiveEditorPinnedContext = ActiveEditorPinnedContext;
exports.ActiveEditorReadonlyContext = ActiveEditorReadonlyContext;
exports.ActiveEditorStickyContext = ActiveEditorStickyContext;
exports.ActivePanelContext = ActivePanelContext;
exports.ActiveViewletContext = ActiveViewletContext;
exports.AuxiliaryBarFocusContext = AuxiliaryBarFocusContext;
exports.AuxiliaryBarVisibleContext = AuxiliaryBarVisibleContext;
exports.BannerFocused = BannerFocused;
exports.DirtyWorkingCopiesContext = DirtyWorkingCopiesContext;
exports.EditorGroupEditorsCountContext = EditorGroupEditorsCountContext;
exports.EditorPartMaximizedEditorGroupContext = EditorPartMaximizedEditorGroupContext;
exports.EditorPartMultipleEditorGroupsContext = EditorPartMultipleEditorGroupsContext;
exports.EditorTabsVisibleContext = EditorTabsVisibleContext;
exports.EditorsVisibleContext = EditorsVisibleContext;
exports.EmbedderIdentifierContext = EmbedderIdentifierContext;
exports.EmptyWorkspaceSupportContext = EmptyWorkspaceSupportContext;
exports.EnterMultiRootWorkspaceSupportContext = EnterMultiRootWorkspaceSupportContext;
exports.FocusedViewContext = FocusedViewContext;
exports.HasWebFileSystemAccess = HasWebFileSystemAccess;
exports.InEditorZenModeContext = InEditorZenModeContext;
exports.IsAuxiliaryEditorPartContext = IsAuxiliaryEditorPartContext;
exports.IsAuxiliaryWindowFocusedContext = IsAuxiliaryWindowFocusedContext;
exports.IsMainEditorCenteredLayoutContext = IsMainEditorCenteredLayoutContext;
exports.IsMainWindowFullscreenContext = IsMainWindowFullscreenContext;
exports.MainEditorAreaVisibleContext = MainEditorAreaVisibleContext;
exports.MultipleEditorGroupsContext = MultipleEditorGroupsContext;
exports.NotificationFocusedContext = NotificationFocusedContext;
exports.NotificationsCenterVisibleContext = NotificationsCenterVisibleContext;
exports.NotificationsToastsVisibleContext = NotificationsToastsVisibleContext;
exports.OpenFolderWorkspaceSupportContext = OpenFolderWorkspaceSupportContext;
exports.PanelAlignmentContext = PanelAlignmentContext;
exports.PanelFocusContext = PanelFocusContext;
exports.PanelMaximizedContext = PanelMaximizedContext;
exports.PanelPositionContext = PanelPositionContext;
exports.PanelVisibleContext = PanelVisibleContext;
exports.RemoteNameContext = RemoteNameContext;
exports.ResourceContextKey = ResourceContextKey;
exports.SideBarVisibleContext = SideBarVisibleContext;
exports.SideBySideEditorActiveContext = SideBySideEditorActiveContext;
exports.SidebarFocusContext = SidebarFocusContext;
exports.SplitEditorsVertically = SplitEditorsVertically;
exports.StatusBarFocused = StatusBarFocused;
exports.TemporaryWorkspaceContext = TemporaryWorkspaceContext;
exports.TextCompareEditorActiveContext = TextCompareEditorActiveContext;
exports.TextCompareEditorVisibleContext = TextCompareEditorVisibleContext;
exports.TitleBarStyleContext = TitleBarStyleContext;
exports.TitleBarVisibleContext = TitleBarVisibleContext;
exports.VirtualWorkspaceContext = VirtualWorkspaceContext;
exports.WorkbenchStateContext = WorkbenchStateContext;
exports.WorkspaceFolderCountContext = WorkspaceFolderCountContext;
