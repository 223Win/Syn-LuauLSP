...
const _moduleId = "vs/workbench/contrib/codeEditor/browser/toggleMultiCursorModifier";
class ToggleMultiCursorModifierAction extends Action2 {
  ...
  constructor() {
    super({
      ...
      title: localize2WithPath(_moduleId, 0, 'Toggle Multi-Cursor Modifier'),
      f1: true
    });
  }
  run(accessor) {
...
MenuRegistry.appendMenuItem(MenuId.MenubarSelectionMenu, {
  ...
  command: {
    id: ToggleMultiCursorModifierAction.ID,
    title: localizeWithPath(_moduleId, 1, "Switch to Alt+Click for Multi-Cursor")
  },
...
MenuRegistry.appendMenuItem(MenuId.MenubarSelectionMenu, {
  ...
  command: {
    id: ToggleMultiCursorModifierAction.ID,
    title: isMacintosh ? localizeWithPath(_moduleId, 2, "Switch to Cmd+Click for Multi-Cursor") : localizeWithPath(_moduleId, 3, "Switch to Ctrl+Click for Multi-Cursor")
  },
