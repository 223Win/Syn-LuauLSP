const {} = require('./simpleFindWidget.css.js');
const {
  localizeWithPath
} = require('../../../../../nls.js');
const {
...
const _moduleId = "vs/workbench/contrib/codeEditor/browser/find/simpleFindWidget";
...
class SimpleFindWidget extends Widget {
  ...
  _announceSearchResults(label, searchString) {
    if (!searchString) {
      return localizeWithPath(_moduleId, 5, "Enter search input");
    }
    if (label === NLS_NO_RESULTS) {
      return searchString === '' ? localizeWithPath(_moduleId, 6, "{0} found", label) : localizeWithPath(_moduleId, 7, "{0} found for '{1}'", label, searchString);
    }
    return localizeWithPath(_moduleId, 8, "{0} found for '{1}'", label, searchString);
  }
}
const simpleFindWidgetSashBorder = registerColor('simpleFindWidget.sashBorder', {
  ...
  hcDark: '#6FC3DF',
  hcLight: '#0F4A85'
}, localizeWithPath(_moduleId, 9, 'Border color of the sash border.'));
...
exports.simpleFindWidgetSashBorder = simpleFindWidgetSashBorder;