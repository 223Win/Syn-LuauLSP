...
} = require('./interactiveDocumentService.service.js');
const {
  IInteractiveHistoryService
} = require('./interactiveHistoryService.service.js');
const {
  NotebookSetting
} = require('../../notebook/common/notebookCommon.js');
const {
  NotebookEditorInput
} = require('../../notebook/common/notebookEditorInput.js');
const {
  INotebookService
} = require('../../notebook/common/notebookService.service.js');
...
let InteractiveEditorInput = class InteractiveEditorInput extends EditorInput {
  ...
  dispose() {
    this._editorModelReference?.revert({
      soft: true
    });
...
InteractiveEditorInput = InteractiveEditorInput_1 = __decorate([__param(4, IInstantiationService), __param(5, ITextModelService), __param(6, IInteractiveDocumentService), __param(7, IInteractiveHistoryService), __param(8, INotebookService), __param(9, IFileDialogService), __param(10, IConfigurationService)], InteractiveEditorInput);
