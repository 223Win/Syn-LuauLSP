...
function areWebviewContentOptionsEqual(a, b) {
  return a.allowMultipleAPIAcquire === b.allowMultipleAPIAcquire && a.allowScripts === b.allowScripts && a.allowForms === b.allowForms && equals(a.localResourceRoots, b.localResourceRoots, isEqual) && equals(a.portMapping, b.portMapping, (a, b) => a.extensionHostPort === b.extensionHostPort && a.webviewPort === b.webviewPort) && areEnableCommandUrisEqual(a, b);
}
...
exports.KEYBINDING_CONTEXT_WEBVIEW_FIND_WIDGET_ENABLED = KEYBINDING_CONTEXT_WEBVIEW_FIND_WIDGET_ENABLED;
exports.KEYBINDING_CONTEXT_WEBVIEW_FIND_WIDGET_FOCUSED = KEYBINDING_CONTEXT_WEBVIEW_FIND_WIDGET_FOCUSED;
exports.KEYBINDING_CONTEXT_WEBVIEW_FIND_WIDGET_VISIBLE = KEYBINDING_CONTEXT_WEBVIEW_FIND_WIDGET_VISIBLE;
