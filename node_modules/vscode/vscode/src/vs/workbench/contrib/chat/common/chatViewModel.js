...
const {
  ChatModelInitState
} = require('./chatModel.js');
const {
  countWords
} = require('./chatWordCounter.js');
...
let ChatViewModel = class ChatViewModel extends Disposable {
  ...
  updateCodeBlockTextModels(model) {
    ...
    marked_1.parse(this.ensureFencedCodeBlocksTerminated(content), {
      renderer
    });
  }
...
ChatResponseViewModel = __decorate([__param(1, ILogService)], ChatResponseViewModel);
