...
const {} = require('./media/dirtydiffDecorator.css.js');
const {
  ThrottledDelayer
...
} = require('../../../services/textfile/common/textfiles.js');
const {
  ITextFileService
...
const {
  IQuickDiffService
} = require('../common/quickDiff.service.js');
const {
  SwitchQuickDiffViewItem,
  SwitchQuickDiffBaseAction
} = require('./dirtyDiffSwitcher.js');
const {
  TextDiffEditor
} = require('../../../browser/parts/editor/textDiffEditor.js');
const {
  TextFileEditor
} = require('../../files/browser/editors/textFileEditor.js');
const {
  SideBySideEditor
} = require('../../../browser/parts/editor/sideBySideEditor.js');
var DirtyDiffController_1, DirtyDiffDecorator_1;
const _moduleId = "vs/workbench/contrib/scm/browser/dirtydiffDecorator";
...
UIEditorAction = __decorate([__param(3, IKeybindingService), __param(4, IInstantiationService)], UIEditorAction);
var ChangeType;
(function (ChangeType) {
...
let DirtyDiffWidget = class DirtyDiffWidget extends PeekViewWidget {
  ...
  renderTitle(label) {
    ...
    if (!this.shouldUseDropdown()) {
      detail = this.model.changes.length > 1 ? localizeWithPath(_moduleId, 0, "{0} - {1} of {2} changes", label, providerIndex + 1, providerChanges.length) : localizeWithPath(_moduleId, 1, "{0} - {1} of {2} change", label, providerIndex + 1, providerChanges.length);
      this.dropdownContainer.style.display = 'none';
    } else {
      detail = this.model.changes.length > 1 ? localizeWithPath(_moduleId, 2, "{0} of {1} changes", providerIndex + 1, providerChanges.length) : localizeWithPath(_moduleId, 3, "{0} of {1} change", providerIndex + 1, providerChanges.length);
  ...
  updateActions() {
    ...
    this._actionbarWidget.push(new Action('peekview.close', localizeWithPath(_moduleId, 4, "Close"), ThemeIcon.asClassName(Codicon.close), true, () => this.dispose()), {
      label: false,
      icon: true
    });
  }
...
DirtyDiffWidget = __decorate([__param(2, IThemeService), __param(3, IInstantiationService), __param(4, IMenuService), __param(5, IContextKeyService)], DirtyDiffWidget);
class ShowPreviousChangeAction extends EditorAction {
  constructor(outerEditor) {
    super({
      id: 'editor.action.dirtydiff.previous',
      label: localizeWithPath(_moduleId, 5, "Show Previous Change"),
...
class ShowNextChangeAction extends EditorAction {
  constructor(outerEditor) {
    super({
      ...
      label: localizeWithPath(_moduleId, 6, "Show Next Change"),
...
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
  ...
  command: {
    id: 'editor.action.dirtydiff.next',
    title: localizeWithPath(_moduleId, 7, "Next &&Change")
  },
  order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
  ...
  command: {
    id: 'editor.action.dirtydiff.previous',
    title: localizeWithPath(_moduleId, 8, "Previous &&Change")
  },
  order: 2
});
class GotoPreviousChangeAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 9, "Go to Previous Change"),
...
class GotoNextChangeAction extends EditorAction {
  constructor() {
    super({
      ...
      label: localizeWithPath(_moduleId, 10, "Go to Next Change"),
...
DirtyDiffController = DirtyDiffController_1 = __decorate([__param(1, IContextKeyService), __param(2, IConfigurationService), __param(3, IInstantiationService)], DirtyDiffController);
const editorGutterModifiedBackground = registerColor('editorGutter.modifiedBackground', {
  dark: '#1B81A8',
  light: '#2090D3',
  hcDark: '#1B81A8',
  hcLight: '#2090D3'
}, localizeWithPath(_moduleId, 11, "Editor gutter background color for lines that are modified."));
const editorGutterAddedBackground = registerColor('editorGutter.addedBackground', {
  dark: '#487E02',
  light: '#48985D',
  hcDark: '#487E02',
  hcLight: '#48985D'
}, localizeWithPath(_moduleId, 12, "Editor gutter background color for lines that are added."));
...
}, localizeWithPath(_moduleId, 13, "Editor gutter background color for lines that are deleted."));
...
}, localizeWithPath(_moduleId, 14, "Minimap gutter background color for lines that are modified."));
...
}, localizeWithPath(_moduleId, 15, "Minimap gutter background color for lines that are added."));
...
}, localizeWithPath(_moduleId, 16, "Minimap gutter background color for lines that are deleted."));
const overviewRulerModifiedForeground = registerColor('editorOverviewRuler.modifiedForeground', {
...
}, localizeWithPath(_moduleId, 17, 'Overview ruler marker color for modified content.'));
const overviewRulerAddedForeground = registerColor('editorOverviewRuler.addedForeground', {
...
}, localizeWithPath(_moduleId, 18, 'Overview ruler marker color for added content.'));
const overviewRulerDeletedForeground = registerColor('editorOverviewRuler.deletedForeground', {
...
}, localizeWithPath(_moduleId, 19, 'Overview ruler marker color for deleted content.'));
let DirtyDiffDecorator = DirtyDiffDecorator_1 = class DirtyDiffDecorator extends Disposable {
  ...
  constructor(editorModel, codeEditor, model, configurationService) {
    ...
    const diffAdded = localizeWithPath(_moduleId, 20, 'Added lines');
    ...
    const diffModified = localizeWithPath(_moduleId, 21, 'Changed lines');
    ...
    this.deletedOptions = DirtyDiffDecorator_1.createDecoration('dirty-diff-deleted', localizeWithPath(_moduleId, 22, 'Removed lines'), {
      gutter,
      overview: {
        active: overview,
...
DirtyDiffDecorator = DirtyDiffDecorator_1 = __decorate([__param(3, IConfigurationService)], DirtyDiffDecorator);
...
DirtyDiffModel = __decorate([__param(1, ISCMService), __param(2, IQuickDiffService), __param(3, IEditorWorkerService), __param(4, IConfigurationService), __param(5, ITextModelService), __param(6, IProgressService)], DirtyDiffModel);
class DirtyDiffItem {
...
DirtyDiffWorkbenchController = __decorate([__param(0, IEditorService), __param(1, IInstantiationService), __param(2, IConfigurationService), __param(3, ITextFileService)], DirtyDiffWorkbenchController);
...
exports.isDirtyDiffVisible = isDirtyDiffVisible;