...
const {
  CommentThreadWidget
} = require('./commentThreadWidget.js');
const {
...
let ReviewZoneWidget = class ReviewZoneWidget extends ZoneWidget {
  ...
  async display(range) {
    ...
    await this._commentThreadWidget.display(this.editor.getOption(67));
...
ReviewZoneWidget = __decorate([__param(5, IInstantiationService), __param(6, IThemeService), __param(7, ICommentService), __param(8, IContextKeyService), __param(9, IConfigurationService)], ReviewZoneWidget);
exports.CommentWidgetFocus = CommentWidgetFocus;
