...
const {
  Scrollable
} = require('../../../../base/common/scrollable.js');
const {
...
const _moduleId = "vs/workbench/contrib/comments/browser/commentNode";
...
let CommentNode = class CommentNode extends Disposable {
  ...
  createReactionPicker(reactionGroup) {
    ...
    }, localizeWithPath(_moduleId, 0, "Toggle Reaction")));
      ...
      reactionMenuActions = reactionGroup.map(reaction => {
        return new Action(`reaction.command.${reaction.label}`, `${reaction.label}`, '', true, async () => {
          try {
            ...
            const error = e.message ? localizeWithPath(_moduleId, 1, "Toggling the comment reaction failed: {0}.", e.message) : localizeWithPath(_moduleId, 2, "Toggling the comment reaction failed");
...
CommentNode = __decorate([__param(8, IInstantiationService), __param(9, ICommentService), __param(10, INotificationService), __param(11, IContextMenuService), __param(12, IContextKeyService), __param(13, IConfigurationService), __param(14, IHoverService), __param(15, IAccessibilityService), __param(16, IKeybindingService), __param(17, ITextModelService)], CommentNode);
