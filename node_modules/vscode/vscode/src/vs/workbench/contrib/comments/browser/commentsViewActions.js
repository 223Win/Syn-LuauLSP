...
const {
  viewFilterSubmenu
} = require('../../../browser/parts/views/viewFilter.js');
const _moduleId = "vs/workbench/contrib/comments/browser/commentsViewActions";
...
registerAction2(class extends ViewAction {
  constructor() {
    super({
      ...
      title: localizeWithPath(_moduleId, 0, "Focus Comments view"),
      keybinding: {
...
registerAction2(class extends ViewAction {
  constructor() {
    super({
      ...
      title: localizeWithPath(_moduleId, 1, "Clear filter text"),
      keybinding: {
        when: CommentsViewFilterFocusContextKey,
        weight: 200,
        primary: 9
...
registerAction2(class extends ViewAction {
  constructor() {
    super({
      ...
      title: localizeWithPath(_moduleId, 2, "Focus comments filter"),
      keybinding: {
...
registerAction2(class extends ViewAction {
  constructor() {
    super({
      ...
      title: localizeWithPath(_moduleId, 3, "Show Unresolved"),
      category: localizeWithPath(_moduleId, 4, "Comments"),
      toggled: {
        condition: CONTEXT_KEY_SHOW_UNRESOLVED,
        title: localizeWithPath(_moduleId, 5, "Show Unresolved")
      },
      menu: {
...
registerAction2(class extends ViewAction {
  constructor() {
    super({
      ...
      title: localizeWithPath(_moduleId, 6, "Show Resolved"),
      category: localizeWithPath(_moduleId, 4, "Comments"),
      toggled: {
        condition: CONTEXT_KEY_SHOW_RESOLVED,
        title: localizeWithPath(_moduleId, 7, "Show Resolved")
      },
      menu: {
        id: viewFilterSubmenu,
        group: '1_filter',
