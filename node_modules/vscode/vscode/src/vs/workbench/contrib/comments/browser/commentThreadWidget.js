...
const {
  CommentThreadBody
} = require('./commentThreadBody.js');
const {
  CommentThreadHeader
} = require('./commentThreadHeader.js');
const {
  CommentThreadAdditionalActions
} = require('./commentThreadAdditionalActions.js');
const {
  CommentContextKeys
...
const _moduleId = "vs/workbench/contrib/comments/browser/commentThreadWidget";
let CommentThreadWidget = class CommentThreadWidget extends Disposable {
  ...
  _setAriaLabel() {
    let ariaLabel = localizeWithPath(_moduleId, 0, "Comment");
    let keybinding;
    ...
    if (keybinding) {
      ariaLabel = localizeWithPath(_moduleId, 1, "{0}, use ({1}) for accessibility help", ariaLabel, keybinding);
    } else {
      ariaLabel = localizeWithPath(_moduleId, 2, "{0}, run the command Open Accessibility Help which is currently not triggerable via keybinding.", ariaLabel);
    }
...
CommentThreadWidget = __decorate([__param(12, ICommentService), __param(13, IContextMenuService), __param(14, IConfigurationService), __param(15, IKeybindingService)], CommentThreadWidget);
