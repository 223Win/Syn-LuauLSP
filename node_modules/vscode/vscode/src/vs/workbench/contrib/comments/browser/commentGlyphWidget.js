...
const _moduleId = "vs/workbench/contrib/comments/browser/commentGlyphWidget";
const overviewRulerCommentingRangeForeground = registerColor('editorGutter.commentRangeForeground', {
  ...
  hcDark: Color.white,
  hcLight: Color.black
}, localizeWithPath(_moduleId, 0, 'Editor gutter decoration color for commenting ranges. This color should be opaque.'));
...
}, localizeWithPath(_moduleId, 1, 'Editor overview ruler decoration color for resolved comments. This color should be opaque.'));
const overviewRulerCommentUnresolvedForeground = registerColor('editorOverviewRuler.commentUnresolvedForeground', {
...
}, localizeWithPath(_moduleId, 2, 'Editor overview ruler decoration color for unresolved comments. This color should be opaque.'));
const editorGutterCommentGlyphForeground = registerColor('editorGutter.commentGlyphForeground', {
  ...
  hcDark: Color.black,
  hcLight: Color.white
}, localizeWithPath(_moduleId, 3, 'Editor gutter decoration color for commenting glyphs.'));
registerColor('editorGutter.commentUnresolvedGlyphForeground', {
...
}, localizeWithPath(_moduleId, 4, 'Editor gutter decoration color for commenting glyphs for unresolved comment threads.'));
...
exports.overviewRulerCommentingRangeForeground = overviewRulerCommentingRangeForeground;