...
const {} = require('./media/openeditors.css.js');
const {
  localize2WithPath,
  localizeWithPath
} = require('../../../../../nls.js');
...
} = require('../../../../browser/parts/editor/editorActions.js');
const {
  ContextKeyExpr
...
const {
  EditorGroupView
} = require('../../../../browser/parts/editor/editorGroupView.js');
const {
  IHoverService
...
let OpenEditorsView = class OpenEditorsView extends ViewPane {
  ...
  static {
    this.NAME = localize2WithPath(_moduleId, 0, "Open Editors");
  }
  ...
  renderBody(container) {
    ...
    this.list = this.instantiationService.createInstance(WorkbenchList, 'OpenEditors', container, delegate, [new EditorGroupRenderer(this.keybindingService, this.instantiationService), new OpenEditorRenderer(this.listLabels, this.instantiationService, this.keybindingService, this.configurationService)], {
      identityProvider: {
