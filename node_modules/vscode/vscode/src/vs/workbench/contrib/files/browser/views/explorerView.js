...
} = require('./explorerDecorationsProvider.js');
const {
...
const {
  IDecorationsService
} = require('../../../../services/decorations/common/decorations.service.js');
const {
...
var ExplorerView_1;
const _moduleId = "vs/workbench/contrib/files/browser/views/explorerView";
...
let ExplorerView = class ExplorerView extends ViewPane {
  ...
  renderHeader(container) {
    ...
    const setHeader = () => {
      ...
      this.ariaHeaderLabel = localizeWithPath(_moduleId, 0, "Explorer Section: {0}", this.name);
...
registerAction2(class extends Action2 {
  constructor() {
    super({
      ...
      title: localizeWithPath(_moduleId, 1, "New File..."),
      f1: false,
...
registerAction2(class extends Action2 {
  constructor() {
    super({
      ...
      title: localizeWithPath(_moduleId, 2, "New Folder..."),
      f1: false,
...
registerAction2(class extends Action2 {
  constructor() {
    super({
      ...
      title: localize2WithPath(_moduleId, 3, "Refresh Explorer"),
      f1: true,
      ...
      metadata: {
        description: localize2WithPath(_moduleId, 4, "Forces a refresh of the Explorer.")
      }
    });
  }
  async run(accessor) {
...
registerAction2(class extends Action2 {
  constructor() {
    super({
      ...
      title: localize2WithPath(_moduleId, 5, "Collapse Folders in Explorer"),
      f1: true,
      ...
      metadata: {
        description: localize2WithPath(_moduleId, 6, "Folds all folders in the Explorer.")
      }
    });
  }
  run(accessor) {
