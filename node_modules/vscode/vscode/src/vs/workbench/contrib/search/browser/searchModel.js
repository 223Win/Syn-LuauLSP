...
const {
  TernarySearchTree
} = require('../../../../base/common/ternarySearchTree.js');
const {
  URI
...
const {
  minimapFindMatch
} = require('../../../../platform/theme/common/colors/minimapColors.js');
...
} = require('../../notebook/browser/contrib/find/findMatchDecorationModel.js');
const {
  NotebookEditorWidget
} = require('../../notebook/browser/notebookEditorWidget.js');
const {
  INotebookEditorService
} = require('../../notebook/browser/services/notebookEditorService.service.js');
const {
  NotebookCellsChangeType
} = require('../../notebook/common/notebookCommon.js');
const {
  IReplaceService
} = require('./replace.service.js');
const {
...
} = require('./notebookSearch/searchNotebookHelpers.js');
const {
  INotebookSearchService
} = require('../common/notebookSearch.service.js');
const {
  isINotebookFileMatchNoModel,
  rawCellPrefix
} = require('../common/searchNotebookHelpers.js');
const {
  ReplacePattern
} = require('../../../services/search/common/replace.js');
const {
  OneLineRange,
  resultIsMatch
...
const {
  ISearchService
} = require('../../../services/search/common/search.service.js');
const {
  editorMatchesToTextSearchResults,
  getTextSearchMatchWithModelContext
} = require('../../../services/search/common/searchHelpers.js');
const {
  CellSearchModel
} = require('../common/cellSearchModel.js');
...
Match.__decorator = __decorate([memoize], Match.prototype, "preview", null);
class CellMatch {
...
FileMatch = FileMatch_1 = __decorate([__param(7, IModelService), __param(8, IReplaceService), __param(9, ILabelService), __param(10, INotebookEditorService)], FileMatch);
      ...
      if (existingFileMatch) {
        if (rawFileMatch.results) {
          rawFileMatch.results.filter(resultIsMatch).forEach(m => {
            textSearchResultToMatches(m, existingFileMatch, isAiContributed).forEach(m => existingFileMatch.add(m));
          });
        }
...
FolderMatch = FolderMatch_1 = __decorate([__param(7, IReplaceService), __param(8, IInstantiationService), __param(9, ILabelService), __param(10, IUriIdentityService)], FolderMatch);
...
FolderMatchWithResource = __decorate([__param(7, IReplaceService), __param(8, IInstantiationService), __param(9, ILabelService), __param(10, IUriIdentityService)], FolderMatchWithResource);
...
FolderMatchWorkspaceRoot = __decorate([__param(6, IReplaceService), __param(7, IInstantiationService), __param(8, ILabelService), __param(9, IUriIdentityService)], FolderMatchWorkspaceRoot);
...
FolderMatchNoRoot = __decorate([__param(4, IReplaceService), __param(5, IInstantiationService), __param(6, ILabelService), __param(7, IUriIdentityService)], FolderMatchNoRoot);
let elemAIndex = -1;
let elemBIndex = -1;
...
let SearchResult = class SearchResult extends Disposable {
  ...
  add(allRaw, searchInstanceID, ai, silent = false) {
    const {
      byFolder,
      other
    } = this.groupFilesByFolder(allRaw, ai);
  ...
  remove(matches, ai = false) {
    ...
    const {
      byFolder,
      other
    } = this.groupFilesByFolder(fileMatches, ai);
...
SearchResult = __decorate([__param(1, IReplaceService), __param(2, IInstantiationService), __param(3, IModelService), __param(4, IUriIdentityService), __param(5, INotebookEditorService)], SearchResult);
    ...
    if (this.searchResult.count(true)) {
      ...
      if (this._searchQuery) {
        await this.aiSearch({
          ...
          type: 3
        }, onProgress, this.currentCancelTokenSource?.token);
      }
    }
  }
...
SearchModel = __decorate([__param(0, ISearchService), __param(1, ITelemetryService), __param(2, IConfigurationService), __param(3, IInstantiationService), __param(4, ILogService), __param(5, INotebookSearchService), __param(6, IProgressService)], SearchModel);
...
SearchViewModelWorkbenchService = __decorate([__param(0, IInstantiationService)], SearchViewModelWorkbenchService);
...
RangeHighlightDecorations = RangeHighlightDecorations_1 = __decorate([__param(0, IModelService)], RangeHighlightDecorations);
...
exports.SearchModelLocation = SearchModelLocation;
