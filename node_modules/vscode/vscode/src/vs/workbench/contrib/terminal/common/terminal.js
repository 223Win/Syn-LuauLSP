...
const _moduleId = "vs/workbench/contrib/terminal/common/terminal";
...
const terminalContributionsDescriptor = {
  ...
  jsonSchema: {
    description: localizeWithPath(_moduleId, 0, 'Contributes terminal functionality.'),
    type: 'object',
    properties: {
      profiles: {
        type: 'array',
        description: localizeWithPath(_moduleId, 1, "Defines additional terminal profiles that the user can create."),
        items: {
          type: 'object',
          required: ['id', 'title'],
          defaultSnippets: [{
          ...
          properties: {
            id: {
              description: localizeWithPath(_moduleId, 2, "The ID of the terminal profile provider."),
              type: 'string'
            },
            title: {
              description: localizeWithPath(_moduleId, 3, "Title for this terminal profile."),
              type: 'string'
            },
            icon: {
              description: localizeWithPath(_moduleId, 4, "A codicon, URI, or light and dark URIs to associate with this terminal type."),
              anyOf: [{
                type: 'string'
              }, {
                type: 'object',
                properties: {
                  light: {
                    description: localizeWithPath(_moduleId, 5, 'Icon path when a light theme is used'),
                    type: 'string'
                  },
                  dark: {
                    description: localizeWithPath(_moduleId, 6, 'Icon path when a dark theme is used'),
                    type: 'string'
                  }
                }
              }]
...
exports.DEFAULT_BOLD_FONT_WEIGHT = DEFAULT_BOLD_FONT_WEIGHT;
exports.DEFAULT_COMMANDS_TO_SKIP_SHELL = DEFAULT_COMMANDS_TO_SKIP_SHELL;
exports.DEFAULT_FONT_WEIGHT = DEFAULT_FONT_WEIGHT;
exports.DEFAULT_LETTER_SPACING = DEFAULT_LETTER_SPACING;
exports.DEFAULT_LINE_HEIGHT = DEFAULT_LINE_HEIGHT;
exports.DEFAULT_LOCAL_ECHO_EXCLUDE = DEFAULT_LOCAL_ECHO_EXCLUDE;
exports.MAXIMUM_FONT_WEIGHT = MAXIMUM_FONT_WEIGHT;
exports.MINIMUM_FONT_WEIGHT = MINIMUM_FONT_WEIGHT;
exports.MINIMUM_LETTER_SPACING = MINIMUM_LETTER_SPACING;
exports.SUGGESTIONS_FONT_WEIGHT = SUGGESTIONS_FONT_WEIGHT;
exports.TERMINAL_CONFIG_SECTION = TERMINAL_CONFIG_SECTION;
exports.TERMINAL_CREATION_COMMANDS = TERMINAL_CREATION_COMMANDS;
exports.TERMINAL_VIEW_ID = TERMINAL_VIEW_ID;
exports.isTerminalProcessManager = isTerminalProcessManager;
exports.terminalContributionsDescriptor = terminalContributionsDescriptor;