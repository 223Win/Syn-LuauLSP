...
const {
  ...
  knownTermMappings,
  tocData
} = require('./settingsLayout.js');
const {
  MODIFIED_SETTING_TAG,
  REQUIRE_TRUSTED_WORKSPACE_SETTING_TAG,
  POLICY_SETTING_TAG,
  compareTwoNullableNumbers
} = require('../common/preferences.js');
const {
  SettingValueType,
  SettingMatchType
} = require('../../../services/preferences/common/preferences.js');
const {
...
} = require('../../../services/configuration/common/configuration.js');
const {
...
SettingsTreeModel = __decorate([__param(2, IWorkbenchConfigurationService), __param(3, ILanguageService), __param(4, IUserDataProfileService), __param(5, IProductService)], SettingsTreeModel);
...
function isObjectRenderableSchema({
  type
}) {
