...
const HasSpeechProvider = new RawContextKey('hasSpeechProvider', false, {
  type: 'string',
  description: localizeWithPath(_moduleId, 0, "A speech provider is registered to the speech service.")
});
const SpeechToTextInProgress = new RawContextKey('speechToTextInProgress', false, {
  type: 'string',
  description: localizeWithPath(_moduleId, 1, "A speech-to-text session is in progress.")
});
...
const SPEECH_LANGUAGES = {
  ...
  ['tr-TR']: {
    name: localizeWithPath(_moduleId, 24, "Turkish (Türkiye)")
  },
  ['zh-CN']: {
...
exports.HasSpeechProvider = HasSpeechProvider;
exports.KeywordRecognitionStatus = KeywordRecognitionStatus;
exports.SPEECH_LANGUAGES = SPEECH_LANGUAGES;
exports.SPEECH_LANGUAGE_CONFIG = SPEECH_LANGUAGE_CONFIG;
exports.SpeechToTextInProgress = SpeechToTextInProgress;
