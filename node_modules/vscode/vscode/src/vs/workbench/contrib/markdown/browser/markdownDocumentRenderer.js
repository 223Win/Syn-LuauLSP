...
const {
  sanitize$1
} = require('../../../../base/browser/dompurify/dompurify.js');
const {
  allowedMarkdownAttr
  ...
  try {
    return sanitize$1(documentContent, {
      ...{
        ...
        ALLOWED_ATTR: [...allowedMarkdownAttr, 'data-command', 'name', 'id', 'role', 'tabindex', 'x-dispatch', 'required', 'checked', 'placeholder', 'when-checked', 'checked-on']
      },
...
exports.DEFAULT_MARKDOWN_STYLES = DEFAULT_MARKDOWN_STYLES;
