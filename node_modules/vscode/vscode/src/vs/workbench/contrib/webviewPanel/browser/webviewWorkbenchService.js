...
} = require('./webviewEditor.js');
const {
  WebviewIconManager
} = require('./webviewIconManager.js');
const {
  IEditorService
...
} = require('./webviewWorkbenchService.service.js');
...
LazilyResolvedWebviewEditorInput.__decorator = __decorate([memoize], LazilyResolvedWebviewEditorInput.prototype, "resolve", null);
LazilyResolvedWebviewEditorInput = __decorate([__param(2, IWebviewWorkbenchService)], LazilyResolvedWebviewEditorInput);
class RevivalPool {
  constructor() {
...
WebviewEditorService = __decorate([__param(0, IContextKeyService), __param(1, IEditorService), __param(2, IInstantiationService), __param(3, IWebviewService)], WebviewEditorService);
