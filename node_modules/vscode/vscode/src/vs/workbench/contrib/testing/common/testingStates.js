...
const isFailedState = s => s === 6 || s === 4;
const isStateWithResult = s => s === 6 || s === 4 || s === 3;
...
exports.statesInOrder = statesInOrder;
exports.terminalStatePriorities = terminalStatePriorities;