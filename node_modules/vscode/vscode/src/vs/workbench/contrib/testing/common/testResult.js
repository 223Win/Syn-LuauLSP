...
const {
  ...
  maxPriority,
  statesInOrder
} = require('./testingStates.js');
const {
  TestResultItem,
  getMarkId
} = require('./testTypes.js');
const _moduleId = "vs/workbench/contrib/testing/common/testResult";
...
let LiveTestResult = class LiveTestResult extends Disposable {
  ...
  constructor(id, persist, request, telemetry) {
    ...
    this.tasks = [];
    this.name = localizeWithPath(_moduleId, 0, 'Test run at {0}', new Date().toLocaleString(language));
...
LiveTestResult = __decorate([__param(3, ITelemetryService)], LiveTestResult);
