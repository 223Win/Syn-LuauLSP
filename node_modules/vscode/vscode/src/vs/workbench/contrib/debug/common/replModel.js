...
const {
  ExpressionContainer
} = require('./debugModel.js');
const _moduleId = "vs/workbench/contrib/debug/common/replModel";
  ...
  appendToRepl(session, {
    ...
    if (clearAnsiIndex !== -1) {
      ...
      this.appendToRepl(session, {
        output: localizeWithPath(_moduleId, 0, "Console was cleared"),
