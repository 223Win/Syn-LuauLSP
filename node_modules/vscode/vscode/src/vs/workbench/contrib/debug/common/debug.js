...
exports.BREAKPOINTS_VIEW_ID = BREAKPOINTS_VIEW_ID;
exports.BREAKPOINT_EDITOR_CONTRIBUTION_ID = BREAKPOINT_EDITOR_CONTRIBUTION_ID;
exports.CALLSTACK_VIEW_ID = CALLSTACK_VIEW_ID;
exports.CONTEXT_BREAKPOINTS_EXIST = CONTEXT_BREAKPOINTS_EXIST;
exports.CONTEXT_BREAKPOINTS_FOCUSED = CONTEXT_BREAKPOINTS_FOCUSED;
exports.CONTEXT_BREAKPOINT_HAS_MODES = CONTEXT_BREAKPOINT_HAS_MODES;
exports.CONTEXT_BREAKPOINT_INPUT_FOCUSED = CONTEXT_BREAKPOINT_INPUT_FOCUSED;
exports.CONTEXT_BREAKPOINT_ITEM_IS_DATA_BYTES = CONTEXT_BREAKPOINT_ITEM_IS_DATA_BYTES;
exports.CONTEXT_BREAKPOINT_ITEM_TYPE = CONTEXT_BREAKPOINT_ITEM_TYPE;
exports.CONTEXT_BREAKPOINT_SUPPORTS_CONDITION = CONTEXT_BREAKPOINT_SUPPORTS_CONDITION;
exports.CONTEXT_BREAKPOINT_WIDGET_VISIBLE = CONTEXT_BREAKPOINT_WIDGET_VISIBLE;
exports.CONTEXT_BREAK_WHEN_VALUE_CHANGES_SUPPORTED = CONTEXT_BREAK_WHEN_VALUE_CHANGES_SUPPORTED;
exports.CONTEXT_BREAK_WHEN_VALUE_IS_ACCESSED_SUPPORTED = CONTEXT_BREAK_WHEN_VALUE_IS_ACCESSED_SUPPORTED;
exports.CONTEXT_BREAK_WHEN_VALUE_IS_READ_SUPPORTED = CONTEXT_BREAK_WHEN_VALUE_IS_READ_SUPPORTED;
exports.CONTEXT_CALLSTACK_ITEM_STOPPED = CONTEXT_CALLSTACK_ITEM_STOPPED;
exports.CONTEXT_CALLSTACK_ITEM_TYPE = CONTEXT_CALLSTACK_ITEM_TYPE;
exports.CONTEXT_CALLSTACK_SESSION_HAS_ONE_THREAD = CONTEXT_CALLSTACK_SESSION_HAS_ONE_THREAD;
exports.CONTEXT_CALLSTACK_SESSION_IS_ATTACH = CONTEXT_CALLSTACK_SESSION_IS_ATTACH;
exports.CONTEXT_CAN_VIEW_MEMORY = CONTEXT_CAN_VIEW_MEMORY;
exports.CONTEXT_DEBUGGERS_AVAILABLE = CONTEXT_DEBUGGERS_AVAILABLE;
exports.CONTEXT_DEBUG_CONFIGURATION_TYPE = CONTEXT_DEBUG_CONFIGURATION_TYPE;
exports.CONTEXT_DEBUG_EXTENSION_AVAILABLE = CONTEXT_DEBUG_EXTENSION_AVAILABLE;
exports.CONTEXT_DEBUG_PROTOCOL_VARIABLE_MENU_CONTEXT = CONTEXT_DEBUG_PROTOCOL_VARIABLE_MENU_CONTEXT;
exports.CONTEXT_DEBUG_STATE = CONTEXT_DEBUG_STATE;
exports.CONTEXT_DEBUG_TYPE = CONTEXT_DEBUG_TYPE;
exports.CONTEXT_DEBUG_UX = CONTEXT_DEBUG_UX;
exports.CONTEXT_DEBUG_UX_KEY = CONTEXT_DEBUG_UX_KEY;
exports.CONTEXT_DISASSEMBLE_REQUEST_SUPPORTED = CONTEXT_DISASSEMBLE_REQUEST_SUPPORTED;
exports.CONTEXT_DISASSEMBLY_VIEW_FOCUS = CONTEXT_DISASSEMBLY_VIEW_FOCUS;
exports.CONTEXT_EXCEPTION_WIDGET_VISIBLE = CONTEXT_EXCEPTION_WIDGET_VISIBLE;
exports.CONTEXT_EXPRESSION_SELECTED = CONTEXT_EXPRESSION_SELECTED;
exports.CONTEXT_FOCUSED_SESSION_IS_ATTACH = CONTEXT_FOCUSED_SESSION_IS_ATTACH;
exports.CONTEXT_FOCUSED_SESSION_IS_NO_DEBUG = CONTEXT_FOCUSED_SESSION_IS_NO_DEBUG;
exports.CONTEXT_FOCUSED_STACK_FRAME_HAS_INSTRUCTION_POINTER_REFERENCE = CONTEXT_FOCUSED_STACK_FRAME_HAS_INSTRUCTION_POINTER_REFERENCE;
exports.CONTEXT_HAS_DEBUGGED = CONTEXT_HAS_DEBUGGED;
exports.CONTEXT_IN_BREAKPOINT_WIDGET = CONTEXT_IN_BREAKPOINT_WIDGET;
exports.CONTEXT_IN_DEBUG_MODE = CONTEXT_IN_DEBUG_MODE;
exports.CONTEXT_IN_DEBUG_REPL = CONTEXT_IN_DEBUG_REPL;
exports.CONTEXT_JUMP_TO_CURSOR_SUPPORTED = CONTEXT_JUMP_TO_CURSOR_SUPPORTED;
exports.CONTEXT_LANGUAGE_SUPPORTS_DISASSEMBLE_REQUEST = CONTEXT_LANGUAGE_SUPPORTS_DISASSEMBLE_REQUEST;
exports.CONTEXT_LOADED_SCRIPTS_ITEM_TYPE = CONTEXT_LOADED_SCRIPTS_ITEM_TYPE;
exports.CONTEXT_LOADED_SCRIPTS_SUPPORTED = CONTEXT_LOADED_SCRIPTS_SUPPORTED;
exports.CONTEXT_MULTI_SESSION_DEBUG = CONTEXT_MULTI_SESSION_DEBUG;
exports.CONTEXT_MULTI_SESSION_REPL = CONTEXT_MULTI_SESSION_REPL;
exports.CONTEXT_RESTART_FRAME_SUPPORTED = CONTEXT_RESTART_FRAME_SUPPORTED;
exports.CONTEXT_SET_DATA_BREAKPOINT_BYTES_SUPPORTED = CONTEXT_SET_DATA_BREAKPOINT_BYTES_SUPPORTED;
exports.CONTEXT_SET_EXPRESSION_SUPPORTED = CONTEXT_SET_EXPRESSION_SUPPORTED;
exports.CONTEXT_SET_VARIABLE_SUPPORTED = CONTEXT_SET_VARIABLE_SUPPORTED;
exports.CONTEXT_STACK_FRAME_SUPPORTS_RESTART = CONTEXT_STACK_FRAME_SUPPORTS_RESTART;
exports.CONTEXT_STEP_BACK_SUPPORTED = CONTEXT_STEP_BACK_SUPPORTED;
exports.CONTEXT_STEP_INTO_TARGETS_SUPPORTED = CONTEXT_STEP_INTO_TARGETS_SUPPORTED;
exports.CONTEXT_SUSPEND_DEBUGGEE_SUPPORTED = CONTEXT_SUSPEND_DEBUGGEE_SUPPORTED;
exports.CONTEXT_TERMINATE_DEBUGGEE_SUPPORTED = CONTEXT_TERMINATE_DEBUGGEE_SUPPORTED;
exports.CONTEXT_VARIABLES_FOCUSED = CONTEXT_VARIABLES_FOCUSED;
exports.CONTEXT_VARIABLE_EVALUATE_NAME_PRESENT = CONTEXT_VARIABLE_EVALUATE_NAME_PRESENT;
exports.CONTEXT_VARIABLE_EXTENSIONID = CONTEXT_VARIABLE_EXTENSIONID;
exports.CONTEXT_VARIABLE_INTERFACES = CONTEXT_VARIABLE_INTERFACES;
exports.CONTEXT_VARIABLE_IS_READONLY = CONTEXT_VARIABLE_IS_READONLY;
exports.CONTEXT_VARIABLE_LANGUAGE = CONTEXT_VARIABLE_LANGUAGE;
exports.CONTEXT_VARIABLE_NAME = CONTEXT_VARIABLE_NAME;
exports.CONTEXT_VARIABLE_TYPE = CONTEXT_VARIABLE_TYPE;
exports.CONTEXT_VARIABLE_VALUE = CONTEXT_VARIABLE_VALUE;
exports.CONTEXT_WATCH_EXPRESSIONS_EXIST = CONTEXT_WATCH_EXPRESSIONS_EXIST;
exports.CONTEXT_WATCH_EXPRESSIONS_FOCUSED = CONTEXT_WATCH_EXPRESSIONS_FOCUSED;
exports.CONTEXT_WATCH_ITEM_TYPE = CONTEXT_WATCH_ITEM_TYPE;
exports.DEBUG_MEMORY_SCHEME = DEBUG_MEMORY_SCHEME;
exports.DEBUG_PANEL_ID = DEBUG_PANEL_ID;
exports.DEBUG_SCHEME = DEBUG_SCHEME;
exports.DISASSEMBLY_VIEW_ID = DISASSEMBLY_VIEW_ID;
exports.DebugConfigurationProviderTriggerKind = DebugConfigurationProviderTriggerKind;
exports.DebuggerString = DebuggerString;
exports.EDITOR_CONTRIBUTION_ID = EDITOR_CONTRIBUTION_ID;
exports.IDebugVisualization = IDebugVisualization;
exports.INTERNAL_CONSOLE_OPTIONS_SCHEMA = INTERNAL_CONSOLE_OPTIONS_SCHEMA;
exports.LOADED_SCRIPTS_VIEW_ID = LOADED_SCRIPTS_VIEW_ID;
exports.REPL_VIEW_ID = REPL_VIEW_ID;
exports.VARIABLES_VIEW_ID = VARIABLES_VIEW_ID;
exports.VIEWLET_ID = VIEWLET_ID;
exports.WATCH_VIEW_ID = WATCH_VIEW_ID;
exports.debuggerDisabledMessage = debuggerDisabledMessage;
exports.getStateLabel = getStateLabel;
exports.isFrameDeemphasized = isFrameDeemphasized;