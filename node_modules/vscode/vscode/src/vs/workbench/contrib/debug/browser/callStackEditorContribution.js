...
const {} = require('./media/callStackEditorContribution.css.js');
const _moduleId = "vs/workbench/contrib/debug/browser/callStackEditorContribution";
const topStackFrameColor = registerColor('editor.stackFrameHighlightBackground', {
  dark: '#ffff0033',
  light: '#ffff6673',
  hcDark: '#ffff0033',
  hcLight: '#ffff6673'
}, localizeWithPath(_moduleId, 0, 'Background color for the highlight of line at the top stack frame position.'));
const focusedStackFrameColor = registerColor('editor.focusedStackFrameHighlightBackground', {
  dark: '#7abd7a4d',
  light: '#cee7ce73',
  hcDark: '#7abd7a4d',
  hcLight: '#cee7ce73'
}, localizeWithPath(_moduleId, 1, 'Background color for the highlight of line at focused stack frame position.'));
const stickiness = 1;
...
function createDecorationsForStackFrame(stackFrame, isFocusedSession, noCharactersBefore) {
  const result = [];
  const columnUntilEOLRange = new Range(stackFrame.range.startLineNumber, stackFrame.range.startColumn, stackFrame.range.startLineNumber, 1073741824);
...
exports.focusedStackFrameColor = focusedStackFrameColor;
exports.topStackFrameColor = topStackFrameColor;