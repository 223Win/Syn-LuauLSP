...
} = require('../common/debugVisualizers.service.js');
const {
  ReplEvaluationResult
} = require('../common/replModel.js');
...
function renderExpressionValue(expressionOrValue, container, options, hoverService) {
  ...
  if (options.hover) {
    const {
      ...
      commands,
      commandService
    } = options.hover instanceof DisposableStore ? {
      store: options.hover,
      commands: [],
...
let AbstractExpressionsRenderer = class AbstractExpressionsRenderer {
  ...
  renderInputBox(nameElement, valueElement, inputBoxContainer, options) {
    ...
    const toDispose = [inputBox, addStandardDisposableListener(inputBox.inputElement, EventType.KEY_DOWN, e => {
