...
} = require('../common/debug.js');
const {
  IDebugService
} = require('../common/debug.service.js');
const {
  Expression,
  Variable,
  Breakpoint,
...
CommandsRegistry.registerCommand({
  ...
  handler: async accessor => {
        ...
        if (targets && targets.length) {
          ...
          if (targets.length > 1) {
            ...
            const pick = await quickInputService.pick(picks, {
              placeHolder: localizeWithPath(_moduleId, 28, "Choose the specific location")
            });
            if (!pick) {
              return;
            }
    ...
    return notificationService.warn(localizeWithPath(_moduleId, 29, "No executable code is associated at the current cursor position."));
  }
});
CommandsRegistry.registerCommand({
  id: CALLSTACK_TOP_ID,
...
exports.ADD_CONFIGURATION_ID = ADD_CONFIGURATION_ID;
exports.ADD_TO_WATCH_ID = ADD_TO_WATCH_ID;
exports.ADD_TO_WATCH_LABEL = ADD_TO_WATCH_LABEL;
exports.CALLSTACK_BOTTOM_ID = CALLSTACK_BOTTOM_ID;
exports.CALLSTACK_BOTTOM_LABEL = CALLSTACK_BOTTOM_LABEL;
exports.CALLSTACK_DOWN_ID = CALLSTACK_DOWN_ID;
exports.CALLSTACK_DOWN_LABEL = CALLSTACK_DOWN_LABEL;
exports.CALLSTACK_TOP_ID = CALLSTACK_TOP_ID;
exports.CALLSTACK_TOP_LABEL = CALLSTACK_TOP_LABEL;
exports.CALLSTACK_UP_ID = CALLSTACK_UP_ID;
exports.CALLSTACK_UP_LABEL = CALLSTACK_UP_LABEL;
exports.CONTINUE_ID = CONTINUE_ID;
exports.CONTINUE_LABEL = CONTINUE_LABEL;
exports.COPY_EVALUATE_PATH_ID = COPY_EVALUATE_PATH_ID;
exports.COPY_EVALUATE_PATH_LABEL = COPY_EVALUATE_PATH_LABEL;
exports.COPY_STACK_TRACE_ID = COPY_STACK_TRACE_ID;
exports.COPY_VALUE_ID = COPY_VALUE_ID;
exports.COPY_VALUE_LABEL = COPY_VALUE_LABEL;
exports.DEBUG_COMMAND_CATEGORY = DEBUG_COMMAND_CATEGORY;
exports.DEBUG_CONFIGURE_COMMAND_ID = DEBUG_CONFIGURE_COMMAND_ID;
exports.DEBUG_CONFIGURE_LABEL = DEBUG_CONFIGURE_LABEL;
exports.DEBUG_CONSOLE_QUICK_ACCESS_PREFIX = DEBUG_CONSOLE_QUICK_ACCESS_PREFIX;
exports.DEBUG_QUICK_ACCESS_PREFIX = DEBUG_QUICK_ACCESS_PREFIX;
exports.DEBUG_RUN_COMMAND_ID = DEBUG_RUN_COMMAND_ID;
exports.DEBUG_RUN_LABEL = DEBUG_RUN_LABEL;
exports.DEBUG_START_COMMAND_ID = DEBUG_START_COMMAND_ID;
exports.DEBUG_START_LABEL = DEBUG_START_LABEL;
exports.DISCONNECT_AND_SUSPEND_ID = DISCONNECT_AND_SUSPEND_ID;
exports.DISCONNECT_AND_SUSPEND_LABEL = DISCONNECT_AND_SUSPEND_LABEL;
exports.DISCONNECT_ID = DISCONNECT_ID;
exports.DISCONNECT_LABEL = DISCONNECT_LABEL;
exports.EDIT_EXPRESSION_COMMAND_ID = EDIT_EXPRESSION_COMMAND_ID;
exports.FOCUS_REPL_ID = FOCUS_REPL_ID;
exports.FOCUS_SESSION_ID = FOCUS_SESSION_ID;
exports.FOCUS_SESSION_LABEL = FOCUS_SESSION_LABEL;
exports.JUMP_TO_CURSOR_ID = JUMP_TO_CURSOR_ID;
exports.NEXT_DEBUG_CONSOLE_ID = NEXT_DEBUG_CONSOLE_ID;
exports.NEXT_DEBUG_CONSOLE_LABEL = NEXT_DEBUG_CONSOLE_LABEL;
exports.OPEN_LOADED_SCRIPTS_LABEL = OPEN_LOADED_SCRIPTS_LABEL;
exports.PAUSE_ID = PAUSE_ID;
exports.PAUSE_LABEL = PAUSE_LABEL;
exports.PREV_DEBUG_CONSOLE_ID = PREV_DEBUG_CONSOLE_ID;
exports.PREV_DEBUG_CONSOLE_LABEL = PREV_DEBUG_CONSOLE_LABEL;
exports.REMOVE_EXPRESSION_COMMAND_ID = REMOVE_EXPRESSION_COMMAND_ID;
exports.RESTART_FRAME_ID = RESTART_FRAME_ID;
exports.RESTART_LABEL = RESTART_LABEL;
exports.RESTART_SESSION_ID = RESTART_SESSION_ID;
exports.REVERSE_CONTINUE_ID = REVERSE_CONTINUE_ID;
exports.SELECT_AND_START_ID = SELECT_AND_START_ID;
exports.SELECT_AND_START_LABEL = SELECT_AND_START_LABEL;
exports.SELECT_DEBUG_CONSOLE_ID = SELECT_DEBUG_CONSOLE_ID;
exports.SELECT_DEBUG_CONSOLE_LABEL = SELECT_DEBUG_CONSOLE_LABEL;
exports.SELECT_DEBUG_SESSION_ID = SELECT_DEBUG_SESSION_ID;
exports.SELECT_DEBUG_SESSION_LABEL = SELECT_DEBUG_SESSION_LABEL;
exports.SET_EXPRESSION_COMMAND_ID = SET_EXPRESSION_COMMAND_ID;
exports.SHOW_LOADED_SCRIPTS_ID = SHOW_LOADED_SCRIPTS_ID;
exports.STEP_BACK_ID = STEP_BACK_ID;
exports.STEP_INTO_ID = STEP_INTO_ID;
exports.STEP_INTO_LABEL = STEP_INTO_LABEL;
exports.STEP_INTO_TARGET_ID = STEP_INTO_TARGET_ID;
exports.STEP_INTO_TARGET_LABEL = STEP_INTO_TARGET_LABEL;
exports.STEP_OUT_ID = STEP_OUT_ID;
exports.STEP_OUT_LABEL = STEP_OUT_LABEL;
exports.STEP_OVER_ID = STEP_OVER_ID;
exports.STEP_OVER_LABEL = STEP_OVER_LABEL;
exports.STOP_ID = STOP_ID;
exports.STOP_LABEL = STOP_LABEL;
exports.TERMINATE_THREAD_ID = TERMINATE_THREAD_ID;
exports.TOGGLE_INLINE_BREAKPOINT_ID = TOGGLE_INLINE_BREAKPOINT_ID;