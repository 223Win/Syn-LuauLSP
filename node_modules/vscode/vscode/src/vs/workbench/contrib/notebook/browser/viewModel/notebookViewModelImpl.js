...
} = require('../../../../../editor/common/model/editStack.js');
const {
  IntervalNode,
  IntervalTree
} = require('../../../../../editor/common/model/intervalTree.js');
const {
...
} = require('./cellSelectionCollection.js');
const {
  CodeCellViewModel
} = require('./codeCellViewModel.js');
const {
  MarkupCellViewModel
} = require('./markupCellViewModel.js');
const {
...
let NotebookViewModel = class NotebookViewModel extends Disposable {
  ...
  replaceOne(cell, range, text) {
    ...
    return viewCell.resolveTextModel().then(() => {
      this._bulkEditService.apply([new ResourceTextEdit(cell.uri, {
        range,
        text
      })], {
...
NotebookViewModel = __decorate([__param(5, IInstantiationService), __param(6, IBulkEditService), __param(7, IUndoRedoService), __param(8, ITextModelService), __param(9, INotebookExecutionStateService)], NotebookViewModel);
