...
class NotebookOptions extends Disposable {
  constructor(targetWindow, configurationService, notebookExecutionStateService, codeEditorService, isReadonly, overrides) {
    ...
    const cellToolbarLocation = this.configurationService.getValue(NotebookSetting.cellToolbarLocation) ?? {
      'default': 'right'
    };
  ...
  _updateConfiguration(e) {
    ...
    if (cellToolbarLocation) {
      configuration.cellToolbarLocation = this.configurationService.getValue(NotebookSetting.cellToolbarLocation) ?? {
        'default': 'right'
      };
    }
  ...
  computeBottomToolbarDimensions(viewType) {
    ...
    const {
      bottomToolbarGap,
      bottomToolbarHeight
    } = this._computeBottomToolbarDimensions(configuration.compactView, configuration.insertToolbarPosition, configuration.insertToolbarAlignment, cellToolbarPosition);
    return {
      bottomToolbarGap,
      bottomToolbarHeight
    };
...
exports.OutputInnerContainerTopPadding = OutputInnerContainerTopPadding;