...
const {
  ListError
} = require('../../../../../base/browser/ui/list/list.js');
const {
  Emitter,
  Event
...
} = require('./notebookCellListView.js');
const {
  INotebookExecutionStateService
} = require('../../common/notebookExecutionStateService.service.js');
const {
  NotebookCellAnchor
} = require('./notebookCellAnchor.js');
const {
  NotebookViewZones
} = require('../viewParts/notebookViewZones.js');
...
let NotebookCellList = class NotebookCellList extends WorkbenchList {
  ...
  async revealCell(cell, revealType) {
    ...
    if ((cell.getEditState() === CellEditState.Editing || revealType === 6 && cell.cellKind === CellKind.Code) && !cell.editorAttached) {
...
NotebookCellList = __decorate([__param(7, IListService), __param(8, IConfigurationService), __param(9, IInstantiationService), __param(10, INotebookExecutionStateService)], NotebookCellList);
...
exports.NOTEBOOK_WEBVIEW_BOUNDARY = NOTEBOOK_WEBVIEW_BOUNDARY;
