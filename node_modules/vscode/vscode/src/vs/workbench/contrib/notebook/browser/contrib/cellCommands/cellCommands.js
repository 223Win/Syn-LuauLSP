...
} = require('../../../../bulkEdit/browser/bulkCellEdits.js');
const {
  moveCellRange,
  copyCellRange,
  ...
  joinSelectedCells,
  changeCellToKind
} = require('../../controller/cellOperations.js');
const {
  NotebookCellAction,
    ...
    if (context.cell instanceof CodeCellViewModel) {
      ...
      if (error?.location) {
        ...
        if (editor) {
          ...
          controller?.manualTriggerAtCurrentPosition(localizeWithPath(_moduleId, 21, "No code actions available"), CodeActionTriggerSource.Default, {
...
exports.OPEN_CELL_FAILURE_ACTIONS_COMMAND_ID = OPEN_CELL_FAILURE_ACTIONS_COMMAND_ID;