...
const {
  ICommentService
} = require('../../../../comments/browser/commentService.service.js');
const {
  CommentThreadWidget
} = require('../../../../comments/browser/commentThreadWidget.js');
const {
  CellContentPart
} = require('../cellPart.js');
const {
  ...
  async _getCommentThreadForCell(element) {
    if (this.notebookEditor.hasModel()) {
      ...
      if (commentInfos.length && commentInfos[0].threads.length) {
        return {
          owner: commentInfos[0].uniqueOwner,
          thread: commentInfos[0].threads[0]
        };
      }
    }
    return null;
...
CellComments = __decorate([__param(2, IContextKeyService), __param(3, IThemeService), __param(4, ICommentService), __param(5, IConfigurationService), __param(6, IInstantiationService)], CellComments);
