...
const {} = require('./notebookFindReplaceWidget.css.js');
const {
  FindReplaceState
...
const {
  parseReplaceString,
  ReplacePattern
} = require('../../../../../../editor/contrib/find/browser/replacePattern.js');
const {
  Codicon
...
let SimpleFindReplaceWidget = class SimpleFindReplaceWidget extends Widget {
  constructor(_contextViewService, contextKeyService, _configurationService, contextMenuService, instantiationService, hoverService, _state = new FindReplaceState(), _notebookEditor) {
    ...
    const findScope = this._configurationService.getValue(NotebookSetting.findScope) ?? {
      markupSource: true,
      markupPreview: true,
      codeSource: true,
      codeOutput: true
