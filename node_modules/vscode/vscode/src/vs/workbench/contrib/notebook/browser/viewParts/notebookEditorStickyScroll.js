...
const {} = require('../../../../../base/browser/touch.js');
const {
  StandardMouseEvent
...
const {
  ...
  foldingExpandedIcon
} = require('../../../../../editor/contrib/folding/browser/foldingDecorations.js');
const {
  FoldingController
...
const {
  INotebookCellOutlineProviderFactory
} = require('../viewModel/notebookOutlineProviderFactory.service.js');
...
let NotebookStickyScroll = NotebookStickyScroll_1 = class NotebookStickyScroll extends Disposable {
  ...
  init() {
    const {
      object: notebookOutlineReference
    } = this.notebookOutlineReference = this.instantiationService.invokeFunction(accessor => accessor.get(INotebookCellOutlineProviderFactory).getOrCreate(this.notebookEditor, 1));
...
NotebookStickyScroll = NotebookStickyScroll_1 = __decorate([__param(3, IContextMenuService), __param(4, IInstantiationService)], NotebookStickyScroll);
