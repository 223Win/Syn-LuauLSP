...
const {
  FoldingModel
} = require('../viewModel/foldingModel.js');
const {
  CellKind
...
const _moduleId = "vs/workbench/contrib/notebook/browser/controller/foldingController";
...
const NOTEBOOK_FOLD_COMMAND_LABEL = localizeWithPath(_moduleId, 0, "Fold Cell");
const NOTEBOOK_UNFOLD_COMMAND_LABEL = localize2WithPath(_moduleId, 1, "Unfold Cell");
...
registerAction2(class extends Action2 {
  constructor() {
    super({
      id: 'notebook.fold',
      title: localize2WithPath(_moduleId, 0, "Fold Cell"),
