...
const _moduleId = "vs/workbench/contrib/notebook/browser/view/cellParts/cellEditorOptions";
...
Registry.as(Extensions.Configuration).registerConfiguration({
  ...
  'properties': {
    'notebook.lineNumbers': {
      ...
      enum: ['off', 'on'],
      default: 'off',
      markdownDescription: localizeWithPath(_moduleId, 0, "Controls the display of line numbers in the cell editor.")
    }
  }
});
registerAction2(class ToggleLineNumberAction extends Action2 {
  constructor() {
    super({
      ...
      title: localize2WithPath(_moduleId, 1, 'Toggle Notebook Line Numbers'),
      ...
      toggled: {
        ...
        title: localizeWithPath(_moduleId, 2, "Notebook Line Numbers")
      }
    });
  }
  async run(accessor) {
...
registerAction2(class ToggleActiveLineNumberAction extends NotebookMultiCellAction {
  constructor() {
    super({
      ...
      title: localizeWithPath(_moduleId, 3, "Show Cell Line Numbers"),
