...
const {
  CellEditorOptions
} = require('./cellEditorOptions.js');
const {
  CellOutputContainer
} = require('./cellOutput.js');
const {
  CollapsedCodeCellExecutionIcon
} = require('./codeCellExecutionIcon.js');
const {
  outputDisplayLimit
...
const _moduleId = "vs/workbench/contrib/notebook/browser/view/cellParts/codeCell";
let CodeCell = class CodeCell extends Disposable {
  ...
  _attachInputExpandButton(element) {
    ...
    if (keybinding) {
      element.title = localizeWithPath(_moduleId, 0, "Double-click to expand cell input ({0})", keybinding.getLabel());
      expandIcon.title = localizeWithPath(_moduleId, 1, "Expand Cell Input ({0})", keybinding.getLabel());
    }
...
CodeCell = __decorate([__param(3, IInstantiationService), __param(4, IKeybindingService), __param(5, IOpenerService), __param(6, ILanguageService), __param(7, IConfigurationService), __param(8, INotebookExecutionStateService)], CodeCell);
