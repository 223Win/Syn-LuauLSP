...
const {
  IInlineChatService
} = require('../../../../inlineChat/common/inlineChat.service.js');
const {
  Iterable
...
CellDiagnostics = CellDiagnostics_1 = __decorate([__param(1, INotebookExecutionStateService), __param(2, IMarkerService), __param(3, IInlineChatService), __param(4, IConfigurationService)], CellDiagnostics);
