...
const {
  PrefixSumComputer
} = require('../../../../../editor/common/model/prefixSumComputer.js');
const {
...
const {
  CellOutputViewModel
} = require('./cellOutputViewModel.js');
const {
  CellKind
...
const {
  CellDiagnostics
} = require('../contrib/cellDiagnostics/cellDiagnostics.js');
const {
...
let CodeCellViewModel = class CodeCellViewModel extends BaseCellViewModel {
  ...
  layoutChange(state, source) {
    ...
    if (!this.isInputCollapsed) {
      ...
      const editorWidth = state.outerWidth !== undefined ? this.viewContext.notebookOptions.computeCodeCellEditorWidth(state.outerWidth) : this._layoutInfo?.editorWidth;
      this._layoutInfo = {
...
CodeCellViewModel = __decorate([__param(4, IConfigurationService), __param(5, INotebookService), __param(6, ITextModelService), __param(7, IUndoRedoService), __param(8, ICodeEditorService), __param(9, IInstantiationService)], CodeCellViewModel);
exports.CodeCellViewModel = CodeCellViewModel;
exports.outputDisplayLimit = outputDisplayLimit;