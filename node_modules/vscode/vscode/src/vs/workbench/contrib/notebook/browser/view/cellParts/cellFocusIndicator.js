...
class CellFocusIndicator extends CellContentPart {
  constructor(notebookEditor, titleToolbar, top, left, right, bottom) {
    ...
    this.right = right;
    this.bottom = bottom;
    this.codeFocusIndicator = new FastDomNode(append(this.left.domNode, $('.codeOutput-focus-indicator-container', undefined, $('.codeOutput-focus-indicator.code-focus-indicator'))));
    this.outputFocusIndicator = new FastDomNode(append(this.left.domNode, $('.codeOutput-focus-indicator-container', undefined, $('.codeOutput-focus-indicator.output-focus-indicator'))));
