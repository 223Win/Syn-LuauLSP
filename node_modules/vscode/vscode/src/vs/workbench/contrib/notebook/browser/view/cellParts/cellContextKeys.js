...
} = require('../../controller/chat/notebookChatController.js');
const {
  CellFocusMode,
  CellEditState
...
CellContextKeyPart = __decorate([__param(1, IInstantiationService)], CellContextKeyPart);
...
CellContextKeyManager = __decorate([__param(2, IContextKeyService), __param(3, INotebookExecutionStateService)], CellContextKeyManager);
