...
} = require('./notebookService.js');
const {
  INotebookService
} = require('./notebookService.service.js');
const {
  joinPath,
  isEqual
...
} = require('./notebookEditorModelResolverService.service.js');
const {
  ILabelService
...
} = require('../../../common/editor/resourceEditorInput.js');
const {
  onUnexpectedError
...
const _moduleId = "vs/workbench/contrib/notebook/common/notebookEditorInput";
  ...
  constructor(resource, preferredResource, viewType, options, _notebookService, _notebookModelResolverService, _fileDialogService, labelService, fileService, filesConfigurationService, extensionService, editorService, textResourceConfigurationService, customEditorLabelService) {
    ...
    this._register(extensionService.onWillStop(e => {
      ...
      e.veto((async () => {
        ...
        return true;
      })(), localizeWithPath(_moduleId, 0, "Notebook '{0}' could not be saved.", this.resource.path));
    }));
  }
  dispose() {
...
NotebookEditorInput = NotebookEditorInput_1 = __decorate([__param(4, INotebookService), __param(5, INotebookEditorModelResolverService), __param(6, IFileDialogService), __param(7, ILabelService), __param(8, IFileService), __param(9, IFilesConfigurationService), __param(10, IExtensionService), __param(11, IEditorService), __param(12, ITextResourceConfigurationService), __param(13, ICustomEditorLabelService)], NotebookEditorInput);
...
function isNotebookEditorInput(thing) {
  return !!thing && typeof thing === 'object' && thing instanceof NotebookEditorInput;
}
