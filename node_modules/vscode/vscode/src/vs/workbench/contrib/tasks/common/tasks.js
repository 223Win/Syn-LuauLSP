...
} = require('./taskDefinitionRegistry.js');
const _moduleId = "vs/workbench/contrib/tasks/common/tasks";
const USER_TASKS_GROUP_KEY = 'settings';
const TASK_RUNNING_STATE = new RawContextKey('taskRunning', false, localizeWithPath(_moduleId, 0, "Whether a task is currently running."));
const TASKS_CATEGORY = localize2WithPath(_moduleId, 1, "Tasks");
var ShellQuoting;
        ...
        if (schema.default !== undefined) {
          ...
          switch (schema.type) {
            ...
            case 'string':
              ...
              break;
            default:
              reporter.error(localizeWithPath(_moduleId, 2, 'Error: the task identifier \'{0}\' is missing the required property \'{1}\'. The task identifier will be ignored.', JSON.stringify(external, undefined, 0), property));
              return undefined;
          }
        }
      }
...
exports.CUSTOMIZED_TASK_TYPE = CUSTOMIZED_TASK_TYPE;
...
exports.RevealKind = RevealKind;
exports.RevealProblemKind = RevealProblemKind;
exports.RunOnOptions = RunOnOptions;
exports.RunOptions = RunOptions;
exports.RuntimeType = RuntimeType;
exports.ShellQuoting = ShellQuoting;
exports.TASKS_CATEGORY = TASKS_CATEGORY;
exports.TASK_RUNNING_STATE = TASK_RUNNING_STATE;
exports.TaskDefinition = TaskDefinition;
exports.TaskEvent = TaskEvent;
exports.TaskGroup = TaskGroup;
exports.TaskSorter = TaskSorter;
exports.TaskSourceKind = TaskSourceKind;
exports.USER_TASKS_GROUP_KEY = USER_TASKS_GROUP_KEY;