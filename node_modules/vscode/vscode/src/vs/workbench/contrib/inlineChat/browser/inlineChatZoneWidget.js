    ...
    this.widget = this._instaService.createInstance(EditorBasedInlineChatWidget, this.editor, {
      ...
      rendererOptions: {
        renderTextEditsAsSummary: uri => {
          return isEqual(uri, editor.getModel()?.uri) && configurationService.getValue("inlineChat.mode") === "live";
        }
      }
    });
...
InlineChatZoneWidget = __decorate([__param(1, IInstantiationService), __param(2, IContextKeyService), __param(3, IConfigurationService)], InlineChatZoneWidget);
