...
}, localizeWithPath(_moduleId, 0, 'Foreground color for the labels in the editor watermark.'));
const showCommands = {
  text: localizeWithPath(_moduleId, 1, "Show All Commands"),
  id: 'workbench.action.showCommands'
};
const quickAccess = {
  text: localizeWithPath(_moduleId, 2, "Go to File"),
  id: 'workbench.action.quickOpen'
};
const openFileNonMacOnly = {
  text: localizeWithPath(_moduleId, 3, "Open File"),
  id: 'workbench.action.files.openFile',
  mac: false
};
const openFolderNonMacOnly = {
  text: localizeWithPath(_moduleId, 4, "Open Folder"),
  id: 'workbench.action.files.openFolder',
  mac: false
};
const openFileOrFolderMacOnly = {
  text: localizeWithPath(_moduleId, 5, "Open File or Folder"),
  id: 'workbench.action.files.openFileFolder',
  mac: true
};
const openRecent = {
  text: localizeWithPath(_moduleId, 6, "Open Recent"),
  id: 'workbench.action.openRecent'
};
const newUntitledFileMacOnly = {
  text: localizeWithPath(_moduleId, 7, "New Untitled Text File"),
  id: 'workbench.action.files.newUntitledFile',
  mac: true
};
const findInFiles = {
  text: localizeWithPath(_moduleId, 8, "Find in Files"),
  id: 'workbench.action.findInFiles'
};
const toggleTerminal = {
  text: localizeWithPath(_moduleId, 9, "Toggle Terminal"),
  id: 'workbench.action.terminal.toggleTerminal',
  when: ContextKeyExpr.equals('terminalProcessSupported', true)
};
const startDebugging = {
  text: localizeWithPath(_moduleId, 10, "Start Debugging"),
  id: 'workbench.action.debug.start',
  when: ContextKeyExpr.equals('terminalProcessSupported', true)
};
const toggleFullscreen = {
  text: localizeWithPath(_moduleId, 11, "Toggle Full Screen"),
  id: 'workbench.action.toggleFullScreen'
};
const showSettings = {
  text: localizeWithPath(_moduleId, 12, "Show Settings"),
  id: 'workbench.action.openSettings'
};
const noFolderEntries = [showCommands, openFileNonMacOnly, openFolderNonMacOnly, openFileOrFolderMacOnly, openRecent, newUntitledFileMacOnly];
const folderEntries = [showCommands, quickAccess, findInFiles, startDebugging, toggleTerminal, toggleFullscreen, showSettings];
let EditorGroupWatermark = class EditorGroupWatermark extends Disposable {
  constructor(container, keybindingService, contextService, contextKeyService, configurationService) {
    ...
    this.enabled = false;
    const elements = h('.editor-group-watermark', [h('.letterpress'), h('.shortcuts@shortcuts')]);
  ...
  render() {
    ...
    const update = () => {
      ...
      for (const entry of selected) {
        ...
        this.keybindingLabel = new KeybindingLabel(dd, OS, {
...
EditorGroupWatermark = __decorate([__param(1, IKeybindingService), __param(2, IWorkspaceContextService), __param(3, IContextKeyService), __param(4, IConfigurationService)], EditorGroupWatermark);
