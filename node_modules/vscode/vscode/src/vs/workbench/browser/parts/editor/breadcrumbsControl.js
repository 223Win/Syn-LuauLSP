...
const {
  BreadcrumbsWidget,
  BreadcrumbsItem
} = require('../../../../base/browser/ui/breadcrumbs/breadcrumbsWidget.js');
const {
  tail
...
const {
  IBreadcrumbsService
} = require('./breadcrumbs.service.js');
const {
  BreadcrumbsModel,
  OutlineElement2,
  FileElement
} = require('./breadcrumbsModel.js');
const {
  BreadcrumbsFilePicker,
  BreadcrumbsOutlinePicker
} = require('./breadcrumbsPicker.js');
const {
...
const _moduleId = "vs/workbench/browser/parts/editor/breadcrumbsControl";
...
const separatorIcon = registerIcon('breadcrumb-separator', Codicon.chevronRight, localizeWithPath(_moduleId, 0, 'Icon for the separator in the breadcrumbs.'));
let BreadcrumbsControl = class BreadcrumbsControl {
  ...
  static {
    this.CK_BreadcrumbsPossible = new RawContextKey('breadcrumbsPossible', false, localizeWithPath(_moduleId, 1, "Whether the editor can show breadcrumbs"));
  }
  static {
    this.CK_BreadcrumbsVisible = new RawContextKey('breadcrumbsVisible', false, localizeWithPath(_moduleId, 2, "Whether breadcrumbs are currently visible"));
  }
  static {
    this.CK_BreadcrumbsActive = new RawContextKey('breadcrumbsActive', false, localizeWithPath(_moduleId, 3, "Whether breadcrumbs have focus"));
  }
    ...
    const updateBreadcrumbs = () => {
      ...
      if (items.length === 0) {
        ...
        this._widget.setItems([new class extends BreadcrumbsItem {
          render(container) {
            container.innerText = localizeWithPath(_moduleId, 4, "no elements");
          }
          equals(other) {
            return other === this;
          }
...
registerAction2(class ToggleBreadcrumb extends Action2 {
  constructor() {
    super({
      ...
      title: {
        ...localize2WithPath(_moduleId, 5, "Toggle Breadcrumbs"),
        mnemonicTitle: localizeWithPath(_moduleId, 6, "Toggle &&Breadcrumbs")
      },
      category: Categories.View,
      toggled: {
        condition: ContextKeyExpr.equals('config.breadcrumbs.enabled', true),
        title: localizeWithPath(_moduleId, 7, "Toggle Breadcrumbs"),
        mnemonicTitle: localizeWithPath(_moduleId, 8, "Toggle &&Breadcrumbs")
      },
      menu: [{
...
registerAction2(class FocusAndSelectBreadcrumbs extends Action2 {
  constructor() {
    super({
      ...
      title: localize2WithPath(_moduleId, 9, "Focus and Select Breadcrumbs"),
...
registerAction2(class FocusBreadcrumbs extends Action2 {
  constructor() {
    super({
      ...
      title: localize2WithPath(_moduleId, 10, "Focus Breadcrumbs"),
      precondition: BreadcrumbsControl.CK_BreadcrumbsVisible,
      keybinding: {
        weight: 200,
