const {} = require('./media/singleeditortabscontrol.css.js');
const {
  EditorTabsControl
...
class NoEditorTabsControl extends EditorTabsControl {
  ...
  activeEditorChanged() {
    if (!this.activeEditor && this.tabsModel.activeEditor || this.activeEditor && !this.tabsModel.activeEditor || !this.activeEditor || !this.tabsModel.isActive(this.activeEditor)) {
      return true;
    }
    return false;
  }
