...
const _moduleId = "vs/workbench/browser/parts/editor/textEditor";
let AbstractTextEditor = class AbstractTextEditor extends AbstractEditorWithViewState {
  ...
  computeAriaLabel() {
    return this.input ? computeEditorAriaLabel(this.input, undefined, this.group, this.editorGroupService.count) : localizeWithPath(_moduleId, 0, "Editor");
  }
