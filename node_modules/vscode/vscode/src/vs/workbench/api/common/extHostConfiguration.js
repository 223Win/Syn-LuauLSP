...
class ExtHostConfigProvider {
  ...
  getConfiguration(section, scope, extensionDescription) {
    ...
    const config = this._toReadonlyValue(section ? lookUp(this._configuration.getValue(undefined, overrides, this._extHostWorkspace.workspace), section) : this._configuration.getValue(undefined, overrides, this._extHostWorkspace.workspace));
    if (section) {
...
exports.IExtHostConfiguration = IExtHostConfiguration;