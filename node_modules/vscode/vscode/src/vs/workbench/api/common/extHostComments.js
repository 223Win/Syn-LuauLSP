...
const {
  ...
  CommentThreadState$1,
  CommentThreadApplicability$1
...
const {
  MarkdownString,
  CommentThreadCollapsibleState$1,
  CommentThreadState,
...
function createExtHostComments(mainContext, commands, documents) {
  ...
  class ExtHostCommentController {
    ...
    $createCommentThreadTemplate(uriComponents, range) {
      const commentThread = new ExtHostCommentThread(this.id, this.handle, undefined, URI.revive(uriComponents), Range.to(range), [], this._extension, true);
