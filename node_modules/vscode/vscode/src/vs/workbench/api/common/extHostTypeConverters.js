...
const marked_1 = require('../../../../../../external/vscode-marked/lib/marked.esm.js');
const {
  parse,
  revive
...
const {
  ChatAgentLocation
} = require('../../contrib/chat/common/chatAgents.js');
const {
  CellKind,
  NotebookCellExecutionState$1
...
const {
  ...
  SymbolInformation,
  CallHierarchyItem$1,
  CallHierarchyIncomingCall$1,
  CallHierarchyOutgoingCall$1,
  Location$1,
  InlineValueText,
  ...
  NotebookRange$1,
  NotebookCellData$1,
  NotebookCellOutputItem$1,
  NotebookCellOutput$1,
  TestTag$1,
  TypeHierarchyItem$1,
  LanguageModelChatAssistantMessage,
  LanguageModelChatUserMessage,
  LanguageModelChatSystemMessage,
  InteractiveEditorResponseFeedbackKind$1,
  ChatLocation$1,
  Diagnostic$1,
  SymbolTag$1,
  DocumentSymbol$1,
  ...
  DocumentHighlight$1,
  MultiDocumentHighlight$1,
  CompletionItemTag$1,
  CompletionItemKind,
  InlayHintLabelPart$1,
  SelectionRange$1,
  EndOfLine$1,
  FoldingRangeKind$1,
  RelativePattern,
  ...
  DataTransfer$1,
  ChatResponseMarkdownPart$1,
  ChatResponseAnchorPart$1,
  ChatResponseReferencePart$1,
  ChatResponseProgressPart$1,
  ChatResponseFileTreePart,
  ChatResponseCommandButtonPart$1,
  ChatResponseTextEditPart$1,
  ChatResponseMarkdownWithVulnerabilitiesPart$1,
  ChatResponseDetectedParticipantPart$1,
  ...
  ChatVariableLevel$1,
  PartialAcceptTriggerKind$1,
  StandardTokenType,
  TextDocumentSaveReason$1,
  TextEditorLineNumbersStyle$1,
  ProgressLocation$1,
  NotebookCellExecutionState$2,
  TestMessage$1,
  validateTestCoverageCount,
  NotebookRendererScript$1,
  DecorationRangeBehavior$1
...
(function (SymbolKind) {
  ...
  function to(kind) {
    ...
    return SymbSymbolKind$1olKind.Property;
  }
  SymbolKind$1.to = to;
...
(function (WorkspaceSymbol) {
  ...
  function to(info) {
    const result = new SymbolInformation(info.name, SymbolKind$1.to(info.kind), info.containerName, location.to(info.location));
...
(function (DocumentSymbol) {
  ...
  function to(info) {
    const result = new DocumentSymbol$1(info.name, info.detail, SymbolKind$1.to(info.kind), Range.to(info.range), Range.to(info.selectionRange));
...
(function (CallHierarchyItem) {
  function to(item) {
    const result = new CallHierarchyItem$1(SymbolKind$1.to(item.kind), item.name, item.detail || '', URI.revive(item.uri), Range.to(item.range), Range.to(item.selectionRange));
...
(function (CompletionItemKind) {
  const _from = new Map([[CompletionItemKind.Method, 0], [CompletionItemKind.Function, 1], [CompletionItemKind.Constructor, 2], [CompletionItemKind.Field, 3], [CompletionItemKind.Variable, 4], [CompletionItemKind.Class, 5], [CompletionItemKind.Interface, 7], [CompletionItemKind.Struct, 6], [CompletionItemKind.Module, 8], [CompletionItemKind.Property, 9], [CompletionItemKind.Unit, 12], [CompletionItemKind.Value, 13], [CompletionItemKind.Constant, 14], [CompletionItemKind.Enum, 15], [CompletionItemKind.EnumMember, 16], [CompletionItemKind.Keyword, 17], [CompletionItemKind.Snippet, 27], [CompletionItemKind.Text, 18], [CompletionItemKind.Color, 19], [CompletionItemKind.File, 20], [CompletionItemKind.Reference, 21], [CompletionItemKind.Folder, 23], [CompletionItemKind.Event, 10], [CompletionItemKind.Operator, 11], [CompletionItemKind.TypeParameter, 24], [CompletionItemKind.Issue, 26], [CompletionItemKind.User, 25]]);
  function from(kind) {
    return _from.get(kind) ?? 9;
  }
  CompletionItemKind.from = from;
  const _to = new Map([[0, CompletionItemKind.Method], [1, CompletionItemKind.Function], [2, CompletionItemKind.Constructor], [3, CompletionItemKind.Field], [4, CompletionItemKind.Variable], [5, CompletionItemKind.Class], [7, CompletionItemKind.Interface], [6, CompletionItemKind.Struct], [8, CompletionItemKind.Module], [9, CompletionItemKind.Property], [12, CompletionItemKind.Unit], [13, CompletionItemKind.Value], [14, CompletionItemKind.Constant], [15, CompletionItemKind.Enum], [16, CompletionItemKind.EnumMember], [17, CompletionItemKind.Keyword], [27, CompletionItemKind.Snippet], [18, CompletionItemKind.Text], [19, CompletionItemKind.Color], [20, CompletionItemKind.File], [21, CompletionItemKind.Reference], [23, CompletionItemKind.Folder], [10, CompletionItemKind.Event], [11, CompletionItemKind.Operator], [24, CompletionItemKind.TypeParameter], [25, CompletionItemKind.User], [26, CompletionItemKind.Issue]]);
  function to(kind) {
...
(function (MappedEditsContext) {
  function is(v) {
    return !!v && typeof v === 'object' && 'documents' in v && Array.isArray(v.documents) && v.documents.every(subArr => Array.isArray(subArr) && subArr.every(docRef => docRef && typeof docRef === 'object' && 'uri' in docRef && URI.isUri(docRef.uri) && 'version' in docRef && typeof docRef.version === 'number' && 'ranges' in docRef && Array.isArray(docRef.ranges) && docRef.ranges.every(r => r instanceof Range$1)));
  }
  ...
  const convertTestResultItem = (node, parent) => {
    ...
    const snapshot = {
      ...
      taskStates: item.tasks.map(t => ({
        state: t.state,
        duration: t.duration,
        messages: t.messages.filter(m => m.type === 0).map(TestMessage.to)
      })),
      children: []
    };
    if (node.children) {
...
(function (TypeHierarchyItem) {
  function to(item) {
    const result = new TypeHierarchyItem$1(SymbolKind$1.to(item.kind), item.name, item.detail || '', URI.revive(item.uri), Range.to(item.range), Range.to(item.selectionRange));
    result._sessionId = item._sessionId;
    result._itemId = item._itemId;
    return result;
  }
...
(function (ChatVariableLevel) {
  function to(level) {
    switch (level) {
      case 'short':
        return ChatVariableLevel$1.Short;
      case 'medium':
        return ChatVariableLevel$1.Medium;
      case 'full':
      default:
  ...
  function from(level) {
    switch (level) {
      case ChatVariableLevel$1.Short:
        return 'short';
      case ChatVariableLevel$1.Medium:
        return 'medium';
...
(function (ChatResponseReferencePart) {
  function from(part) {
    ...
    return {
      kind: 'reference',
      reference: URI.isUri(part.value) ? part.value : Location.from(part.value),
      iconPath
    };
  }
  ...
  function to(part) {
    ...
    return new ChatResponseReferencePart$1('variableName' in value.reference ? {
...
exports.CallHierarchyItem$1 = CallHierarchyItem;
exports.CallHierarchyOutgoingCall = CallHierarchyOutgoingCall;
exports.ChatAgentCompletionItem = ChatAgentCompletionItem;
exports.ChatAgentRequest = ChatAgentRequest;
exports.ChatAgentResolvedVariable = ChatAgentResolvedVariable;
exports.ChatAgentResult = ChatAgentResult;
exports.ChatAgentUserActionEvent = ChatAgentUserActionEvent;
exports.ChatFollowup = ChatFollowup;
exports.ChatInlineFollowup = ChatInlineFollowup;
...
exports.ChatResponseFilesPart = ChatResponseFilesPart;
...
exports.ChatResponsePart = ChatResponsePart;
...
exports.ChatVariable = ChatVariable;
...
exports.CompletionItem = CompletionItem$1;
exports.CompletionItemKind = CompletionItemKind$1;
...
exports.InlineValue = InlineValue;
...
exports.LanguageModelMessage = LanguageModelMessage;
exports.LanguageSelector = LanguageSelector;
exports.Location = Location;
exports.MappedEditsContext = MappedEditsContext;
...
exports.NotebookCellExecutionSummary = NotebookCellExecutionSummary;
...
exports.NotebookDocumentContentOptions = NotebookDocumentContentOptions;
exports.NotebookExclusiveDocumentPattern = NotebookExclusiveDocumentPattern;
...
exports.NotebookStatusBarItem = NotebookStatusBarItem;
exports.ParameterInformation = ParameterInformation;
exports.PartialAcceptInfo = PartialAcceptInfo;
exports.PartialAcceptTriggerKind = PartialAcceptTriggerKind;
exports.Position$1 = Position;
exports.ProgressLocation = ProgressLocation;
exports.Range$1 = Range;
exports.Selection$1 = Selection;
exports.SelectionRange = SelectionRange;
exports.SignatureHelp = SignatureHelp;
exports.SignatureInformation = SignatureInformation;
exports.SymbolKind = SymbolKind$1;
exports.SymbolTag = SymbolTag;
exports.TerminalQuickFix = TerminalQuickFix;
...
exports.TextEditorOpenOptions = TextEditorOpenOptions;
exports.ThemableDecorationAttachmentRenderOptions = ThemableDecorationAttachmentRenderOptions;
exports.ThemableDecorationRenderOptions = ThemableDecorationRenderOptions;
exports.TokenType = TokenType;
exports.TypeHierarchyItem$1 = TypeHierarchyItem;
exports.ViewBadge = ViewBadge;
