  ...
  update() {
    ...
    this._timeoutHandle = setTimeout(() => {
      ...
      if (this._name) {
        ...
        name = localizeWithPath(_moduleId, 0, "{0} (Extension)", this._extension.displayName || this._extension.name);
      }
...
class StatusBarMessage {
  constructor(statusBar) {
    ...
    this._item.name = localizeWithPath(_moduleId, 1, "Extension Status");
  }
  dispose() {
