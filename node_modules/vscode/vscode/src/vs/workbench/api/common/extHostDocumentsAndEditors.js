...
const {
  ExtHostDocumentData
} = require('./extHostDocumentData.js');
const {
  IExtHostRpcService
} = require('./extHostRpcService.js');
const {
  ExtHostTextEditor
} = require('./extHostTextEditor.js');
const {
  Selection,
  Range,
  ViewColumn
...
ExtHostDocumentsAndEditors = __decorate([__param(0, IExtHostRpcService), __param(1, ILogService)], ExtHostDocumentsAndEditors);
...
exports.IExtHostDocumentsAndEditors = IExtHostDocumentsAndEditors;