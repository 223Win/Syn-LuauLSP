...
ExtHostSourceControl.__decorator = __decorate([debounce(100)], ExtHostSourceControl.prototype, "eventuallyAddResourceGroups", null);
ExtHostSourceControl.__decorator = __decorate([debounce(100)], ExtHostSourceControl.prototype, "eventuallyUpdateResourceStates", null);
let ExtHostSCM = class ExtHostSCM {
  ...
  async $provideHistoryItemSummary(sourceControlHandle, historyItemId, historyItemParentId, token) {
    ...
    return historyItem ? {
      ...historyItem,
      icon: getHistoryItemIconDto(historyItem)
    } : undefined;
  }
...
ExtHostSCM = ExtHostSCM_1 = __decorate([__param(3, ILogService)], ExtHostSCM);
