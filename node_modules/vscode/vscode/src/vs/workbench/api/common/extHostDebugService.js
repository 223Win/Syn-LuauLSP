...
} = require('../../contrib/debug/common/abstractDebugAdapter.js');
const {
  convertToVSCPaths,
  convertToDAPaths,
  isDebuggerMainContribution
} = require('../../contrib/debug/common/debugUtils.js');
const {
  IExtHostConfiguration
} = require('./extHostConfiguration.js');
const {
  IExtHostVariableResolverProvider
} = require('./extHostVariableResolverService.js');
const {
  toDisposable
...
let ExtHostDebugServiceBase = class ExtHostDebugServiceBase {
  ...
  constructor(extHostRpcService, _workspaceService, _extensionService, _configurationService, _editorTabs, _variableResolver, _commands) {
    ...
    this._onDidChangeActiveStackItem = new Emitter();
  ...
  getDebugAdapterTrackers(session) {
    ...
    return Promise.race([Promise.all(promises).then(result => {
      const trackers = result.filter(t => !!t);
      if (trackers.length > 0) {
        return new MultiTracker(trackers);
      }
      return undefined;
    }), new Promise(resolve => setTimeout(() => resolve(undefined), 1000))]).catch(err => {
      return undefined;
    });
  }
...
ExtHostDebugServiceBase = __decorate([__param(0, IExtHostRpcService), __param(1, IExtHostWorkspace), __param(2, IExtHostExtensionService), __param(3, IExtHostConfiguration), __param(4, IExtHostEditorTabs), __param(5, IExtHostVariableResolverProvider), __param(6, IExtHostCommands)], ExtHostDebugServiceBase);
...
WorkerExtHostDebugService = __decorate([__param(0, IExtHostRpcService), __param(1, IExtHostWorkspace), __param(2, IExtHostExtensionService), __param(3, IExtHostConfiguration), __param(4, IExtHostEditorTabs), __param(5, IExtHostVariableResolverProvider), __param(6, IExtHostCommands)], WorkerExtHostDebugService);
...
exports.IExtHostDebugService = IExtHostDebugService;
