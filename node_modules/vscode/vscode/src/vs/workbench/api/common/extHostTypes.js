...
} = require('../../../platform/remote/common/remoteAuthorityResolver.js');
const {
    isTextStreamMime
} = require('../../contrib/notebook/common/notebookCommon.js');
...
Position = Position_1 = __decorate([es5ClassCompat], Position);
...
Range = Range_1 = __decorate([es5ClassCompat], Range);
...
Selection = Selection_1 = __decorate([es5ClassCompat], Selection);
...
TextEdit = TextEdit_1 = __decorate([es5ClassCompat], TextEdit);
...
NotebookEdit = NotebookEdit_1 = __decorate([es5ClassCompat], NotebookEdit);
...
WorkspaceEdit = __decorate([es5ClassCompat], WorkspaceEdit);
...
SnippetString = SnippetString_1 = __decorate([es5ClassCompat], SnippetString);
var DiagnosticTag;
...
let Location = Location_1 = class Location {
    ...
    constructor(uri, rangeOrPosition) {
        this.uri = uri;
        if (!rangeOrPosition); else if (Range.isRange(rangeOrPosition)) {
...
Location = Location_1 = __decorate([es5ClassCompat], Location);
...
DiagnosticRelatedInformation = __decorate([es5ClassCompat], DiagnosticRelatedInformation);
...
Diagnostic = __decorate([es5ClassCompat], Diagnostic);
...
SymbolInformation = SymbolInformation_1 = __decorate([es5ClassCompat], SymbolInformation);
...
CodeActionKind = CodeActionKind_1 = __decorate([es5ClassCompat], CodeActionKind);
...
let MarkdownString = MarkdownString_1 = class MarkdownString {
    ...
    constructor(value, supportThemeIcons = false) {
        this.#delegate = new MarkdownString$1(value, {
            supportThemeIcons
        });
    }
    get value() {
...
MarkdownString = MarkdownString_1 = __decorate([es5ClassCompat], MarkdownString);
...
module.exports.CallHierarchyIncomingCall = CallHierarchyIncomingCall;
module.exports.CallHierarchyItem = CallHierarchyItem;
module.exports.CallHierarchyOutgoingCall = CallHierarchyOutgoingCall;
module.exports.ChatCompletionItem = ChatCompletionItem;
module.exports.ChatCopyKind = ChatCopyKind;
module.exports.ChatEditorTabInput = ChatEditorTabInput;
module.exports.ChatLocation = ChatLocation;
module.exports.ChatRequestTurn = ChatRequestTurn;
module.exports.ChatResponseAnchorPart = ChatResponseAnchorPart;
module.exports.ChatResponseCommandButtonPart = ChatResponseCommandButtonPart;
module.exports.ChatResponseDetectedParticipantPart = ChatResponseDetectedParticipantPart;
module.exports.ChatResponseFileTreePart = ChatResponseFileTreePart;
module.exports.ChatResponseMarkdownPart = ChatResponseMarkdownPart;
module.exports.ChatResponseMarkdownWithVulnerabilitiesPart = ChatResponseMarkdownWithVulnerabilitiesPart;
module.exports.ChatResponseProgressPart = ChatResponseProgressPart;
module.exports.ChatResponseReferencePart = ChatResponseReferencePart;
module.exports.ChatResponseTextEditPart = ChatResponseTextEditPart;
module.exports.ChatResponseTurn = ChatResponseTurn;
module.exports.ChatResultFeedbackKind = ChatResultFeedbackKind;
module.exports.ChatVariableLevel = ChatVariableLevel;
module.exports.CodeAction = CodeAction;
module.exports.CodeActionKind = CodeActionKind;
module.exports.CodeActionTriggerKind = CodeActionTriggerKind;
module.exports.CodeLens = CodeLens;
module.exports.Color = Color;
module.exports.ColorInformation = ColorInformation;
module.exports.ColorPresentation = ColorPresentation;
module.exports.ColorTheme = ColorTheme;
module.exports.ColorThemeKind = ColorThemeKind;
module.exports.CommentMode = CommentMode;
module.exports.CommentState = CommentState;
module.exports.CommentThreadApplicability = CommentThreadApplicability;
module.exports.CommentThreadCollapsibleState = CommentThreadCollapsibleState;
module.exports.CommentThreadState = CommentThreadState;
module.exports.CompletionItem = CompletionItem;
module.exports.CompletionItemKind = CompletionItemKind;
module.exports.CompletionItemTag = CompletionItemTag;
module.exports.CompletionList = CompletionList;
module.exports.CompletionTriggerKind = CompletionTriggerKind;
module.exports.ConfigurationTarget = ConfigurationTarget;
module.exports.CustomEditorTabInput = CustomEditorTabInput;
module.exports.CustomExecution = CustomExecution;
module.exports.DataBreakpoint = DataBreakpoint;
module.exports.DataTransfer = DataTransfer;
module.exports.DataTransferFile = DataTransferFile;
module.exports.DataTransferItem = DataTransferItem;
module.exports.DebugAdapterExecutable = DebugAdapterExecutable;
module.exports.DebugAdapterInlineImplementation = DebugAdapterInlineImplementation;
module.exports.DebugAdapterNamedPipeServer = DebugAdapterNamedPipeServer;
module.exports.DebugAdapterServer = DebugAdapterServer;
module.exports.DebugConsoleMode = DebugConsoleMode;
module.exports.DebugStackFrame = DebugStackFrame;
module.exports.DebugThread = DebugThread;
module.exports.DebugVisualization = DebugVisualization;
module.exports.DeclarationCoverage = DeclarationCoverage;
module.exports.DecorationRangeBehavior = DecorationRangeBehavior;
module.exports.Diagnostic = Diagnostic;
module.exports.DiagnosticRelatedInformation = DiagnosticRelatedInformation;
module.exports.DiagnosticSeverity = DiagnosticSeverity;
module.exports.DiagnosticTag = DiagnosticTag;
module.exports.Disposable = Disposable;
module.exports.DocumentDropEdit = DocumentDropEdit;
module.exports.DocumentDropOrPasteEditKind = DocumentDropOrPasteEditKind;
module.exports.DocumentHighlight = DocumentHighlight;
module.exports.DocumentHighlightKind = DocumentHighlightKind;
module.exports.DocumentLink = DocumentLink;
module.exports.DocumentPasteEdit = DocumentPasteEdit;
module.exports.DocumentPasteTriggerKind = DocumentPasteTriggerKind;
module.exports.DocumentSymbol = DocumentSymbol;
module.exports.EndOfLine = EndOfLine;
module.exports.EnvironmentVariableMutatorType = EnvironmentVariableMutatorType;
module.exports.EvaluatableExpression = EvaluatableExpression;
module.exports.ExtensionKind = ExtensionKind;
module.exports.ExtensionMode = ExtensionMode;
module.exports.ExtensionRuntime = ExtensionRuntime;
module.exports.ExternalUriOpenerPriority = ExternalUriOpenerPriority;
module.exports.FileChangeType = FileChangeType;
module.exports.FileCoverage = FileCoverage;
module.exports.FileDecoration = FileDecoration;
module.exports.FileSystemError = FileSystemError;
module.exports.FoldingRange = FoldingRange;
module.exports.FoldingRangeKind = FoldingRangeKind;
module.exports.FunctionBreakpoint = FunctionBreakpoint;
module.exports.Hover = Hover;
module.exports.HoverVerbosityAction = HoverVerbosityAction;
module.exports.InlayHint = InlayHint;
module.exports.InlayHintKind = InlayHintKind;
module.exports.InlayHintLabelPart = InlayHintLabelPart;
module.exports.InlineCompletionTriggerKind = InlineCompletionTriggerKind;
module.exports.InlineEdit = InlineEdit;
module.exports.InlineEditTriggerKind = InlineEditTriggerKind;
module.exports.InlineSuggestion = InlineSuggestion;
module.exports.InlineSuggestionList = InlineSuggestionList;
module.exports.InlineValueContext = InlineValueContext;
module.exports.InlineValueEvaluatableExpression = InlineValueEvaluatableExpression;
module.exports.InlineValueText = InlineValueText;
module.exports.InlineValueVariableLookup = InlineValueVariableLookup;
module.exports.InputBoxValidationSeverity = InputBoxValidationSeverity;
module.exports.InteractiveEditorResponseFeedbackKind = InteractiveEditorResponseFeedbackKind;
module.exports.InteractiveSessionVoteDirection = InteractiveSessionVoteDirection;
module.exports.InteractiveWindowInput = InteractiveWindowInput;
module.exports.InternalDataTransferItem = InternalDataTransferItem;
module.exports.InternalFileDataTransferItem = InternalFileDataTransferItem;
module.exports.KeywordRecognitionStatus = KeywordRecognitionStatus;
module.exports.LanguageModelChatAssistantMessage = LanguageModelChatAssistantMessage;
module.exports.LanguageModelChatSystemMessage = LanguageModelChatSystemMessage;
module.exports.LanguageModelChatUserMessage = LanguageModelChatUserMessage;
module.exports.LanguageModelError = LanguageModelError;
module.exports.LanguageStatusSeverity = LanguageStatusSeverity;
module.exports.LinkedEditingRanges = LinkedEditingRanges;
module.exports.Location = Location;
module.exports.ManagedResolvedAuthority = ManagedResolvedAuthority;
module.exports.MarkdownString = MarkdownString;
module.exports.MultiDocumentHighlight = MultiDocumentHighlight;
module.exports.NewSymbolName = NewSymbolName;
module.exports.NewSymbolNameTag = NewSymbolNameTag;
module.exports.NewSymbolNameTriggerKind$1 = NewSymbolNameTriggerKind;
module.exports.NotebookCellData = NotebookCellData;
module.exports.NotebookCellExecutionState = NotebookCellExecutionState;
module.exports.NotebookCellKind = NotebookCellKind;
module.exports.NotebookCellOutput = NotebookCellOutput;
module.exports.NotebookCellOutputItem = NotebookCellOutputItem;
module.exports.NotebookCellStatusBarAlignment = NotebookCellStatusBarAlignment;
module.exports.NotebookCellStatusBarItem = NotebookCellStatusBarItem;
module.exports.NotebookControllerAffinity = NotebookControllerAffinity;
module.exports.NotebookControllerAffinity2 = NotebookControllerAffinity2;
module.exports.NotebookData = NotebookData;
module.exports.NotebookDiffEditorTabInput = NotebookDiffEditorTabInput;
module.exports.NotebookEdit = NotebookEdit;
module.exports.NotebookEditorRevealType = NotebookEditorRevealType;
module.exports.NotebookEditorTabInput = NotebookEditorTabInput;
module.exports.NotebookKernelSourceAction = NotebookKernelSourceAction;
module.exports.NotebookRange = NotebookRange;
module.exports.NotebookRendererScript = NotebookRendererScript;
module.exports.NotebookVariablesRequestKind = NotebookVariablesRequestKind;
module.exports.ParameterInformation = ParameterInformation;
module.exports.PartialAcceptTriggerKind = PartialAcceptTriggerKind;
module.exports.PortAttributes = PortAttributes;
module.exports.PortAutoForwardAction = PortAutoForwardAction;
module.exports.Position = Position;
module.exports.ProcessExecution = ProcessExecution;
module.exports.ProgressLocation = ProgressLocation;
module.exports.QuickInputButtons = QuickInputButtons;
module.exports.QuickPickItemKind = QuickPickItemKind;
module.exports.Range = Range;
module.exports.RelatedInformationType = RelatedInformationType;
module.exports.RelativePattern = RelativePattern;
module.exports.RemoteAuthorityResolverError = RemoteAuthorityResolverError;
module.exports.ResolvedAuthority = ResolvedAuthority;
module.exports.Selection = Selection;
module.exports.SelectionRange = SelectionRange;
module.exports.SemanticTokens = SemanticTokens;
module.exports.SemanticTokensBuilder = SemanticTokensBuilder;
module.exports.SemanticTokensEdit = SemanticTokensEdit;
module.exports.SemanticTokensEdits = SemanticTokensEdits;
module.exports.SemanticTokensLegend = SemanticTokensLegend;
module.exports.ShellExecution = ShellExecution;
module.exports.ShellQuoting = ShellQuoting;
module.exports.SignatureHelp = SignatureHelp;
module.exports.SignatureHelpTriggerKind = SignatureHelpTriggerKind;
module.exports.SignatureInformation = SignatureInformation;
module.exports.SnippetString = SnippetString;
module.exports.SnippetTextEdit = SnippetTextEdit;
module.exports.SourceBreakpoint = SourceBreakpoint;
module.exports.SourceControlInputBoxValidationType = SourceControlInputBoxValidationType;
module.exports.SpeechToTextStatus = SpeechToTextStatus;
module.exports.StandardTokenType = StandardTokenType;
module.exports.StatementCoverage = StatementCoverage;
module.exports.StatusBarAlignment = StatusBarAlignment;
module.exports.SymbolInformation = SymbolInformation;
module.exports.SymbolKind = SymbolKind;
module.exports.SymbolTag = SymbolTag;
module.exports.SyntaxTokenType = SyntaxTokenType;
module.exports.Task = Task;
module.exports.TaskGroup = TaskGroup;
module.exports.TaskPanelKind = TaskPanelKind;
module.exports.TaskRevealKind = TaskRevealKind;
module.exports.TaskScope = TaskScope;
module.exports.TerminalEditorTabInput = TerminalEditorTabInput;
module.exports.TerminalExitReason = TerminalExitReason;
module.exports.TerminalLink = TerminalLink;
module.exports.TerminalLocation = TerminalLocation;
module.exports.TerminalOutputAnchor = TerminalOutputAnchor;
module.exports.TerminalProfile = TerminalProfile;
module.exports.TerminalQuickFixCommand = TerminalQuickFixCommand;
module.exports.TerminalQuickFixOpener = TerminalQuickFixOpener;
module.exports.TerminalShellExecutionCommandLineConfidence = TerminalShellExecutionCommandLineConfidence;
module.exports.TestCoverageCount = TestCoverageCount;
module.exports.TestMessage = TestMessage;
module.exports.TestResultState = TestResultState;
module.exports.TestRunProfileKind = TestRunProfileKind;
module.exports.TestRunRequest = TestRunRequest;
module.exports.TestTag = TestTag;
module.exports.TextDiffTabInput = TextDiffTabInput;
module.exports.TextDocumentChangeReason = TextDocumentChangeReason;
module.exports.TextDocumentSaveReason = TextDocumentSaveReason;
module.exports.TextEdit = TextEdit;
module.exports.TextEditorLineNumbersStyle = TextEditorLineNumbersStyle;
module.exports.TextEditorRevealType = TextEditorRevealType;
module.exports.TextEditorSelectionChangeKind = TextEditorSelectionChangeKind;
module.exports.TextMergeTabInput = TextMergeTabInput;
module.exports.TextMultiDiffTabInput = TextMultiDiffTabInput;
module.exports.TextTabInput = TextTabInput;
module.exports.ThemeColor = ThemeColor;
module.exports.ThemeIcon = ThemeIcon;
module.exports.TimelineItem = TimelineItem;
module.exports.TreeItem = TreeItem;
module.exports.TreeItemCheckboxState = TreeItemCheckboxState;
module.exports.TreeItemCollapsibleState = TreeItemCollapsibleState;
module.exports.TypeHierarchyItem = TypeHierarchyItem;
module.exports.VerboseHover = VerboseHover;
module.exports.ViewBadge = ViewBadge;
module.exports.ViewColumn = ViewColumn;
module.exports.WebviewEditorTabInput = WebviewEditorTabInput;
module.exports.WorkspaceEdit = WorkspaceEdit;
module.exports.WorkspaceTrustState = WorkspaceTrustState;
module.exports.asStatusBarItemIdentifier = asStatusBarItemIdentifier;
module.exports.setBreakpointId = setBreakpointId;
module.exports.validateTestCoverageCount = validateTestCoverageCount;