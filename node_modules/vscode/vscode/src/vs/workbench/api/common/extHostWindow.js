...
let ExtHostWindow = class ExtHostWindow {
  ...
  constructor(extHostRpc) {
    ...
    this._proxy.$getInitialState().then(({
      isFocused,
      isActive
    }) => {
...
ExtHostWindow = ExtHostWindow_1 = __decorate([__param(0, IExtHostRpcService)], ExtHostWindow);
const IExtHostWindow = createDecorator('IExtHostWindow');
exports.ExtHostWindow = ExtHostWindow;
exports.IExtHostWindow = IExtHostWindow;