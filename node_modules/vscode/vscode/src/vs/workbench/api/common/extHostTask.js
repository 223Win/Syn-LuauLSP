...
const {} = require('../../contrib/tasks/common/tasks.js');
const {
  NotSupportedError,
  ErrorNoTelemetry
...
(function (TaskDTO) {
  ...
  function from(value, extension) {
    ...
    const result = {
      ...
      runOptions: value.runOptions ? value.runOptions : {
...
ExtHostTaskBase = __decorate([__param(0, IExtHostRpcService), __param(1, IExtHostInitDataService), __param(2, IExtHostWorkspace), __param(3, IExtHostDocumentsAndEditors), __param(4, IExtHostConfiguration), __param(5, IExtHostTerminalService), __param(6, ILogService), __param(7, IExtHostApiDeprecationService)], ExtHostTaskBase);
...
WorkerExtHostTask = __decorate([__param(0, IExtHostRpcService), __param(1, IExtHostInitDataService), __param(2, IExtHostWorkspace), __param(3, IExtHostDocumentsAndEditors), __param(4, IExtHostConfiguration), __param(5, IExtHostTerminalService), __param(6, ILogService), __param(7, IExtHostApiDeprecationService)], WorkerExtHostTask);
const IExtHostTask = createDecorator('IExtHostTask');
exports.CustomExecutionDTO = CustomExecutionDTO;
exports.ExtHostTaskBase = ExtHostTaskBase;
exports.IExtHostTask = IExtHostTask;
