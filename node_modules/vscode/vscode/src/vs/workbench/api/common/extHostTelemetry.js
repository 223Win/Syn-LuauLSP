...
let ExtHostTelemetry = class ExtHostTelemetry extends Disposable {
  constructor(initData, loggerService) {
    ...
    this._outputLogger = loggerService.createLogger(this.extHostTelemetryLogFile, {
      ...
      name: localizeWithPath(_moduleId, 0, "Extension Telemetry{0}", this._inLoggingOnlyMode ? ' (Not Sent)' : ''),
      hidden: true
    });
...
ExtHostTelemetry = __decorate([__param(0, IExtHostInitDataService), __param(1, ILoggerService)], ExtHostTelemetry);
...
exports.IExtHostTelemetry = IExtHostTelemetry;
