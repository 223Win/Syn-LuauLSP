...
const {
  targetsNotebooks,
  score
} = require('../../../editor/common/languageSelector.js');
const {
  IndentAction
} = require('../../../editor/common/languages/languageConfiguration.js');
const {
  OverviewRulerLane
...
const {
  LogLevel
} = require('../../../platform/log/common/log.js');
const {
  ILoggerService,
  ILogService
...
const {
  getRemoteName
} = require('../../../platform/remote/common/remoteHosts.js');
const {
  TelemetryTrustedValue
} = require('../../../platform/telemetry/common/telemetryUtils.js');
const {
  EditSessionIdentityMatch
} = require('../../../platform/workspace/common/editSessions.js');
const {
  ExtHostContext,
  MainContext,
  CandidatePortSource
...
} = require('./extHostAiRelatedInformation.js');
const {
  ExtHostApiCommands
} = require('./extHostApiCommands.js');
const {
  IExtHostApiDeprecationService
} = require('./extHostApiDeprecationService.js');
const {
  IExtHostAuthentication
} = require('./extHostAuthentication.js');
const {
  ExtHostBulkEdits
} = require('./extHostBulkEdits.js');
const {
  ExtHostChatAgents2
} = require('./extHostChatAgents2.js');
const {
  ExtHostChatVariables
} = require('./extHostChatVariables.js');
const {
  ExtHostClipboard
} = require('./extHostClipboard.js');
const {
  ExtHostEditorInsets
} = require('./extHostCodeInsets.js');
const {
  IExtHostCommands
} = require('./extHostCommands.js');
const {
  createExtHostComments
} = require('./extHostComments.js');
const {
  IExtHostConfiguration
} = require('./extHostConfiguration.js');
const {
  ExtHostCustomEditors
} = require('./extHostCustomEditors.js');
const {
  IExtHostDebugService
} = require('./extHostDebugService.js');
const {
  IExtHostDecorations
} = require('./extHostDecorations.js');
const {
  ExtHostDiagnostics
} = require('./extHostDiagnostics.js');
const {
  ExtHostDialogs
} = require('./extHostDialogs.js');
const {
  ExtHostDocumentContentProvider
} = require('./extHostDocumentContentProviders.js');
const {
  ExtHostDocumentSaveParticipant
} = require('./extHostDocumentSaveParticipant.js');
const {
  ExtHostDocuments
} = require('./extHostDocuments.js');
const {
  IExtHostDocumentsAndEditors
} = require('./extHostDocumentsAndEditors.js');
const {
  IExtHostEditorTabs
} = require('./extHostEditorTabs.js');
const {
  ExtHostAiEmbeddingVector
} = require('./extHostEmbeddingVector.js');
const {
  IExtHostExtensionService,
  Extension
} = require('./extHostExtensionService.js');
const {
  ExtHostFileSystem
} = require('./extHostFileSystem.js');
const {
  IExtHostConsumerFileSystem
} = require('./extHostFileSystemConsumer.js');
const {
  ExtHostFileSystemEventService
} = require('./extHostFileSystemEventService.js');
const {
  IExtHostFileSystemInfo
} = require('./extHostFileSystemInfo.js');
const {
  IExtHostInitDataService
} = require('./extHostInitDataService.js');
const {
  ExtHostInteractiveEditor
} = require('./extHostInlineChat.js');
const {
  ExtHostInteractive
} = require('./extHostInteractive.js');
const {
  ExtHostLabelService
} = require('./extHostLabelService.js');
const {
  ExtHostLanguageFeatures
} = require('./extHostLanguageFeatures.js');
const {
  IExtHostLanguageModels
} = require('./extHostLanguageModels.js');
const {
  ExtHostLanguages
} = require('./extHostLanguages.js');
const {
  IExtHostLocalizationService
} = require('./extHostLocalizationService.js');
const {
  IExtHostManagedSockets
} = require('./extHostManagedSockets.js');
const {
  ExtHostMessageService
} = require('./extHostMessageService.js');
const {
  ExtHostNotebookController
} = require('./extHostNotebook.js');
const {
  ExtHostNotebookDocumentSaveParticipant
} = require('./extHostNotebookDocumentSaveParticipant.js');
const {
  ExtHostNotebookDocuments
} = require('./extHostNotebookDocuments.js');
const {
  ExtHostNotebookEditors
} = require('./extHostNotebookEditors.js');
const {
  ExtHostNotebookKernels
} = require('./extHostNotebookKernels.js');
const {
  ExtHostNotebookRenderers
} = require('./extHostNotebookRenderers.js');
const {
  IExtHostOutputService
} = require('./extHostOutput.js');
const {
  ExtHostProfileContentHandlers
} = require('./extHostProfileContentHandler.js');
const {
  ExtHostProgress
} = require('./extHostProgress.js');
const {
  ExtHostQuickDiff
} = require('./extHostQuickDiff.js');
const {
  createExtHostQuickOpen
} = require('./extHostQuickOpen.js');
const {
  IExtHostRpcService
} = require('./extHostRpcService.js');
const {
  ExtHostSCM
} = require('./extHostSCM.js');
const {
  IExtHostSearch
} = require('./extHostSearch.js');
const {
  IExtHostSecretState
} = require('./extHostSecretState.js');
const {
  ExtHostShare
} = require('./extHostShare.js');
const {
  ExtHostSpeech
} = require('./extHostSpeech.js');
const {
  ExtHostStatusBar
} = require('./extHostStatusBar.js');
const {
  IExtHostStorage
} = require('./extHostStorage.js');
const {
  IExtensionStoragePaths
} = require('./extHostStoragePaths.js');
const {
  IExtHostTask
} = require('./extHostTask.js');
const {
  IExtHostTelemetry,
  isNewAppInstall,
  ExtHostTelemetryLogger
} = require('./extHostTelemetry.js');
const {
  IExtHostTerminalService
} = require('./extHostTerminalService.js');
const {
  IExtHostTerminalShellIntegration
} = require('./extHostTerminalShellIntegration.js');
const {
  ExtHostTesting
} = require('./extHostTesting.js');
const {
  ExtHostEditors
} = require('./extHostTextEditors.js');
const {
  ExtHostTheming
} = require('./extHostTheming.js');
const {
  ExtHostTimeline
} = require('./extHostTimeline.js');
const {
  ExtHostTreeViews
} = require('./extHostTreeViews.js');
const {
  IExtHostTunnelService
} = require('./extHostTunnelService.js');
const {
  LanguageSelector
...
const {
  ExtHostUriOpeners
} = require('./extHostUriOpener.js');
const {
  IURITransformerService
} = require('./extHostUriTransformerService.js');
const {
  ExtHostUrls
} = require('./extHostUrls.js');
const {
  ExtHostWebviews
} = require('./extHostWebview.js');
const {
  ExtHostWebviewPanels
} = require('./extHostWebviewPanels.js');
const {
  ExtHostWebviewViews
} = require('./extHostWebviewView.js');
const {
  IExtHostWindow
} = require('./extHostWindow.js');
const {
  IExtHostWorkspace
} = require('./extHostWorkspace.js');
const {
  DebugConfigurationProviderTriggerKind
} = require('../../contrib/debug/common/debug.js');
const {
  UIKind
} = require('../../services/extensions/common/extensionHostProtocol.js');
const {
...
} = require('../../services/search/common/searchExtTypes.js');
function createApiFactoryAndRegisterActors(accessor) {
  ...
  return function (extension, extensionInfo, configProvider) {
      ...
      return (listener, thisArgs, disposables) => {
        const handle = actual(e => {
          try {
            ...
            onUnexpectedExternalError(new Error(`[ExtensionListenerError] Extension '${extension.identifier.value}' FAILED to handle event: ${err.toString()}`, {
              cause: err
            }));
    ...
    return {
      ...
      TestRunRequest2: TestRunRequest,
      ...
      LanguageModelChatSystemMessage: LanguageModelChatSystemMessage,
      LanguageModelChatUserMessage: LanguageModelChatUserMessage,
      LanguageModelChatAssistantMessage: LanguageModelChatAssistantMessage,
      LanguageModelSystemMessage: LanguageModelChatSystemMessage,
      LanguageModelUserMessage: LanguageModelChatUserMessage,
      LanguageModelAssistantMessage: LanguageModelChatAssistantMessage,
