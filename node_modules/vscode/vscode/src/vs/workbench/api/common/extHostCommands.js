...
ExtHostCommands = __decorate([__param(0, IExtHostRpcService), __param(1, ILogService), __param(2, IExtHostTelemetry)], ExtHostCommands);
...
class ApiCommandArgument {
  ...
  static {
    this.Position = new ApiCommandArgument('position', 'A position in a text document', v => Position.isPosition(v), Position$1.from);
  }
  static {
    this.Range = new ApiCommandArgument('range', 'A range in a text document', v => Range.isRange(v), Range$1.from);
  }
  static {
    this.Selection = new ApiCommandArgument('selection', 'A selection in a text document', v => Selection.isSelection(v), Selection$1.from);
  }
  static {
  ...
  static {
    this.StringArray = ApiCommandArgument.Arr(ApiCommandArgument.String);
  }
  static Arr(element) {
  ...
  static {
    this.CallHierarchyItem = new ApiCommandArgument('item', 'A call hierarchy item', v => v instanceof CallHierarchyItem, CallHierarchyItem$1.from);
  }
  static {
    this.TypeHierarchyItem = new ApiCommandArgument('item', 'A type hierarchy item', v => v instanceof TypeHierarchyItem, TypeHierarchyItem$1.from);
  }
  static {
    this.TestItem = new ApiCommandArgument('testItem', 'A VS Code TestItem', v => v instanceof TestItemImpl, TestItem.from);
  }
...
exports.IExtHostCommands = IExtHostCommands;