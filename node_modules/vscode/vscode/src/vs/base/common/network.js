...
class FileAccessImpl {
  ...
  toUrl(moduleId) {
    ...
    return new URL(url ?? moduleId, globalThis.location?.href ?? __filename).toString();
  }
  asBrowserUri(resourcePath) {
    const uri = this.toUri(resourcePath, {
      toUrl: this.toUrl.bind(this)
    });
  ...
  uriToBrowserUri(uri) {
    ...
    if (uri.scheme === Schemas.file && (isNative || webWorkerOrigin === `${Schemas.vscodeFileResource}://${FileAccessImpl.FALLBACK_AUTHORITY}`)) {
      return uri.with({
...
exports.VSCODE_AUTHORITY = VSCODE_AUTHORITY;
exports.connectionTokenQueryName = connectionTokenQueryName;
...
exports.nodeModulesAsarPath = nodeModulesAsarPath;
exports.nodeModulesAsarUnpackedPath = nodeModulesAsarUnpackedPath;
