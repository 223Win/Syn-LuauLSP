...
class ProtocolWriter {
  ...
  _writeNow() {
    ...
    this._socket.traceSocketEvent("protocolWrite", {
...
class PersistentProtocol {
  ...
  _recvAckCheck() {
    ...
    if (timeSinceOldestUnacknowledgedMsg >= 20000 && timeSinceLastReceivedSomeData >= 20000 && timeSinceLastTimeout >= 20000) {
...
exports.SocketDiagnostics = SocketDiagnostics;