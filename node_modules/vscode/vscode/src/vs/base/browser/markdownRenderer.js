...
const {
  ...
  sanitize,
  removeHook
} = require('./dompurify/dompurify.js');
const {
  DomEmitter
} = require('./event.js');
const {
...
} = require('./ui/iconLabel/iconLabels.js');
const {
  onUnexpectedError
...
} = require('../common/htmlContent.js');
const {
  markdownEscapeEscapedIcons
} = require('../common/iconLabels.js');
const {
  defaultGenerator
} = require('../common/idGenerator.js');
const {
  Lazy
} = require('../common/lazy.js');
const {
  DisposableStore
...
const {
  escape
} = require('../common/strings.js');
const {
  URI
} = require('../common/uri.js');
...
const allowedMarkdownAttr = ['align', 'autoplay', 'alt', 'checked', 'class', 'controls', 'data-code', 'data-href', 'disabled', 'draggable', 'height', 'href', 'loop', 'muted', 'playsinline', 'poster', 'src', 'style', 'target', 'title', 'type', 'width', 'start'];
...
function renderMarkdownAsPlaintext(markdown) {
  ...
  const html = marked_1.parse(value, {
...
exports.allowedMarkdownAttr = allowedMarkdownAttr;
