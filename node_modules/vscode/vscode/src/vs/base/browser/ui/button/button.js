...
} = require('../iconLabel/iconLabels.js');
const {
  Action
...
const _moduleId = "vs/base/browser/ui/button/button";
...
class ButtonWithDropdown extends Disposable {
  constructor(container, options) {
    ...
    this._register(getBaseLayerHoverDelegate().setupUpdatableHover(getDefaultHoverDelegate('mouse'), this.dropdownButton.element, localizeWithPath(_moduleId, 0, 'More Actions...')));
