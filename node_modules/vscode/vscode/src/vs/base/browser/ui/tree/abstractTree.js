...
const {
  FindInput
} = require('../findinput/findInput.js');
const {
  unthemedInboxStyles
} = require('../inputbox/inputBox.js');
const {
  ElementsDragAndDropData
} = require('../list/listView.js');
const {
  isInputElement,
  ...
  isActionItem
} = require('../list/listWidget.js');
const {
  Toggle,
  unthemedToggleStyles
} = require('../toggle/toggle.js');
const {
  isFilterResult,
  getVisibleState
} = require('./indexTreeModel.js');
const {
...
const {
  Codicon
} = require('../../../common/codicons.js');
const {
  ThemeIcon
} = require('../../../common/themables.js');
const {
  SetMap
...
const {} = require('./media/tree.css.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const {
...
const _moduleId = "vs/base/browser/ui/tree/abstractTree";
...
class ModeToggle extends Toggle {
  constructor(opts) {
    super({
      ...
      title: localizeWithPath(_moduleId, 0, "Filter"),
...
class FuzzyToggle extends Toggle {
  constructor(opts) {
    super({
      ...
      title: localizeWithPath(_moduleId, 1, "Fuzzy Match"),
      isChecked: opts.isChecked ?? false,
      hoverDelegate: opts.hoverDelegate ?? getDefaultHoverDelegate('element'),
      inputActiveOptionBorder: opts.inputActiveOptionBorder,
      inputActiveOptionForeground: opts.inputActiveOptionForeground,
...
class FindWidget extends Disposable {
  set mode(mode) {
    ...
    this.findInput.inputBox.setPlaceHolder(mode === TreeFindMode.Filter ? localizeWithPath(_moduleId, 2, "Type to filter") : localizeWithPath(_moduleId, 3, "Type to search"));
  }
  ...
  constructor(container, tree, contextViewProvider, mode, matchType, options) {
    ...
    this.findInput = this._register(new FindInput(this.elements.findInput, contextViewProvider, {
      label: localizeWithPath(_moduleId, 3, "Type to search"),
    ...
    const closeAction = this._register(new Action('close', localizeWithPath(_moduleId, 4, "Close"), 'codicon codicon-close', true, () => this.dispose()));
...
class FindController {
  ...
  open() {
    ...
    this.widget = new FindWidget(this.view.getHTMLElement(), this.tree, this.contextViewProvider, this.mode, this.matchType, {
      ...this.options,
    ...
    if (this.pattern && noMatches) {
      if (this.tree.options.showNotFoundMessage ?? true) {
        this.widget?.showMessage({
          type: 2,
          content: localizeWithPath(_moduleId, 5, "No elements found.")
        });
      } else {
        this.widget?.showMessage({
          type: 2
...
exports.RenderIndentGuides = RenderIndentGuides;
exports.TreeFindMatchType = TreeFindMatchType;
exports.TreeFindMode = TreeFindMode;
