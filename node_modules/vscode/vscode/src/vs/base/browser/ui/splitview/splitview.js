...
const {
  Scrollable
} = require('../../../common/scrollable.js');
const {
  isUndefined
} = require('../../../common/types.js');
const {} = require('./splitview.css.js');
const defaultStyles = {
  ...
  constructor(container, options = {}) {
    ...
    if (options.descriptor) {
      ...
      options.descriptor.views.forEach((viewDescriptor, index) => {
        const sizing = isUndefined(viewDescriptor.visible) || viewDescriptor.visible ? viewDescriptor.size : {
          type: 'invisible',
  ...
  doAddView(view, size, index = this.viewItems.length, skipLayout) {
    ...
    try {
      ...
      if (this.viewItems.length > 1) {
        ...
        const sash = this.orientation === 0 ? new Sash(this.sashContainer, {
        ...
        const sashEventMapper = this.orientation === 0 ? e => ({
          sash,
          start: e.startY,
          current: e.currentY,
          alt: e.altKey
