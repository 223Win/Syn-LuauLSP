const {} = require('./iconlabel.css.js');
const {
  append,
  $,
  after
  ...
  setLabel(label, options) {
    ...
    if (typeof label === 'string') {
      if (!this.singleLabel) {
        ...
        this.singleLabel = append(this.container, $('a.label-name', {
          id: options?.domId
        }));
      }
      ...
      for (let i = 0; i < label.length; i++) {
        ...
        append(this.container, $('a.label-name', {
          id,
  ...
  setLabel(label, options) {
    ...
    if (typeof label === 'string') {
      if (!this.singleLabel) {
        this.container.innerText = '';
        this.container.classList.remove('multiple');
        this.singleLabel = this._register(new HighlightedLabel(append(this.container, $('a.label-name', {
          id: options?.domId
        })), {
