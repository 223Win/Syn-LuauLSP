...
const {} = require('./hoverWidget.css.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const _moduleId = "vs/base/browser/ui/hover/hoverWidget";
const $ = $$1;
...
class HoverAction extends Disposable {
  ...
  constructor(parent, actionOptions, keybindingLabel) {
    ...
    this._store.add(new KeyDownAction(this.actionContainer, actionOptions.run, [3, 10]));
...
function getHoverAccessibleViewHint(shouldHaveHint, keybinding) {
  return shouldHaveHint && keybinding ? localizeWithPath(_moduleId, 0, "Inspect this in the accessible view with {0}.", keybinding) : shouldHaveHint ? localizeWithPath(_moduleId, 1, "Inspect this in the accessible view via the command Open Accessible View which is currently not triggerable via keybinding.") : '';
}
