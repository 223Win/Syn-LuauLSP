...
const {
  AbstractTree
} = require('./abstractTree.js');
const {
  CompressibleObjectTreeModel
} = require('./compressedObjectTreeModel.js');
const {
  ObjectTreeModel
} = require('./objectTreeModel.js');
const {
  memoize
} = require('../../../common/decorators.js');
const {
  Iterable
} = require('../../../common/iterator.js');
...
CompressibleRenderer.__decorator = __decorate([memoize], CompressibleRenderer.prototype, "compressedTreeNodeProvider", null);
