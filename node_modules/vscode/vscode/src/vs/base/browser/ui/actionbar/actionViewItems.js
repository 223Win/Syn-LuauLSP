...
const {
  SelectBox
} = require('../selectBox/selectBox.js');
const {
  Action,
  ActionRunner,
  Separator
...
const {} = require('./actionbar.css.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const {
...
const _moduleId = "vs/base/browser/ui/actionbar/actionViewItems";
  ...
  getTooltip() {
    ...
    if (this.action.tooltip) {
      ...
      if (this.options.keybinding) {
        title = localizeWithPath(_moduleId, 0, "{0} ({1})", title, this.options.keybinding);
      }
    }
