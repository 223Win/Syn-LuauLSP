...
} = require('../../../common/cancellation.js');
const {
  Event
...
class PagedList {
  ...
  get onMouseClick() {
    return Event.map(this.list.onMouseClick, ({
      element,
      index,
      browserEvent
    }) => ({
  ...
  get onTap() {
    return Event.map(this.list.onTap, ({
      element,
      index,
      browserEvent
    }) => ({
  ...
  get onDidChangeFocus() {
    return Event.map(this.list.onDidChangeFocus, ({
      elements,
      indexes,
      browserEvent
    }) => ({
  ...
  get onContextMenu() {
    return Event.map(this.list.onContextMenu, ({
      element,
      index,
      anchor,
      browserEvent
