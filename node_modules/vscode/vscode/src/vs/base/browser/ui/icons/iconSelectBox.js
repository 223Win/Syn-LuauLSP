const {} = require('./iconSelectBox.css.js');
const {
  $,
  append,
  clearNode,
...
const {
  HighlightedLabel
} = require('../highlightedlabel/highlightedLabel.js');
...
class IconSelectBox extends Disposable {
  ...
  create() {
    ...
    const iconsContainer = this.iconsContainer = $('.icon-select-icons-container', {
    ...
    if (this.options.showIconInfo) {
      this.iconIdElement = this._register(new HighlightedLabel(append(append(iconSelectBoxContainer, $('.icon-select-id-container')), $('.icon-select-id-label'))));
    }
  ...
  renderIcons(icons, matches, container) {
    ...
    if (icons.length) {
      for (let index = 0; index < icons.length; index++) {
        ...
        const iconContainer = append(container, $('.icon-container', {
  ...
  reveal(index) {
    ...
    const {
      scrollTop
    } = this.scrollableElement.getScrollPosition();
