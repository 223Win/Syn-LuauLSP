...
const {
  UILabelProvider
} = require('../../../common/keybindingLabels.js');
const {
  Disposable
...
const {} = require('./keybindingLabel.css.js');
const {
  localizeWithPath
} = require('../../../../nls.js');
const _moduleId = "vs/base/browser/ui/keybindingLabel/keybindingLabel";
const $ = $$1;
...
class KeybindingLabel extends Disposable {
  ...
  renderUnbound(parent) {
    append(parent, this.createKeyElement(localizeWithPath(_moduleId, 0, "Unbound")));
  }
...
exports.unthemedKeybindingLabelOptions = unthemedKeybindingLabelOptions;