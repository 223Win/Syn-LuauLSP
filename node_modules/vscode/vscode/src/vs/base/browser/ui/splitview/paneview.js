...
const {
  SplitView,
  Sizing
} = require('./splitview.js');
const _moduleId = "vs/base/browser/ui/splitview/paneview";
class Pane extends Disposable {
  ...
  constructor(options) {
    ...
    this._ariaHeaderLabel = localizeWithPath(_moduleId, 0, "{0} Section", options.title);
