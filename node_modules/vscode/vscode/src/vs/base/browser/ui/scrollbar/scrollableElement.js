...
const {
  createFastDomNode
} = require('../../fastDomNode.js');
const {
  StandardWheelEvent
} = require('../../mouseEvent.js');
const {
  HorizontalScrollbar
} = require('./horizontalScrollbar.js');
const {
  VerticalScrollbar
} = require('./verticalScrollbar.js');
const {
  Widget
} = require('../widget.js');
const {
...
const {} = require('./media/scrollbars.css.js');
...
class AbstractScrollableElement extends Widget {
  ...
  _setListeningToMouseWheel(shouldListen) {
    ...
    if (shouldListen) {
      ...
      this._mouseWheelToDispose.push(addDisposableListener(this._listenOnDomNode, EventType.MOUSE_WHEEL, onMouseWheel, {
        passive: false
      }));
    }
  }
