...
const {
  BaseActionViewItem,
  ActionViewItem
} = require('../actionbar/actionViewItems.js');
const {
  layout
} = require('../contextview/contextview.js');
const {
...
} = require('../../../common/codiconsUtil.js');
const {
  ThemeIcon
    ...
    if (this.options.label) {
      ...
      if (label) {
        ...
        if (matches) {
          ...
          if (escMatch) {
            this.label.append(ltrim(replaceDoubleEscapes(label.substr(0, escMatch.index)), ' '), $('u', {
              'aria-hidden': 'true'
            }, escMatch[3]), rtrim(replaceDoubleEscapes(label.substr(escMatch.index + escMatch[0].length)), ' '));
          } else {
...
exports.MENU_ESCAPED_MNEMONIC_REGEX = MENU_ESCAPED_MNEMONIC_REGEX;
exports.MENU_MNEMONIC_REGEX = MENU_MNEMONIC_REGEX;
exports.Menu = Menu;
