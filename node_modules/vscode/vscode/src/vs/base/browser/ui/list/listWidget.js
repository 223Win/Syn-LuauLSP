...
const {
  ...
  binarySearch,
  range
} = require('../../../common/arrays.js');
const {
  timeout
} = require('../../../common/async.js');
const {
  Color
} = require('../../../common/color.js');
const {
  memoize
} = require('../../../common/decorators.js');
const {
  Event,
  EventBufferer,
  Emitter
...
const {} = require('../../../common/observableInternal/derived.js');
const {
  autorun
} = require('../../../common/observableInternal/autorun.js');
const {
  constObservable
} = require('../../../common/observableInternal/utils.js');
const {} = require('../../../common/cancellation.js');
class TraitRenderer {
  constructor(trait) {
    this.trait = trait;
...
Trait.__decorator = __decorate([memoize], Trait.prototype, "renderer", null);
...
KeyboardController.__decorator = __decorate([memoize], KeyboardController.prototype, "onKeyDown", null);
...
class List {
  ...
  get onContextMenu() {
    ...
    const fromKeyDown = Event.chain(this.disposables.add(new DomEmitter(this.view.domNode, 'keydown')).event, $ => $.map(e => new StandardKeyboardEvent(e)).filter(e => didJustPressContextMenuKey = e.keyCode === 58 || e.shiftKey && e.keyCode === 68).map(e => EventHelper.stop(e, true)).filter(() => false));
    const fromKeyUp = Event.chain(this.disposables.add(new DomEmitter(this.view.domNode, 'keyup')).event, $ => $.forEach(() => didJustPressContextMenuKey = false).map(e => new StandardKeyboardEvent(e)).filter(e => e.keyCode === 58 || e.shiftKey && e.keyCode === 68).map(e => EventHelper.stop(e, true)).map(({
      browserEvent
    }) => {
...
List.__decorator = __decorate([memoize], List.prototype, "onDidChangeFocus", null);
List.__decorator = __decorate([memoize], List.prototype, "onDidChangeSelection", null);
List.__decorator = __decorate([memoize], List.prototype, "onContextMenu", null);
List.__decorator = __decorate([memoize], List.prototype, "onKeyDown", null);
List.__decorator = __decorate([memoize], List.prototype, "onKeyUp", null);
List.__decorator = __decorate([memoize], List.prototype, "onKeyPress", null);
List.__decorator = __decorate([memoize], List.prototype, "onDidFocus", null);
List.__decorator = __decorate([memoize], List.prototype, "onDidBlur", null);
exports.DefaultKeyboardNavigationDelegate = DefaultKeyboardNavigationDelegate;
exports.DefaultStyleController = DefaultStyleController;
exports.List = List;
exports.MouseController = MouseController;
exports.TypeNavigationMode = TypeNavigationMode;
...
exports.unthemedListStyles = unthemedListStyles;