...
} = require('../dropdown/dropdownActionViewItem.js');
const {
  Action,
  SubmenuAction
...
const _moduleId = "vs/base/browser/ui/toolbar/toolbar";
...
class ToggleMenuAction extends Action {
  ...
  constructor(toggleDropdownMenu, title) {
    title = title || localizeWithPath(_moduleId, 0, "More Actions...");
